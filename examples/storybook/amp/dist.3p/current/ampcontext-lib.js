(() => {
  ...
  var AmpContext = /* @__PURE__ */ function(_AbstractAmpContext) {
    _inherits(AmpContext2, _AbstractAmpContext);
    var _super = _createSuper(AmpContext2);
    function AmpContext2() {
      _classCallCheck6(this, AmpContext2);
      return _super.apply(this, arguments);
    }
    _createClass5(AmpContext2, [{
      key: "isAbstractImplementation_",
      value: function isAbstractImplementation_() {
        return false;
      }
  ...
  try {
    windowContextCreated = new Event("amp-windowContextCreated");
    window.context = new AmpContext(window);
    window.dispatchEvent(windowContextCreated);
  } catch (err) {
  }
  var windowContextCreated;
})();
