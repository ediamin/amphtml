(function() {
  ...
  var loadThree = function loadThree2(global, cb) {
    var loadScriptCb = function loadScriptCb2(url) {
      return function(cb2) {
        return loadScript(global, url, cb2);
      };
    };
  ...
  function gltfViewer(global) {
    var dataReceived = parseJson(global.name)["attributes"]._context;
    loadThree(global, function() {
      ...
      listenParent(global, "action", function(msg) {
  ...
  // 3p/vendors/3d-gltf.js
  init(window);
  register("3d-gltf", gltfViewer);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=3d-gltf.max.js.map
