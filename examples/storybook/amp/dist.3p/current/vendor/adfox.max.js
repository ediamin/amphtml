(function() {
  ...
  function maybeInstrumentsNodes(win, addedNodes) {
    var _loop = function _loop2(n3) {
      var node = addedNodes[n3];
      try {
    ...
    for (var n2 = 0; n2 < addedNodes.length; n2++) {
      var _ret = _loop(n2);
      if (_ret === "continue")
        continue;
    }
  ...
  function createContainer2(global, id) {
...
//# sourceMappingURL=adfox.max.js.map
