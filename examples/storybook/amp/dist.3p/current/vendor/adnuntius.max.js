(function() {
  ...
  function adnuntius(global, data) {
    validateData(data, ["auId"]);
    loadScript(global, "https://cdn.adnuntius.com/adn.js", function() {
      global.adn = global.adn || {};
      global.adn.calls = global.adn.calls || [];
      global.adn.calls.push(function() {
        global.adn.request({
          amp: {
            data: data
          }
  ...
  // 3p/vendors/adnuntius.js
  init(window);
  register("adnuntius", adnuntius);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=adnuntius.max.js.map
