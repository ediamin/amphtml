(function() {
  ...
  function runSync(global, cb) {
    ...
    global.document.write("<script>__aoPrivFnct" + runSyncCount + "();<\/script>");
  }
  ...
  function executeMaster(masterId, data, global, callback) {
    ...
    if (global["ado"]) {
      global["ado"]["onEmit"](function(masterId2, instanceId, codes) {
        callback(codes);
      });
  ...
  function requestCodes(masterId, data, global, callback) {
    ...
    computeInMasterFrame(global, "ao-master-exec", function(done) {
      executeMaster(masterId, data, global, function(codes) {
        return done(codes);
      });
    }, function(codes) {
  ...
  var AdoBuffer = /* @__PURE__ */ function() {
    function AdoBuffer2(container, global) {
      _classCallCheck8(this, AdoBuffer2);
      this.container = container;
      this.global = global;
      this.callback = null;
    }
    _createClass7(AdoBuffer2, [{
      key: "render",
  ...
  function executeSlave(slaveId, config, global) {
    ...
    if (global["ado"]) {
      if (!config || config["isEmpty"]) {
        ...
        var buffer = new AdoBuffer(placement, global);
  ...
  function adocean(global, data) {
    ...
    writeScript(global, adoUrl, function() {
      ...
      if (masterId) {
        ...
        requestCodes(masterId, data, global, function(codes) {
  ...
  // 3p/vendors/adocean.js
  init(window);
  register("adocean", adocean);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=adocean.max.js.map
