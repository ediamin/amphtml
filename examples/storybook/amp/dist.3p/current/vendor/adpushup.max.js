(function() {
  ...
  function adpushup(global, data) {
    validateData(data, ["siteid", "slotpath", "width", "height"], ["totalampslots", "jsontargeting", "extras"]);
    loadScript(global, "https://securepubads.g.doubleclick.net/tag/js/gpt.js", function() {
      loadScript(global, "https://cdn.adpushup.com/" + data.siteid + "/amp.js", function() {
        window.adpushup.initAmp(global, data.width, data.height, data.siteid, data.slotpath, data.totalampslots, data.jsontargeting, data.extras);
      });
    });
  }

  // 3p/vendors/adpushup.js
  init(window);
  register("adpushup", adpushup);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=adpushup.max.js.map
