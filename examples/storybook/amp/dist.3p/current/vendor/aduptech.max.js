(function() {
  ...
  function aduptech(global, data) {
    var context = global.context, document2 = global.document;
    ...
    var options = {
      ...
      onAds: function onAds() {
        return context.renderStart();
      },
      onNoAds: function onNoAds() {
        return context.noContentAvailable();
      }
    };
    if ("mincpc" in data) {
    ...
    if (context.consentSharedData !== null && typeof context.consentSharedData === "object" && context.consentSharedData.consentString && context.consentSharedData.consentString !== "") {
    ...
    loadScript(global, ADUPTECH_API_URL, function() {
      return global.uAd.embed(ADUPTECH_ELEMENT_ID, options);
    });
  }

  // 3p/vendors/aduptech.js
  init(window);
  register("aduptech", aduptech);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=aduptech.max.js.map
