(function() {
  ...
  function adventive(global, data) {
  ...
  function adventive_(global, data) {
    ...
    var cb = callback.bind(this, data.pid, ns), url = getUrl(global.context, data, ns);
    url ? (hasOwn(data, "async") ? loadScript : writeScript)(global, url, cb) : cb();
  }
  ...
  function getUrl(context, data, ns) {
    var mode = ns.mode, isDev = hasOwn(data, "isDev"), sld_ = sld[!mode.dev], thld_ = thld[isDev && !mode.live], search = reduceSearch(ns, data.pid, data.click, context.referrer), url = search ? addParamsToUrl("https://" + thld_ + "." + sld_ + ".com/ad", search) : false;
    return url;
  }
  ...
  // 3p/vendors/adventive.js
  init(window);
  register("adventive", adventive);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=adventive.max.js.map
