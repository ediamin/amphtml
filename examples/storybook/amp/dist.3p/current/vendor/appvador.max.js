(function() {
  ...
  // 3p/vendors/appvador.js
  init(window);
  register("appvador", appvador);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=appvador.max.js.map
