(function() {
  ...
  function addCanonicalLinkTag(global) {
    var canonicalUrl = global.context.canonicalUrl;
    if (canonicalUrl) {
  ...
  function createContainer(global, data) {
    ...
    var container = global.document.createElement("container");
    ...
    return function() {
      global.BeOpinionSDK.init({
        ...
        onHeightChange: function onHeightChange(newHeight) {
          ...
          context.requestResize(boundingClientRect.width, newHeight).catch(function() {
  ...
  function beopinion(global, data) {
    var container = createContainer(global, data);
    var c = global.document.getElementById("c");
  ...
  // 3p/vendors/beopinion.js
  init(window);
  register("beopinion", beopinion);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=beopinion.max.js.map
