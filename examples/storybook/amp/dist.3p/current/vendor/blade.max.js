(function() {
  ...
  function blade(global, data) {
    ...
    loadScript(global, "https://" + servingDomain + "/js/" + data["blade_api_key"] + "/" + data["blade_player_id"] + "/player.js?t=" + data["blade_player_type"] + "&callback=" + bladeOnLoad + "&config=" + bladeConfig + "&c=" + containerId, void 0, function() {
      global.context.noContentAvailable();
    });
...
//# sourceMappingURL=blade.max.js.map
