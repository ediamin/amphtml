(function() {
  ...
  function bodymovinanimation(global) {
    var dataReceived = parseJson(global.name)["attributes"]._context;
    var dataLoop = dataReceived["loop"];
    var animatingContainer = global.document.createElement("div");
  ...
  // 3p/vendors/bodymovinanimation.js
  init(window);
  register("bodymovinanimation", bodymovinanimation);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=bodymovinanimation.max.js.map
