(function() {
  ...
  function cedato(global, data) {
    var requiredParams = ["id"];
    var optionalParams = ["domain", "servingDomain", "subid", "version", "extraParams"];
    ...
    var domain = data.domain || parseUrlDeprecated(global.context.sourceUrl).origin;
    var playerDiv = global.document.createElement("div");
    playerDiv.id = "video" + data.id + cb;
    setStyles(playerDiv, {
      width: "100%",
      height: "100%"
    });
    var playerScript = global.document.createElement("script");
  ...
  // 3p/vendors/cedato.js
  init(window);
  register("cedato", cedato);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=cedato.max.js.map
