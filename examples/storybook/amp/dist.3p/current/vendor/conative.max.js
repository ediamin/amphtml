(function() {
  ...
  function conative(global, data) {
    ...
    if (data.domain) {
      writeScript(global, "//s3-eu-west-1.amazonaws.com/ccc-adscript/serve/domain/" + data.domain + "/config.js");
    }
  }

  // 3p/vendors/conative.js
  init(window);
  register("conative", conative);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=conative.max.js.map
