(function() {
  ...
  function csa(global, data) {
    ...
    var pageOptions = {
      source: "amp",
      referer: global.context.referrer
    };
    var adblockOptions = {
    ...
    loadScript(global, "https://www.google.com/adsense/search/ads.js", requestCsaAds.bind(null, global, data, afsPage, afsAd, afshPage, afshAd));
  }
  function orientationChangeHandler(global, containerDiv) {
    var oldHeight = getStyle(containerDiv, "height");
    global.setTimeout(function() {
      var ignore = global.document.body.offsetHeight;
      ...
      if (oldHeight != newHeight && newHeight != currentAmpHeight) {
        ...
        if (overflow) {
          overflow.onclick = function() {
            return requestResizeInternal(global, containerDiv, newHeightPx);
          };
        }
  ...
  function requestResizeInternal(global, container, height) {
    global.context.requestResize(void 0, height).then(function() {
  ...
  function createOverflow(global, container, height) {
    ...
    overflow.onclick = function() {
      return requestResizeInternal(global, container, height);
    };
...
//# sourceMappingURL=csa.max.js.map
