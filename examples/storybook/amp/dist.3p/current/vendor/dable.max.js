(function() {
  ...
  function dable(global, data) {
    validateData(data, ["widgetId"]);
    global.dable = global.dable || function() {
      (global.dable.q = global.dable.q || []).push(arguments);
    };
    global.dable("setService", data["serviceName"] || global.window.context.location.hostname);
...
//# sourceMappingURL=dable.max.js.map
