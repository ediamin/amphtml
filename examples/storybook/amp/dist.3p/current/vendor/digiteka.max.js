(function() {
  ...
  function digiteka(global, data) {
    global._digiteka_amp = {
      allowed_data: ["mdtk", "zone", "adunit", "params"],
      mandatory_data: ["mdtk", "zone"],
      data: data
    };
    validateData(data, global._digiteka_amp.mandatory_data, global._digiteka_amp.allowed_data);
    loadScript(global, "https://ot.digiteka.com/amp.js");
  }

  // 3p/vendors/digiteka.js
  init(window);
  register("digiteka", digiteka);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=digiteka.max.js.map
