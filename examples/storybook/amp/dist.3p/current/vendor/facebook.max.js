(function() {
  ...
  function getFacebookSdk(global, cb, locale) {
    loadScript(global, "https://connect.facebook.net/" + locale + "/sdk.js", function() {
      cb(global.FB);
    });
  }
  ...
  function getCommentContainer(global, data) {
    var c = global.document.getElementById("c");
    var container = createContainer(global, "comment-embed", data.href);
  ...
  function getPageContainer(global, data) {
    var container = createContainer(global, "page", data.href);
  ...
  function getCommentsContainer(global, data) {
    var container = createContainer(global, "comments", data.href);
  ...
  function getLikeContainer(global, data) {
    var container = createContainer(global, "like", data.href);
  ...
  function facebook(global, data) {
    var container = getEmbedContainer(global, data, data.embedAs || getDefaultEmbedAs(data.href));
  ...
  // 3p/vendors/facebook.js
  init(window);
  register("facebook", facebook);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=facebook.max.js.map
