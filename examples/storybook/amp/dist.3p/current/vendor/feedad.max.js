(function() {
  ...
  function feedad(global, data) {
    validateData(data, ["clientToken", "placementId"], ["background"]);
    global.feedad = global.feedad || {
      cmd: []
    };
    global.feedad.cmd.push(function() {
      global.feedad.sdk.init(data.clientToken).then(function() {
        return global.feedad.sdk.requestAd(data.placementId);
  ...
  // 3p/vendors/feedad.js
  init(window);
  register("feedad", feedad);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=feedad.max.js.map
