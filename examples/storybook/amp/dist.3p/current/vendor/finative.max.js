(function() {
  ...
  function finative(global, data) {
    writeScript(global, "https://d.finative.cloud/cds/delivery/init?url=" + encodeURIComponent(data.url));
  }

  // 3p/vendors/finative.js
  init(window);
  register("finative", finative);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=finative.max.js.map
