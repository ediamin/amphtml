(function() {
  ...
  function firstimpression(global, data) {
    validateData(data, ["zoneId", "websiteId"]);
    var _global$context$locat = global.context.location, hash = _global$context$locat.hash, search = _global$context$locat.search;
  ...
  // 3p/vendors/firstimpression.js
  init(window);
  register("firstimpression", firstimpression);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=firstimpression.max.js.map
