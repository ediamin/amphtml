(function() {
  ...
  function gumgum(global, data) {
    ...
    var win = window, ctx = win.context, dom = global.document.getElementById("c"), ampWidth = parseInt(data.width || "0", 10), ampHeight = parseInt(data.height || "0", 10), ggevents = global.ggevents || [];
  ...
  // 3p/vendors/gumgum.js
  init(window);
  register("gumgum", gumgum);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=gumgum.max.js.map
