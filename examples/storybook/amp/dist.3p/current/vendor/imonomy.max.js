(function() {
  ...
  var TAG = "DOUBLECLICK - DEPRECATED";
  function doubleclick(opt_global, opt_data) {
    dev().error(TAG, "The use of doubleclick.js has been deprecated. Please switch to Fast Fetch. See documentation here: https://github.com/ampproject/amphtml/issues/11834");
  }
  ...
  function imonomy(global, data) {
    if (!("slot" in data)) {
      ...
      loadScript(global, "//tag.imonomy.com/amp/" + data.pid + "/amp.js", function() {
  ...
  // 3p/vendors/imonomy.js
  init(window);
  register("imonomy", imonomy);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=imonomy.max.js.map
