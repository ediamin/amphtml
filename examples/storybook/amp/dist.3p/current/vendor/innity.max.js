(function() {
  ...
  function innity(global, data) {
    validateData(data, ["pub", "zone"], ["channel"]);
    writeScript(global, "https://cdn.innity.net/admanager.js", function() {
      var innityAMPZone = global.innity_adZone;
  ...
  // 3p/vendors/innity.js
  init(window);
  register("innity", innity);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=innity.max.js.map
