(function() {
  ...
  function invibes(global, data) {
    global.invibesAmp = {
      allowedData: ["adCateg", "pid", "customEndpoint"],
      mandatoryData: [],
      data: data
    };
    validateData(data, global.invibesAmp.mandatoryData, global.invibesAmp.allowedData);
  ...
  // 3p/vendors/invibes.js
  init(window);
  register("invibes", invibes);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=invibes.max.js.map
