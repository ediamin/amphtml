(function() {
  ...
  function lentainform(global, data) {
    ...
    global.uniqId = ("00000" + Math.round(Math.random() * 1e5).toString(16)).slice(-5);
  ...
  // 3p/vendors/lentainform.js
  init(window);
  register("lentainform", lentainform);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=lentainform.max.js.map
