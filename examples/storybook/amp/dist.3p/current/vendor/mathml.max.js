(function() {
  ...
  function mathml(global, data) {
    userAssert(data.formula, "The formula attribute is required for <amp-mathml> %s", data.element);
    getMathmlJs(global, "https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_CHTML", function(mathjax) {
      delete data.width;
      delete data.height;
  ...
  // 3p/vendors/mathml.js
  init(window);
  register("mathml", mathml);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=mathml.max.js.map
