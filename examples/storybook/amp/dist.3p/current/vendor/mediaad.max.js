(function() {
  ...
  function mediaad(global, data) {
    ...
    loadScript(global, "https://s1.mediaad.org/serve/" + encodeURIComponent(data.publisher) + "/loader.js");
  }

  // 3p/vendors/mediaad.js
  init(window);
  register("mediaad", mediaad);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=mediaad.max.js.map
