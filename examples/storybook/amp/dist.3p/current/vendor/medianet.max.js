(function() {
  ...
  var optionalParams = ["timeout", "crid", "misc", "slot", "targeting", "categoryExclusions", "tagForChildDirectedTreatment", "cookieOptions", "overrideWidth", "overrideHeight", "loadingStrategy", "consentNotificationId", "useSameDomainRenderingUntilDeprecated", "experimentId", "multiSize", "multiSizeValidation"];
  ...
  // 3p/vendors/medianet.js
  init(window);
  register("medianet", medianet);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=medianet.max.js.map
