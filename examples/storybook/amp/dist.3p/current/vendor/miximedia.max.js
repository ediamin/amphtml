(function() {
  ...
  function miximedia(global, data) {
    ...
    loadScript(global, "https://amp.mixi.media/ampclient/mixi.js?rand=" + rand, function() {
    }, global.context.noContentAvailable);
  }

  // 3p/vendors/miximedia.js
  init(window);
  register("miximedia", miximedia);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=miximedia.max.js.map
