(function() {
  ...
  function mixpo(global, data) {
    ...
    var g = global, cdnSubdomain = data.subdomain == "www" ? "cdn" : data.subdomain + "-cdn", url = data.loader || "https://" + cdnSubdomain + ".mixpo.com/js/loader.js";
    g.mixpoAd = {
      amp: true,
      noflash: true,
      width: data.width,
...
//# sourceMappingURL=mixpo.max.js.map
