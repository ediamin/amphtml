(function() {
  ...
  function my6sense(global, data) {
    validateData(data, ["widgetKey"]);
    var widgetTag = global.document.createElement("script");
    widgetTag.src = "//web-clients.mynativeplatform.com/web-clients/bootloaders/" + data["widgetKey"] + "/bootloader.js";
    var url = data["url"] && data["url"] !== "[PAGE_URL]" ? data["url"] : global.context.sourceUrl;
  ...
  // 3p/vendors/my6sense.js
  init(window);
  register("my6sense", my6sense);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=my6sense.max.js.map
