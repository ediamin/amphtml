(function() {
  ...
  function nativeroll(global, data) {
    validateData(data, ["gid"]);
    loadScript(global, "https://cdn01.nativeroll.tv/js/seedr-player.min.js", function() {
  ...
  function initPlayer(global, data) {
    var config = {
      ...
      onLoad: function onLoad() {
        var height = global.document.getElementsByClassName("nr-player")[0].offsetHeight;
        global.context.requestResize(void 0, height);
      },
  ...
  // 3p/vendors/nativeroll.js
  init(window);
  register("nativeroll", nativeroll);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=nativeroll.max.js.map
