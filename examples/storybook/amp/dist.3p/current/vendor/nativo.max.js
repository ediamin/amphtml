(function() {
  ...
  function nativo(global, data) {
    var ntvAd;
    (function(ntvAd2, global2, data2) {
      global2.history.replaceState(null, "", location.pathname + location.hash.replace(/({).*(})/, ""));
      var delayedAdLoad = false;
      var percentageOfadViewed;
      var loc = global2.context.location;
      ...
      function loadAdWhenViewed() {
        var g = global2;
        global2.context.observeIntersection(function(positions) {
      ...
      function viewabilityConfiguration(positions) {
        ...
        global2.PostRelease.checkIsAdVisible();
      }
      ...
      ntvAd2.setupAd = function() {
        global2._prx = [["cfg.Amp"]];
        global2._prx.push(["cfg.RequestUrl", data2["requestUrl"] || loc.href]);
        for (var key in data2) {
          switch (key) {
            case "premium":
              global2._prx.push(["cfg.SetUserPremium"]);
              break;
            case "debug":
              global2._prx.push(["cfg.Debug"]);
              break;
            case "delay":
              if (isValidDelayTime(data2.delayByTime)) {
                global2._prx.push(["cfg.SetNoAutoStart"]);
              }
              break;
          }
        }
      ...
      ntvAd2.Start = function() {
        ...
        global2.PostRelease.checkAmpViewability = function() {
          return ntvAd2.getPercentageOfadViewed();
        };
        global2.context.observeIntersection(viewabilityConfiguration);
      };
  ...
  // 3p/vendors/nativo.js
  init(window);
  register("nativo", nativo);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=nativo.max.js.map
