(function() {
  ...
  function pixels(global, data) {
    validateData(data, ["origin", "sid", "tag"], ["clickTracker", "viewability"]);
    data.tag = data.tag.toString().toLowerCase();
    global._pixelsParam = data;
    if (data.tag === "sync") {
      writeScript(global, "https://cdn.adsfactor.net/amp/pixels-amp.min.js", function() {
        var pixelsAMPAd = global.pixelsAd;
  ...
  // 3p/vendors/pixels.js
  init(window);
  register("pixels", pixels);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=pixels.max.js.map
