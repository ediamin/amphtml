(function() {
  ...
  var mandatoryParams = ["id"];
  var optionalParams = ["fluid"];
  function playstream(global, data) {
    global.playstream = {
      unitData: data["id"],
      fluid: data["fluid"]
    };
    ...
    loadScript(global, "https://app.playstream.media/js/amp.js?" + searchParams.toString());
  }

  // 3p/vendors/playstream.js
  init(window);
  register("playstream", playstream);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=playstream.max.js.map
