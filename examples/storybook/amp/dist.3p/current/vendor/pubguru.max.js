(function() {
  ...
  function pubguru(global, data) {
    validateData(data, ["publisher", "slot"]);
    global.$pubguru = data;
    var el = global.document.createElement("div");
    el.setAttribute("id", "the-ad-unit");
    global.document.getElementById("c").appendChild(el);
    loadScript(global, "https://amp.pubguru.org/amp." + encodeURIComponent(data.publisher) + ".min.js");
  }

  // 3p/vendors/pubguru.js
  init(window);
  register("pubguru", pubguru);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=pubguru.max.js.map
