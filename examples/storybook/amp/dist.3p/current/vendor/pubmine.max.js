(function() {
  ...
  function createSlot(slotId, global) {
    var containerEl = global.document.getElementById("c");
    var adSlot = global.document.createElement("div");
  ...
  function pubmine(global, data) {
    ...
    var isMaster = global.context.isMaster;
    if (isMaster) {
      initMasterFrame(data, global);
    }
    var master = isMaster ? global : global.context.master;
  ...
  // 3p/vendors/pubmine.js
  init(window);
  register("pubmine", pubmine);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=pubmine.max.js.map
