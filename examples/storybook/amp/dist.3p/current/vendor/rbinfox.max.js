(function() {
  ...
  var jsnPrefix = "https://rb.infox.sg/";
  var n = "infoxContextAsyncCallbacks";
  function rbinfox(global, data) {
  ...
  // 3p/vendors/rbinfox.js
  init(window);
  register("rbinfox", rbinfox);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=rbinfox.max.js.map
