(function() {
  ...
  function recreativ(global, data) {
    validateData(data, ["bn"]);
    var target = global.document.createElement("div");
    target.id = "bn_" + data["bn"];
    global.document.getElementById("c").appendChild(target);
    loadScript(global, "https://go.rcvlink.com/static/amp.js", function() {
  ...
  // 3p/vendors/recreativ.js
  init(window);
  register("recreativ", recreativ);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=recreativ.max.js.map
