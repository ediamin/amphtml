(function() {
  ...
  function relappro(global, data) {
    validateData(data, [], ["slotId", "nameAdUnit", "requirements"]);
    global.params = data;
    loadScript(global, "https://cdn.relappro.com/adservices/amp/relappro.amp.min.js");
  }

  // 3p/vendors/relappro.js
  init(window);
  register("relappro", relappro);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=relappro.max.js.map
