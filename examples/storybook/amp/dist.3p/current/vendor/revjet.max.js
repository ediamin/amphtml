(function() {
  ...
  function revjet(global, data) {
    validateData(data, ["tag", "key"], ["plc", "opts", "params"]);
    global._revjetData = _extends({}, data);
    loadScript(global, "https://cdn.revjet.com/~cdn/JS/03/amp.js", void 0, function() {
      global.context.noContentAvailable();
    });
  }

  // 3p/vendors/revjet.js
  init(window);
  register("revjet", revjet);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=revjet.max.js.map
