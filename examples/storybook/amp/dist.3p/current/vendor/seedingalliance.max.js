(function() {
  ...
  function seedingalliance(global, data) {
    writeScript(global, "https://d.nativendo.de/cds/delivery/init?url=" + encodeURIComponent(data.url));
  }

  // 3p/vendors/seedingalliance.js
  init(window);
  register("seedingalliance", seedingalliance);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=seedingalliance.max.js.map
