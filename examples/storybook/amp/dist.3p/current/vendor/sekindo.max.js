(function() {
  ...
  function sekindo(global, data) {
    validateData(data, ["spaceid"]);
    var pubUrl = encodeURIComponent(global.context.sourceUrl);
    var excludesSet = {
      ampSlotIndex: 1,
      type: 1
    };
    ...
    var query = "isAmpProject=1&pubUrl=" + pubUrl + "&cbuster=" + global.context.startTime + "&";
    var getParam = "";
    for (var key in data) {
      if (hasOwn(data, key)) {
    ...
    loadScript(global, "https://live.sekindo.com/live/liveView.php?" + query, function() {
  ...
  // 3p/vendors/sekindo.js
  init(window);
  register("sekindo", sekindo);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=sekindo.max.js.map
