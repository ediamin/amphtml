(function() {
  ...
  function smartclip(global, data) {
    ...
    validateData(data, global._smartclip_amp.mandatory_data, global._smartclip_amp.allowed_data);
    var rand = Math.round(Math.random() * 1e8);
    loadScript(global, "https://des.smartclip.net/ads?type=dyn&plc=" + encodeURIComponent(data.plc) + "&sz=" + encodeURIComponent(data.sz) + (data.extra ? "&" + encodeURI(data.extra) : "") + "&rnd=" + rand);
  }

  // 3p/vendors/smartclip.js
  init(window);
  register("smartclip", smartclip);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=smartclip.max.js.map
