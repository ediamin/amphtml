(function() {
  ...
  function springAds(global, data) {
    computeInMasterFrame(global, "springAds", function() {
    ...
    if (data.adssetup) {
      ...
      loadScript(global, "https://www.asadcdn.com/adlib/pages/" + sitename + "_amp.js");
    } else {
      registerSlot({
        global: global,
        document: document,
  ...
  // 3p/vendors/springAds.js
  init(window);
  register("springAds", springAds);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=springAds.max.js.map
