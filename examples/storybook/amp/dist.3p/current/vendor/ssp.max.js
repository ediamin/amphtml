(function() {
  ...
  function ssp(global, data) {
    ...
    var mW = global.context.isMaster ? global : global.context.master;
    ...
    computeInMasterFrame(global, "ssp-load", function(done) {
      loadScript(global, "https://ssp.imedia.cz/static/js/ssp.js", function() {
        if (!global["sssp"]) {
          done(false);
          return;
        }
        var sssp = global["sssp"];
        sssp.config({
        ...
        AMPcallback: function AMPcallback(ads) {
          ...
          if (!ad || ["error", "empty"].includes(ad.type)) {
            ...
            if (["APPNEXUS", "PUBMATIC"].includes(ad.dsp)) {
              global.context.observeIntersection(function() {
                forceElementReflow(parentElement);
              });
            }
            mW.sssp.writeAd(ad, _extends({}, position, {
              id: parentElement
            }));
            var d = ad.responsive ? {
              width: "100%",
...
//# sourceMappingURL=ssp.max.js.map
