(function() {
  ...
  var renderTo = "strossle-widget";
  function strossle(global, data) {
    validateData(data, ["widgetid"]);
    global._strossle = global._strossle || {
      widgetId: data["widgetid"]
    };
    createContainer(global, data);
    loadScript(global, "https://widgets.sprinklecontent.com/v2/sprinkle.js", function() {
    });
  }
  ...
  // 3p/vendors/strossle.js
  init(window);
  register("strossle", strossle);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=strossle.max.js.map
