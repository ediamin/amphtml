(function() {
  ...
  function teads(global, data) {
    ...
    validateData(data, global._teads_amp.mandatory_data, global._teads_amp.allowed_data);
    if (data.tag) {
      validateData(data.tag, global._teads_amp.mandatory_tag_data);
      global._tta = data.tag.tta;
      global._ttp = data.tag.ttp;
      loadScript(global, "https://s8t.teads.tv/media/format/" + encodeURI(data.tag.js || "v3/teads-format.min.js"));
    } else {
...
//# sourceMappingURL=teads.max.js.map
