(function() {
  ...
  function getTwttr(global, cb) {
    loadScript(global, "https://platform.twitter.com/widgets.js", function() {
      cb(global.twttr);
    });
  }
  function twitter(global, data) {
    ...
    function stripPrefixCamelCase(input, prefix) {
      var stripped = input.replace(new RegExp("^" + prefix), "");
  ...
  // 3p/vendors/twitter.js
  init(window);
  register("twitter", twitter);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=twitter.max.js.map
