(function() {
  ...
  function viqeoPlayerInitLoaded(global, VIQEO) {
    var _global$context = global.context, canonicalUrl = _global$context.canonicalUrl, pageViewId = _global$context.pageViewId, sourceUrl = _global$context.sourceUrl;
    var data = getData(global.context);
  ...
  function viqeoplayer(global) {
    ...
    global["onViqeoLoad"] = function(VIQEO) {
      return viqeoPlayerInitLoaded(global, VIQEO);
    };
    loadScript(global, scriptPlayerInit);
  }

  // 3p/vendors/viqeoplayer.js
  init(window);
  register("viqeoplayer", viqeoplayer);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=viqeoplayer.max.js.map
