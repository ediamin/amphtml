(function() {
  ...
  function yieldbot(global, data) {
    ...
    loadScript(global, "https://cdn.yldbt.com/js/yieldbot.intent.amp.js", function() {
      global.ybotq.push(function() {
        try {
          ...
          if (window.context.isMaster) {
            global.yieldbot.defineSlot(data.ybSlot, {
              sizes: dimensions
            });
            global.yieldbot.go();
          } else {
  ...
  // 3p/vendors/yieldbot.js
  init(window);
  register("yieldbot", yieldbot);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=yieldbot.max.js.map
