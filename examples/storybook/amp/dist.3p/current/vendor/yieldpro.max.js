(function() {
  ...
  function yieldpro(global, data) {
    ...
    var scriptUrl = "https://" + SCRIPT_HOST + data["pubnetwork"] + ".js";
    if (data["debugsrc"]) {
      scriptUrl = data["debugsrc"];
    }
    computeInMasterFrame(global, "yieldpro-request", function(done) {
      var success = false;
      if (!global.showadAMPAdapter) {
        ...
        loadScript(global, scriptUrl, function() {
  ...
  // 3p/vendors/yieldpro.js
  init(window);
  register("yieldpro", yieldpro);
  window.draw3p = draw3p;
})();
/*! https://mths.be/cssescape v1.5.1 by @mathias | MIT license */
//# sourceMappingURL=yieldpro.max.js.map
