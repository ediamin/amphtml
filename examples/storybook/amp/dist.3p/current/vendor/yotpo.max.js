(function() {
  ...
  function getContainerScript(global, scriptSource, cb) {
    loadScript(global, scriptSource, function() {
      global.Yotpo = global.Yotpo || {};
      delete global.Yotpo.widgets["testimonials"];
      var yotpoWidget = typeof global.yotpo === "undefined" ? void 0 : global.yotpo;
  ...
  function getBottomLineContainer(global, data) {
    ...
    var childDiv = global.document.createElement("div");
    childDiv.className = "preview-only-flex-center preview-only-full-height";
    container.appendChild(childDiv);
    var bottomLine = global.document.createElement("div");
  ...
  function getEmbeddedWidgetContainer(global, data) {
    ...
    var cellCentered = global.document.createElement("div");
    cellCentered.className = "preview-only-table-cell-centered";
    container.appendChild(cellCentered);
    var embeddedWidget = global.document.createElement("div");
  ...
  function getPhotosCarouselContainer(global, data) {
    ...
    var photosCarousel = global.document.createElement("div");
  ...
  function yotpo(global, data) {
    ...
    getContainerScript(global, scriptSource, function(yotpoWidget, eventType) {
...
//# sourceMappingURL=yotpo.max.js.map
