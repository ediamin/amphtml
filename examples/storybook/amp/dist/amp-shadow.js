self.AMP_CONFIG||(self.AMP_CONFIG={"localDev":true,"allow-doc-opt-in":["amp-next-page"],"allow-url-opt-in":[],"canary":0,"a4aProfilingRate":0.01,"adsense-ad-size-optimization":1,"doubleclickSraExp":0.01,"doubleclickSraReportExcludedBlock":0.1,"flexAdSlots":0.05,"flexible-bitrate":0.1,"ios-fixed-no-transfer":0,"visibility-trigger-improvements":1,"layout-aspect-ratio-css":0,"disable-a4a-non-sd":1,"tcf-post-message-proxy-api":1,"amp-consent-granular-consent":1,"amp-cid-backup":1,"3p-vendor-split":0.5,"story-ad-placements":0.01});/*AMP_CONFIG*/(() => {
  ...
  var DomWriterStreamer = /* @__PURE__ */ function() {
    function DomWriterStreamer2(win) {
      _classCallCheck11(this, DomWriterStreamer2);
    ...
    _createClass9(DomWriterStreamer2, [{
      key: "onBody",
  ...
  var DomWriterBulk = /* @__PURE__ */ function() {
    function DomWriterBulk2(win) {
      _classCallCheck11(this, DomWriterBulk2);
      this.fullHtml_ = [];
      this.vsync_ = Services.vsyncFor(win);
      this.onBody_ = null;
      this.onBodyChunk_ = null;
  ...
  var MultidocManager = /* @__PURE__ */ function() {
    function MultidocManager2(win, ampdocService, extensions, timer) {
      _classCallCheck13(this, MultidocManager2);
      this.win = win;
    ...
    _createClass11(MultidocManager2, [{
  ...
  var ParserTokenizer = /* @__PURE__ */ function() {
    function ParserTokenizer2(str) {
      _classCallCheck14(this, ParserTokenizer2);
      this.str_ = str;
      this.index_ = -1;
    }
  ...
  var BatchedXhr = /* @__PURE__ */ function(_Xhr) {
    ...
    function BatchedXhr2(win) {
      var _this;
      _classCallCheck16(this, BatchedXhr2);
      _this = _super.call(this, win);
      _this.fetchPromises_ = map();
      return _this;
    }
    _createClass14(BatchedXhr2, [{
      key: "fetch",
      value: function fetch(input, opt_init) {
        var _this2 = this;
  ...
  var WindowInterface = /* @__PURE__ */ function() {
    function WindowInterface2() {
      _classCallCheck18(this, WindowInterface2);
    }
    _createClass16(WindowInterface2, null, [{
      key: "getTop",
  ...
  var GoogleCidApi = /* @__PURE__ */ function() {
    function GoogleCidApi2(ampdoc) {
      _classCallCheck19(this, GoogleCidApi2);
  ...
  var Crypto = /* @__PURE__ */ function() {
    function Crypto2(win) {
      _classCallCheck22(this, Crypto2);
      this.win_ = win;
      var subtle = null;
        ...
        try {
          return this.subtle.digest({
            ...
            if (e.message && e.message.indexOf("secure origin") < 0) {
              user().error(TAG4, "SubtleCrypto failed, fallback to closure lib.", e);
            }
          ...
          dev().error(TAG4, "SubtleCrypto failed, fallback to closure lib.", e);
  ...
  var DocInfo = /* @__PURE__ */ function() {
    function DocInfo2(ampdoc) {
      _classCallCheck23(this, DocInfo2);
      this.ampdoc_ = ampdoc;
      this.info_ = null;
      this.pageViewId64_ = null;
    }
    _createClass21(DocInfo2, [{
      key: "get",
      value: function get() {
        if (this.info_) {
          return this.info_;
  ...
  var PriorityQueue = /* @__PURE__ */ function() {
    function PriorityQueue2() {
      _classCallCheck24(this, PriorityQueue2);
      this.queue_ = [];
    }
    _createClass22(PriorityQueue2, [{
      key: "peek",
      value: function peek() {
        var l = this.length;
        if (!l) {
  ...
  var Navigation = /* @__PURE__ */ function() {
    function Navigation2(ampdoc) {
      var _this = this;
      _classCallCheck25(this, Navigation2);
      this.ampdoc = ampdoc;
  ...
  var Observable = /* @__PURE__ */ function() {
    function Observable2() {
      _classCallCheck26(this, Observable2);
      this.handlers_ = null;
    }
    _createClass24(Observable2, [{
      key: "add",
  ...
  var HiddenObserver = /* @__PURE__ */ function() {
    function HiddenObserver2(ampdoc) {
      _classCallCheck27(this, HiddenObserver2);
    ...
    _createClass25(HiddenObserver2, [{
      key: "add",
      value: function add(handler) {
        var _this = this;
        this.init_();
  ...
  var History = /* @__PURE__ */ function() {
    function History2(ampdoc, binding) {
      _classCallCheck28(this, History2);
      this.ampdoc_ = ampdoc;
  ...
  var HistoryBindingNatural_ = /* @__PURE__ */ function() {
    function HistoryBindingNatural_2(win) {
      var _this9 = this;
      _classCallCheck28(this, HistoryBindingNatural_2);
      this.win = win;
    ...
    _createClass26(HistoryBindingNatural_2, [{
      key: "cleanup",
      value: function cleanup() {
  ...
  var HistoryBindingVirtual_ = /* @__PURE__ */ function() {
    function HistoryBindingVirtual_2(win, viewer) {
      var _this17 = this;
      _classCallCheck28(this, HistoryBindingVirtual_2);
      this.win = win;
      this.viewer_ = viewer;
      this.stackIndex_ = 0;
      this.onStateUpdated_ = null;
    ...
    _createClass26(HistoryBindingVirtual_2, [{
      key: "replaceStateForTarget",
      value: function replaceStateForTarget(target) {
        devAssert(target[0] == "#", "target should start with a #");
  ...
  var ElementStub = /* @__PURE__ */ function(_BaseElement) {
    ...
    function ElementStub2() {
      _classCallCheck29(this, ElementStub2);
  ...
  var MediaQueryProps = /* @__PURE__ */ function() {
    function MediaQueryProps2(win, callback) {
      _classCallCheck30(this, MediaQueryProps2);
      this.win_ = win;
      this.callback_ = callback;
      this.exprMap_ = {};
      this.prevExprMap_ = null;
    }
    _createClass27(MediaQueryProps2, [{
      key: "start",
  ...
  var Resource = /* @__PURE__ */ function() {
    function Resource2(id, element, resources) {
      _classCallCheck31(this, Resource2);
  ...
  var Signals = /* @__PURE__ */ function() {
    function Signals2() {
      _classCallCheck32(this, Signals2);
      this.map_ = map();
      this.promiseMap_ = null;
    }
    _createClass29(Signals2, [{
      key: "get",
      value: function get(name) {
  ...
  var Scheduler = /* @__PURE__ */ function() {
    function Scheduler2(ampdoc) {
      var _this = this;
      _classCallCheck33(this, Scheduler2);
      this.ampdoc_ = ampdoc;
      var win = ampdoc.win;
  ...
  var Task = /* @__PURE__ */ function() {
    function Task2(fn) {
      _classCallCheck34(this, Task2);
      this.state = TaskState.NOT_RUN;
      this.fn_ = fn;
    }
    _createClass31(Task2, [{
      key: "runTask_",
  ...
  var StartupTask = /* @__PURE__ */ function(_Task) {
    ...
    function StartupTask2(fn, win, chunks) {
      var _this;
      _classCallCheck34(this, StartupTask2);
      _this = _super.call(this, fn);
      _this.chunks_ = chunks;
      return _this;
    }
    _createClass31(StartupTask2, [{
      key: "onTaskError_",
      value: function onTaskError_(unusedError) {
  ...
  var Chunks = /* @__PURE__ */ function() {
    function Chunks2(ampDoc) {
      var _this2 = this;
      _classCallCheck34(this, Chunks2);
      this.ampdoc = ampDoc;
      this.win_ = ampDoc.win;
  ...
  function createCustomElementClass(win, elementConnectedCallback2) {
    ...
    var CustomAmpElement = /* @__PURE__ */ function(_BaseCustomElement) {
      ...
      function CustomAmpElement2() {
        _classCallCheck35(this, CustomAmpElement2);
        return _super.apply(this, arguments);
      }
      _createClass32(CustomAmpElement2, [{
        key: "adoptedCallback",
  ...
  function createBaseCustomElementClass(win, elementConnectedCallback2) {
    ...
    var BaseCustomElement = /* @__PURE__ */ function(_htmlElement) {
      ...
      function BaseCustomElement2() {
        var _this;
        _classCallCheck35(this, BaseCustomElement2);
        _this = _super2.call(this);
        _this.createdCallback();
        return _this;
      }
      _createClass32(BaseCustomElement2, [{
        key: "createdCallback",
        ...
        value: function overflowCallback(overflown, requestedHeight, requestedWidth) {
          ...
          if (!this.overflowElement_) {
            if (overflown && this.warnOnMissingOverflow) {
              user().warn(TAG8, "Cannot resize element and overflow is not available", this);
            }
          } else {
  ...
  var AmpImg = /* @__PURE__ */ function(_BaseElement) {
    ...
    function AmpImg2(element) {
      var _this;
      _classCallCheck36(this, AmpImg2);
    ...
    _createClass33(AmpImg2, [{
      ...
      value: function mutatedAttributesCallback(mutations) {
        if (this.img_) {
          ...
          if (mutations["src"] && !mutations["srcset"] && this.element.hasAttribute("srcset")) {
            ...
            attrs.push("srcset");
            this.user().warn(TAG9, "Removed [srcset] since [src] was mutated. Recommend adding a [srcset] binding to support responsive images.", this.element);
          }
      ...
      value: function initialize_() {
        ...
        if (this.element.getAttribute("role") == "img") {
          ...
          this.user().error(TAG9, "Setting role=img on amp-img elements breaks screen readers please just set alt or ARIA attributes, they will be correctly propagated for the underlying <img> element.");
        }
  ...
  function installImg(win) {
    registerElement(win, TAG9, AmpImg);
  }
  ...
  var InaboxResources = /* @__PURE__ */ function() {
    function InaboxResources2(ampdoc) {
      var _this = this;
      _classCallCheck38(this, InaboxResources2);
      this.ampdoc_ = ampdoc;
      this.win = ampdoc.win;
      this.resources_ = [];
    ...
    _createClass35(InaboxResources2, [{
      key: "dispose",
      value: function dispose() {
  ...
  var AmpLayout = /* @__PURE__ */ function(_BaseElement) {
    ...
    function AmpLayout2() {
      _classCallCheck40(this, AmpLayout2);
      return _super.apply(this, arguments);
    }
    _createClass37(AmpLayout2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
  ...
  var LoadingIndicatorImpl = /* @__PURE__ */ function() {
    function LoadingIndicatorImpl2(ampdoc) {
      _classCallCheck41(this, LoadingIndicatorImpl2);
      this.ampdoc_ = ampdoc;
      var win = ampdoc.win;
    ...
    _createClass38(LoadingIndicatorImpl2, [{
      key: "dispose",
      value: function dispose() {
        this.io_.disconnect();
      }
  ...
  var FocusHistory = /* @__PURE__ */ function() {
    function FocusHistory2(win, purgeTimeout) {
      var _this = this;
      _classCallCheck42(this, FocusHistory2);
      this.win = win;
  ...
  var MutatorImpl = /* @__PURE__ */ function() {
    function MutatorImpl2(ampdoc) {
      var _this = this;
      _classCallCheck43(this, MutatorImpl2);
      this.ampdoc = ampdoc;
      this.win = ampdoc.win;
  ...
  var OwnersImpl = /* @__PURE__ */ function() {
    function OwnersImpl2(ampdoc) {
      _classCallCheck44(this, OwnersImpl2);
      this.resources_ = Services.resourcesForDoc(ampdoc);
    }
    _createClass41(OwnersImpl2, [{
      key: "setOwner",
      value: function setOwner(element, owner) {
  ...
  function createPixel(win, src, referrerPolicy) {
    if (referrerPolicy && referrerPolicy !== "no-referrer") {
      user().error(TAG11, "Unsupported referrerPolicy: %s", referrerPolicy);
    }
  ...
  var AmpPixel = /* @__PURE__ */ function(_BaseElement) {
    ...
    function AmpPixel2(element) {
      var _this;
      _classCallCheck45(this, AmpPixel2);
      _this = _super.call(this, element);
      _this.triggerPromise_ = null;
      return _this;
    }
    _createClass42(AmpPixel2, [{
      key: "isLayoutSupported",
      ...
      value: function buildCallback() {
        ...
        if (this.referrerPolicy_) {
          userAssert(this.referrerPolicy_ == "no-referrer", TAG12 + ': invalid "referrerpolicy" value "' + this.referrerPolicy_ + '". Only "no-referrer" is supported');
        }
        if (this.element.hasAttribute("i-amphtml-ssr") && this.element.querySelector("img")) {
          dev().info(TAG12, "inabox img already present");
          return;
        }
      ...
      value: function trigger_() {
        ...
        if (this.triggerPromise_) {
          dev().error(TAG12, "duplicate pixel");
        ...
        this.triggerPromise_ = Services.timerFor(this.win).promise(1).then(function() {
          ...
          return Services.urlReplacementsForDoc(_this2.element).expandUrlAsync(_this2.assertSource_(src)).then(function(src2) {
            ...
            dev().info(TAG12, "pixel triggered: ", src2);
            return pixel;
          });
        });
      }
  ...
  function installPixel(win) {
    registerElement(win, TAG12, AmpPixel);
  }
  ...
  var Platform = /* @__PURE__ */ function() {
    function Platform2(win) {
      _classCallCheck46(this, Platform2);
      this.navigator_ = win.navigator;
      this.win_ = win;
    }
    _createClass43(Platform2, [{
      key: "isAndroid",
  ...
  var PreconnectService = /* @__PURE__ */ function() {
    function PreconnectService2(win) {
      _classCallCheck47(this, PreconnectService2);
    ...
    _createClass44(PreconnectService2, [{
      key: "url",
  ...
  var FiniteStateMachine = /* @__PURE__ */ function() {
    function FiniteStateMachine2(initialState) {
      _classCallCheck48(this, FiniteStateMachine2);
      this.state_ = initialState;
      this.transitions_ = map();
    }
    _createClass45(FiniteStateMachine2, [{
      key: "addTransition",
  ...
  var TaskQueue = /* @__PURE__ */ function() {
    function TaskQueue2() {
      _classCallCheck49(this, TaskQueue2);
      this.tasks_ = [];
      this.taskIdMap_ = {};
      this.lastEnqueueTime_ = 0;
      this.lastDequeueTime_ = 0;
    }
    _createClass46(TaskQueue2, [{
      key: "getSize",
    ...
    return new Promise(function(resolve) {
      ...
      var interval = win.setInterval(function() {
        ...
        if (matches2 || now > endTime) {
          ...
          resolve();
          if (!matches2) {
            dev().error(TAG13, "IE media never resolved");
          }
        }
      }, 10);
    });
  ...
  function matchMediaIeQuite(win) {
    ...
    try {
      ...
      dev().error(TAG13, "IE matchMedia failed: ", e);
      return true;
    }
  }
  ...
  var ResourcesImpl = /* @__PURE__ */ function() {
    function ResourcesImpl2(ampdoc) {
      var _this = this;
      _classCallCheck50(this, ResourcesImpl2);
      this.ampdoc = ampdoc;
      this.win = ampdoc.win;
  ...
  var StandardActions = /* @__PURE__ */ function() {
    ...
    _createClass48(StandardActions2, [{
      key: "installActions_",
        ...
        switch (method) {
          ...
          case "optoutOfCid":
            return Services.cidForDoc(this.ampdoc).then(function(cid) {
              ...
              dev().error(TAG14, "Failed to opt out of CID", reason);
            });
        }
      ...
      value: function handleShow_(invocation) {
        ...
        if (target.classList.contains(getLayoutClass(Layout.NODISPLAY))) {
          user().warn(TAG14, "Elements with layout=nodisplay cannot be dynamically shown.", target);
          return null;
        }
        this.mutator_.measureElement(function() {
          if (computedStyle(ownerWindow, target).display == "none" && !isShowable(target)) {
            user().warn(TAG14, 'Elements can only be dynamically shown when they have the "hidden" attribute set or when they were dynamically hidden.', target);
          }
        });
  ...
  var Storage = /* @__PURE__ */ function() {
    function Storage2(ampdoc, viewer, binding) {
      _classCallCheck52(this, Storage2);
      this.ampdoc = ampdoc;
      this.viewer_ = viewer;
      this.binding_ = binding;
    ...
    _createClass49(Storage2, [{
      ...
      value: function getStore_() {
        if (!this.storePromise_) {
          this.storePromise_ = this.binding_.loadBlob(this.origin_).then(function(blob) {
            ...
            dev().expectedError(TAG15, "Failed to load store: ", reason);
            return {};
          }).then(function(obj) {
      ...
      value: function listenToBroadcasts_() {
        ...
        this.viewer_.onBroadcast(function(message) {
          if (message["type"] == "amp-storage-reset" && message["origin"] == _this2.origin_) {
            dev().fine(TAG15, "Received reset message");
      ...
      value: function broadcastReset_() {
        dev().fine(TAG15, "Broadcasted reset message");
  ...
  var LocalStorageBinding = /* @__PURE__ */ function() {
    function LocalStorageBinding2(win) {
      _classCallCheck52(this, LocalStorageBinding2);
      this.win = win;
    ...
    _createClass49(LocalStorageBinding2, [{
  ...
  var ViewerStorageBinding = /* @__PURE__ */ function() {
    function ViewerStorageBinding2(viewer) {
      _classCallCheck52(this, ViewerStorageBinding2);
      this.viewer_ = viewer;
    }
    _createClass49(ViewerStorageBinding2, [{
      key: "loadBlob",
      value: function loadBlob(origin) {
      ...
      value: function saveBlob(origin, blob) {
        return this.viewer_.sendMessageAwaitResponse("saveStore", dict({
          ...
          throw dev().createExpectedError(TAG15, "Failed to save store: ", reason);
        });
      }
    }]);
  ...
  var Templates = /* @__PURE__ */ function() {
    function Templates2(ampdoc) {
      _classCallCheck53(this, Templates2);
      this.ampdoc_ = ampdoc;
      this.templateClassMap_ = {};
      this.templateClassResolvers_ = {};
    }
    _createClass50(Templates2, [{
      key: "whenReady",
  ...
  function installTimerService(window2) {
    registerServiceBuilder(window2, TAG16, Timer);
  }
  ...
  var VariableSource = /* @__PURE__ */ function() {
    function VariableSource2(ampdoc) {
      _classCallCheck56(this, VariableSource2);
      this.ampdoc = ampdoc;
      this.replacements_ = Object.create(null);
      this.initialized_ = false;
      this.getUrlMacroAllowlist_();
    }
    _createClass53(VariableSource2, [{
      key: "initialize_",
      value: function initialize_() {
        this.initialize();
  ...
  var Expander = /* @__PURE__ */ function() {
    function Expander2(variableSource, opt_bindings, opt_collectVars, opt_sync, opt_allowlist, opt_noEncode) {
      _classCallCheck57(this, Expander2);
    ...
    _createClass54(Expander2, [{
      ...
      value: function evaluateBinding_(bindingInfo, opt_args) {
        ...
        if (bindingInfo.prioritized != void 0) {
          ...
          user().error(TAG17, "ignoring async replacement key: ", bindingInfo.name);
          binding = "";
        } else {
      ...
      value: function evaluateBindingSync_(binding, name, opt_args) {
        try {
          ...
          if (value && typeof value.then == "function") {
            user().error(TAG17, "ignoring async macro resolution");
            result = "";
  ...
  var GlobalVariableSource = /* @__PURE__ */ function(_VariableSource) {
    ...
    function GlobalVariableSource2() {
      _classCallCheck58(this, GlobalVariableSource2);
      return _super.apply(this, arguments);
    }
    _createClass55(GlobalVariableSource2, [{
          ...
          return Services.cidForDoc(_this2.ampdoc).then(function(cid) {
            ...
            if (cid && cookieName == "_ga") {
              if (typeof cid === "string") {
                ...
                dev().error(TAG18, "non-string cid, what is it?", Object.keys(cid));
              }
            }
            clientIds[scope] = cid;
            return cid;
      ...
      value: function getAccessValue_(getter, expr) {
        ...
        return Promise.all([Services.accessServiceForDocOrNull(element), Services.subscriptionsServiceForDocOrNull(element)]).then(function(services) {
          ...
          if (!service) {
            user().error(TAG18, "Access or subsciptions service is not installed to access: ", expr);
            return null;
          }
  ...
  var UrlReplacements = /* @__PURE__ */ function() {
    function UrlReplacements2(ampdoc, variableSource) {
      _classCallCheck58(this, UrlReplacements2);
      this.ampdoc = ampdoc;
      this.variableSource_ = variableSource;
    }
    _createClass55(UrlReplacements2, [{
      ...
      value: function ensureProtocolMatches_(url, replacement) {
        ...
        if (newProtocol != oldProtocol) {
          user().error(TAG18, "Illegal replacement of the protocol: ", url);
          return url;
        }
  ...
  var ViewerImpl = /* @__PURE__ */ function() {
    function ViewerImpl2(ampdoc) {
      var _this = this;
      _classCallCheck59(this, ViewerImpl2);
      this.ampdoc = ampdoc;
      this.win = ampdoc.win;
  ...
  var Bezier = /* @__PURE__ */ function() {
    function Bezier2() {
      _classCallCheck60(this, Bezier2);
    }
    _createClass57(Bezier2, null, [{
  ...
  var Animation = /* @__PURE__ */ function() {
    function Animation2(contextNode, opt_vsync) {
      _classCallCheck61(this, Animation2);
      this.contextNode_ = contextNode;
      this.vsync_ = opt_vsync || Services.vsyncFor(self);
      this.curve_ = null;
      this.segments_ = [];
    }
    _createClass58(Animation2, [{
      key: "setCurve",
  ...
  var AnimationPlayer = /* @__PURE__ */ function() {
    function AnimationPlayer2(vsync, contextNode, segments, defaultCurve, duration) {
      _classCallCheck61(this, AnimationPlayer2);
      this.vsync_ = vsync;
      this.contextNode_ = contextNode;
      this.segments_ = [];
    ...
    _createClass58(AnimationPlayer2, [{
      key: "then",
  ...
  var ViewportBindingIosEmbedWrapper_ = /* @__PURE__ */ function() {
    function ViewportBindingIosEmbedWrapper_2(win) {
      var _this = this;
      _classCallCheck62(this, ViewportBindingIosEmbedWrapper_2);
      this.win = win;
      this.vsync_ = Services.vsyncFor(win);
      var doc = this.win.document;
    ...
    _createClass59(ViewportBindingIosEmbedWrapper_2, [{
  ...
  var ViewportBindingNatural_ = /* @__PURE__ */ function() {
    function ViewportBindingNatural_2(ampdoc) {
      var _this = this;
      _classCallCheck63(this, ViewportBindingNatural_2);
      this.ampdoc = ampdoc;
      this.win = ampdoc.win;
    ...
    _createClass60(ViewportBindingNatural_2, [{
  ...
  var ViewportImpl = /* @__PURE__ */ function() {
    function ViewportImpl2(ampdoc, binding, viewer) {
      var _this = this;
      _classCallCheck64(this, ViewportImpl2);
      var win = ampdoc.win;
      this.ampdoc = ampdoc;
  ...
  var Extensions = /* @__PURE__ */ function() {
    function Extensions2(win) {
      _classCallCheck66(this, Extensions2);
      this.win = win;
    ...
    _createClass63(Extensions2, [{
      ...
      value: function waitForExtension(extensionId, version) {
        ...
        return Services.timerFor(this.win).timeoutPromise(16e3, wait).catch(function(err) {
          ...
          user().error(TAG19, "Waited over 16s to load extension " + extensionId + ".");
          return wait;
        });
      }
    }, {
      ...
      value: function getCurrentExtensionHolder_(opt_forName) {
        if (!this.currentExtensionId_ && !getMode(this.win).test) {
          dev().error(TAG19, "unknown extension for ", opt_forName);
        }
    ...
    for (var i = 0; i < preregisteredExtensions.length; i++) {
      ...
      if (maybeLoadCorrectVersion(global, fnOrStruct)) {
        ...
        try {
          ...
          dev().error(TAG20, "Extension failed: ", e, fnOrStruct.n);
        }
        preregisteredExtensions.splice(i--, 1);
      }
    }
    maybePumpEarlyFrame(global, function() {
      ...
      for (var _i = 0; _i < preregisteredExtensions.length; _i++) {
        ...
        try {
          ...
          dev().error(TAG20, "Extension failed: ", e, _fnOrStruct.n);
        }
      }
  ...
  var AmpDocService = /* @__PURE__ */ function() {
    function AmpDocService2(win, isSingleDoc, opt_initParams) {
      _classCallCheck67(this, AmpDocService2);
      this.win = win;
  ...
  var AmpDoc = /* @__PURE__ */ function() {
    function AmpDoc2(win, parent, opt_options) {
      var _this = this;
      _classCallCheck67(this, AmpDoc2);
      this.win = win;
  ...
  var AmpDocSingle = /* @__PURE__ */ function(_AmpDoc) {
    ...
    function AmpDocSingle2(win, opt_options) {
      var _this3;
      _classCallCheck67(this, AmpDocSingle2);
  ...
  var AmpDocShadow = /* @__PURE__ */ function(_AmpDoc2) {
    ...
    function AmpDocShadow2(win, url, shadowRoot, opt_options) {
      var _this4;
      _classCallCheck67(this, AmpDocShadow2);
  ...
  var AmpDocFie = /* @__PURE__ */ function(_AmpDoc3) {
    ...
    function AmpDocFie2(win, url, parent, opt_options) {
      var _this5;
      _classCallCheck67(this, AmpDocFie2);
  ...
  if (self.console) {
    (console.info || console.log).call(console, "Powered by AMP \u26A1 HTML shadows \u2013 Version " + internalRuntimeVersion());
  }
