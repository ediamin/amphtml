(() => {
  ...
  var AmpStoryEntryPoint = /* @__PURE__ */ function() {
    function AmpStoryEntryPoint2(win, element) {
      _classCallCheck(this, AmpStoryEntryPoint2);
      this.win_ = win;
    ...
    _createClass(AmpStoryEntryPoint2, [{
      key: "buildCallback",
  ...
  var AmpStoryPlayerViewportObserver = /* @__PURE__ */ function() {
    function AmpStoryPlayerViewportObserver2(win, element, viewportCb) {
      _classCallCheck3(this, AmpStoryPlayerViewportObserver2);
      this.win_ = win;
      this.element_ = element;
      this.cb_ = viewportCb;
    ...
    _createClass2(AmpStoryPlayerViewportObserver2, [{
  ...
  var WindowPortEmulator = /* @__PURE__ */ function() {
    function WindowPortEmulator2(win, origin, target) {
      _classCallCheck4(this, WindowPortEmulator2);
      this.win_ = win;
      this.origin_ = origin;
      this.target_ = target;
    }
    _createClass3(WindowPortEmulator2, [{
  ...
  var Messaging = /* @__PURE__ */ function() {
    function Messaging2(win, port, opt_isWebview, opt_token, opt_verifyToken) {
      _classCallCheck4(this, Messaging2);
      this.win_ = win;
      this.port_ = port;
  ...
  var PageScroller = /* @__PURE__ */ function() {
    function PageScroller2(win) {
      _classCallCheck5(this, PageScroller2);
      this.win_ = win;
...
/*# sourceURL=/css/amp-story-player-iframe.css*/`;
  ...
  var AmpStoryComponentManager = /* @__PURE__ */ function() {
    function AmpStoryComponentManager2(win) {
      _classCallCheck9(this, AmpStoryComponentManager2);
      this.win_ = win;
    }
    _createClass8(AmpStoryComponentManager2, [{
      key: "layoutEl_",
      value: function layoutEl_(element) {
        var _this = this;
      ...
      key: "loadEntryPoints",
      value: function loadEntryPoints() {
        var doc = this.win_.document;
