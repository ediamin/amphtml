(self.AMP=self.AMP||[]).push({n:"amp-3d-gltf",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var Amp3dGltf = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function Amp3dGltf2(element) {
      var _this;
      _classCallCheck5(this, Amp3dGltf2);
    ...
    _createClass4(Amp3dGltf2, [{
      ...
      value: function layoutCallback() {
        ...
        observeWithSharedInOb(this.element, function(inViewport) {
          return _this3.viewportCallback_(inViewport);
        });
        if (!isWebGLSupported()) {
  ...
  AMP.extension(TAG3, "0.1", function(AMP2) {
    AMP2.registerElement(TAG3, Amp3dGltf);
  });
})();
