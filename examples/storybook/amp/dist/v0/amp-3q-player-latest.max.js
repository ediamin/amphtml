(self.AMP=self.AMP||[]).push({n:"amp-3q-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var Amp3QPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function Amp3QPlayer2(element) {
      var _this;
      _classCallCheck8(this, Amp3QPlayer2);
    ...
    _createClass7(Amp3QPlayer2, [{
      ...
      value: function buildCallback() {
        var el = this.element;
        this.dataId = userAssert(el.getAttribute("data-id"), "The data-id attribute is required for <amp-3q-player> %s", el);
        var deferred = new Deferred();
      ...
      key: "generateIframeSrc_",
      value: function generateIframeSrc_() {
        var _this2 = this;
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, Amp3QPlayer);
  });
})();
