(self.AMP=self.AMP||[]).push({n:"amp-accordion",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var _excluded3 = ["as", "children", "className", "id", "role", "tabIndex"];
  var _excluded4 = ["as", "children", "className", "id", "role"];
  function _extends() {
  ...
  function AccordionWithRef(_ref, ref) {
    ...
    var toggle2 = useCallback(function(id2) {
      if (id2) {
  ...
  function setExpanded(id, value, expandedMap, expandSingleSection) {
    ...
    if (expandSingleSection && value) {
      ...
      var _extends32;
      newExpandedMap = _extends({}, expandedMap, (_extends32 = {}, _extends32[id] = value, _extends32));
    }
    return newExpandedMap;
  }
  ...
  function AccordionHeader(_ref4) {
    var _ref4$as = _ref4.as, Comp = _ref4$as === void 0 ? "div" : _ref4$as, children = _ref4.children, _ref4$className = _ref4.className, className = _ref4$className === void 0 ? "" : _ref4$className, id = _ref4.id, _ref4$role = _ref4.role, role = _ref4$role === void 0 ? "button" : _ref4$role, _ref4$tabIndex = _ref4.tabIndex, tabIndex = _ref4$tabIndex === void 0 ? 0 : _ref4$tabIndex, rest = _objectWithoutPropertiesLoose(_ref4, _excluded3);
    ...
    return createElement(Comp, _extends({}, rest, {
      id: headerId,
      role,
      className: className + " " + $sectionChild + " " + $header,
      tabIndex,
  ...
  function AccordionContent(_ref5) {
    var _objstr;
    var _ref5$as = _ref5.as, Comp = _ref5$as === void 0 ? "div" : _ref5$as, children = _ref5.children, _ref5$className = _ref5.className, className = _ref5$className === void 0 ? "" : _ref5$className, id = _ref5.id, _ref5$role = _ref5.role, role = _ref5$role === void 0 ? "region" : _ref5$role, rest = _objectWithoutPropertiesLoose(_ref5, _excluded4);
    var ref = useRef(null);
    ...
    return createElement(WithAmpContext, {
      ...
      ref,
      className: obj_str_default((_objstr = {}, _objstr[className] = true, _objstr[$sectionChild] = true, _objstr[$contentHidden] = !expanded, _objstr)),
      id: contentId,
  ...
  var _excluded5 = ["as", "children", "className", "contentAs", "contentClassName", "contentProps", "contentRef", "contentStyle", "layout", "paint", "size", "style", "wrapperClassName", "wrapperStyle"];
  function _extends5() {
  ...
  var _excluded6 = ["as", "children", "className", "style", "wrapperClassName", "wrapperStyle"];
  function _extends6() {
  ...
  function WrapperWithRef(_ref, ref) {
    var _ref$as = _ref.as, Comp = _ref$as === void 0 ? "div" : _ref$as, children = _ref.children, className = _ref["className"], style = _ref["style"], wrapperClassName = _ref.wrapperClassName, wrapperStyle = _ref.wrapperStyle, rest = _objectWithoutPropertiesLoose3(_ref, _excluded6);
  ...
  var SECTION_SHIM_PROP = "__AMP_S_SHIM";
      ...
      value: function init() {
        ...
        var getExpandStateTrigger = function getExpandStateTrigger2(section) {
          return function(expanded) {
            return _this.triggerEvent(section, expanded ? "expand" : "collapse");
          };
        };
  ...
  function getState(element, mu, getExpandStateTrigger) {
    ...
    var children = sections.map(function(section) {
      ...
      var sectionShim = memo(section, SECTION_SHIM_PROP, bindSectionShimToElement);
      ...
      return createElement(AccordionSection, _extends7({}, sectionProps), createElement(AccordionHeader, _extends7({}, headerProps)), createElement(AccordionContent, _extends7({}, contentProps)));
    });
    return dict({
      "children": children
    });
  }
  function SectionShim(sectionElement, _ref) {
    var children = _ref.children, expanded = _ref.expanded;
    useLayoutEffect(function() {
  ...
  var bindSectionShimToElement = function bindSectionShimToElement2(element) {
    return SectionShim.bind(null, element);
  };
  function HeaderShim(sectionElement, _ref2) {
    var ariaControls = _ref2["aria-controls"], ariaExpanded = _ref2["aria-expanded"], id = _ref2.id, onClick = _ref2.onClick, role = _ref2.role;
  ...
  function ContentShimWithRef(sectionElement, _ref3, ref) {
    var ariaLabelledBy = _ref3["aria-labelledby"], id = _ref3.id, role = _ref3.role;
  ...
  var AmpAccordion = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpAccordion2, _BaseElement);
    var _super = _createSuper3(AmpAccordion2);
    function AmpAccordion2() {
      _classCallCheck10(this, AmpAccordion2);
      return _super.apply(this, arguments);
    }
    _createClass9(AmpAccordion2, [{
      key: "init",
      value: function init() {
        ...
        return _get2(_getPrototypeOf3(AmpAccordion2.prototype), "init", this).call(this);
      }
    }, {
      key: "triggerEvent",
      value: function triggerEvent(section, eventName, detail) {
        var event = createCustomEvent(toWin(section.ownerDocument.defaultView), "accordionSection." + eventName, detail);
        Services.actionServiceForDoc(section).trigger(section, eventName, event, ActionTrust.HIGH);
        _get2(_getPrototypeOf3(AmpAccordion2.prototype), "triggerEvent", this).call(this, section, eventName, detail);
      }
    }, {
      key: "isLayoutSupported",
  ...
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpAccordion, CSS2);
  });
})();
