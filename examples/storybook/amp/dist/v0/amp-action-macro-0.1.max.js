(self.AMP=self.AMP||[]).push({n:"amp-action-macro",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpActionMacro = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpActionMacro2(element) {
      var _this;
      _classCallCheck3(this, AmpActionMacro2);
      _this = _super.call(this, element);
      _this.actions_ = null;
      _this.arguments_ = [];
      return _this;
    }
    _createClass2(AmpActionMacro2, [{
      key: "buildCallback",
      ...
      key: "execute_",
      value: function execute_(invocation) {
        ...
        if (args && this.arguments_.length > 0) {
          for (var arg in args) {
            userAssert(this.arguments_.includes(arg), 'Variable argument name "%s" is not defined in %s', arg, this.element);
          }
        }
        if (invocation.caller.tagName.toLowerCase() === TAG) {
          userAssert(this.isValidMacroReference_(invocation.caller), 'Action macro with ID "%s" cannot reference itself or macros defined after it', this.element.getAttribute("id"));
        }
      ...
      key: "isValidMacroReference_",
      value: function isValidMacroReference_(invokingElement) {
  ...
  AMP.extension(TAG, "0.1", function(AMP2) {
    AMP2.registerElement(TAG, AmpActionMacro);
  });
})();
