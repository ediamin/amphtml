(self.AMP=self.AMP||[]).push({n:"amp-ad-custom",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var Validator = /* @__PURE__ */ function() {
    ...
    _createClass(Validator2, [{
      key: "validate",
      value: function validate(unusedContext, unusedContainerElement, unusedUnvalidatedBytes, unusedHeaders) {
      }
    }]);
    return Validator2;
  }();
  ...
  function getAmpAdMetadata(creative) {
    ...
    if (metadataStart < 0) {
      dev().warn(TAG2, "Could not locate start index for amp meta data in: " + creative);
      return null;
    }
    var metadataEnd = creative.lastIndexOf("<\/script>");
    if (metadataEnd < 0) {
      dev().warn(TAG2, "Could not locate closing script tag for amp meta data in: %s", creative);
      return null;
    }
    try {
      ...
      dev().warn(TAG2, "Invalid amp metadata: %s", creative.slice(metadataStart + metadataString.length, metadataEnd));
      return null;
    }
  }
  ...
  var AmpAdNetworkBase = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpAdNetworkBase2(element) {
      var _this;
      _classCallCheck5(this, AmpAdNetworkBase2);
    ...
    _createClass4(AmpAdNetworkBase2, [{
      ...
      value: function layoutCallback() {
        var _this2 = this;
        devAssert(this.adResponsePromise_, "layoutCallback invoked before XHR request!");
      ...
      key: "onFailure",
      value: function onFailure(failure, recovery) {
        if (this.recoveryModes_[failure]) {
          dev().warn(TAG3, "Recovery mode for failure type " + failure + " already registered!");
        }
        this.recoveryModes_[failure] = recovery;
      }
    }, {
      key: "registerValidator",
      value: function registerValidator(validator2, type) {
        if (type === void 0) {
          type = "default";
        }
        if (this.validators_[type]) {
          dev().warn(TAG3, type + " validator already registered.");
        }
        this.validators_[type] = validator2;
      }
    }, {
      key: "registerRenderer",
      value: function registerRenderer(renderer, type) {
        if (this.renderers_[type]) {
          dev().warn(TAG3, "Rendering mode already registered for type '" + type + "'");
        }
      ...
      key: "setRequestRetries",
      value: function setRequestRetries(retries) {
        this.retryLimit_ = retries;
      }
    }, {
      key: "sendRequest_",
      value: function sendRequest_() {
        var _this3 = this;
      ...
      key: "invokeValidator_",
      value: function invokeValidator_(response) {
        var _this4 = this;
        ...
        return response.arrayBuffer().then(function(unvalidatedBytes) {
          ...
          devAssert(_this4.validators_[validatorType], "Validator never registered!");
      ...
      key: "invokeRenderer_",
      value: function invokeRenderer_(validatorOutput) {
      ...
      key: "handleFailure_",
      value: function handleFailure_(failureType, error) {
        ...
        switch (recoveryMode) {
          ...
          case RecoveryModeType.RETRY:
            ...
            break;
          default:
            dev().error(TAG3, "Invalid recovery mode!");
        }
      }
    }, {
      key: "forceCollapse_",
      value: function forceCollapse_() {
  ...
  var DomFingerprint = /* @__PURE__ */ function() {
    function DomFingerprint2() {
      _classCallCheck6(this, DomFingerprint2);
    }
    _createClass5(DomFingerprint2, null, [{
      key: "generate",
  ...
  var NameFrameRenderer = /* @__PURE__ */ function(_Renderer) {
    ...
    function NameFrameRenderer2() {
      _classCallCheck7(this, NameFrameRenderer2);
      return _super.apply(this, arguments);
    }
    _createClass6(NameFrameRenderer2, [{
      key: "render",
      value: function render(context, element, crossDomainData) {
        ...
        var asyncIntersection = getExperimentBranch(element.ownerDocument.defaultView, ADS_INITIAL_INTERSECTION_EXP.id) === ADS_INITIAL_INTERSECTION_EXP.experiment;
        var intersectionPromise = asyncIntersection ? measureIntersection(element) : Promise.resolve(element.getIntersectionChangeEntry());
        return intersectionPromise.then(function(intersection) {
  ...
  var AmpAdTemplateHelper = /* @__PURE__ */ function() {
    function AmpAdTemplateHelper2(ampdoc) {
      _classCallCheck8(this, AmpAdTemplateHelper2);
      this.parentAmpdoc_ = ampdoc;
      this.cache_ = new LruCache(5);
    }
    _createClass7(AmpAdTemplateHelper2, [{
      key: "fetch",
  ...
  var A4AVariableSource = /* @__PURE__ */ function(_VariableSource) {
    _inherits3(A4AVariableSource2, _VariableSource);
    var _super = _createSuper3(A4AVariableSource2);
    function A4AVariableSource2(parentAmpdoc, embedWin) {
      var _this;
      _classCallCheck10(this, A4AVariableSource2);
    ...
    _createClass9(A4AVariableSource2, [{
      key: "initialize",
      value: function initialize() {
        var _this2 = this;
  ...
  var GlobalVariableSource = /* @__PURE__ */ function(_VariableSource) {
    _inherits5(GlobalVariableSource2, _VariableSource);
    var _super = _createSuper5(GlobalVariableSource2);
  ...
  var TemplateRenderer = /* @__PURE__ */ function(_Renderer) {
    ...
    function TemplateRenderer2() {
      _classCallCheck53(this, TemplateRenderer2);
      return _super.call(this);
    }
    _createClass52(TemplateRenderer2, [{
      key: "getDocument",
      value: function getDocument(iframe) {
        return iframe.contentDocument || iframe.contentWindow.document;
      }
    }, {
      key: "render",
      value: function render(context, element, creativeData) {
        var _this = this;
  ...
  var TemplateValidator = /* @__PURE__ */ function(_Validator) {
    ...
    function TemplateValidator2() {
      _classCallCheck54(this, TemplateValidator2);
      return _super.apply(this, arguments);
    }
    _createClass53(TemplateValidator2, [{
      key: "validate",
      value: function validate(context, containerElement, unvalidatedBytes, headers) {
  ...
  var AmpAdTemplate = /* @__PURE__ */ function(_AmpAdNetworkBase) {
    ...
    function AmpAdTemplate2(element) {
      var _this;
      _classCallCheck55(this, AmpAdTemplate2);
      _this = _super.call(this, element);
      ...
      devAssert(_this.baseRequestUrl_, "Invalid network configuration: no request URL specified");
      _this.getContext().win = _this.win;
      return _this;
    }
    _createClass54(AmpAdTemplate2, [{
      key: "buildCallback",
  ...
  var TAG15 = "amp-ad-custom";
  AMP.extension(TAG15, "0.1", function(AMP2) {
    AMP2.registerElement(TAG15, AmpAdTemplate);
  });
})();
