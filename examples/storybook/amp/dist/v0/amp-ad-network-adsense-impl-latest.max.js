(self.AMP=self.AMP||[]).push({n:"amp-ad-network-adsense-impl",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var SignatureVerifier = /* @__PURE__ */ function() {
    function SignatureVerifier2(win, signingServerURLs2) {
      _classCallCheck3(this, SignatureVerifier2);
      this.win_ = win;
    ...
    _createClass2(SignatureVerifier2, [{
      key: "loadKeyset",
  ...
  var AdsenseSharedState = /* @__PURE__ */ function() {
    function AdsenseSharedState2() {
      _classCallCheck4(this, AdsenseSharedState2);
      this.previousSlots_ = [];
    }
    _createClass3(AdsenseSharedState2, [{
      key: "addNewSlot",
    ...
    _createClass5(A4AVariableSource2, [{
      ...
      value: function htmlAttributeBinding_(cssSelector, var_args) {
        ...
        if (attributeNames.length > HTML_ATTR_MAX_ATTRS) {
          user().error(TAG18, "At most " + HTML_ATTR_MAX_ATTRS + " may be requested.");
          return "[]";
        }
        ...
        try {
          ...
          user().error(TAG18, "Invalid selector: " + cssSelector);
          return "[]";
        }
        if (elements2.length > HTML_ATTR_MAX_ELEMENTS_TO_TRAVERSE) {
          user().error(TAG18, "CSS selector may match at most " + (HTML_ATTR_MAX_ELEMENTS_TO_TRAVERSE + " elements."));
          return "[]";
        }
        var result = [];
  ...
  function onDocumentFormSubmit_(e) {
    ...
    if (method == "GET") {
      ...
      if (action) {
        var TAG18 = "form";
        user().error(TAG18, "action attribute is invalid for method=POST: %s", form);
      }
      if (!actionXhr) {
        e.preventDefault();
  ...
  var RealTimeConfigService = /* @__PURE__ */ function() {
    function RealTimeConfigService2(ampDoc) {
      _classCallCheck53(this, RealTimeConfigService2);
      this.ampDoc_ = ampDoc;
    }
    _createClass52(RealTimeConfigService2, [{
  ...
  var RealTimeConfigManager = /* @__PURE__ */ function() {
    function RealTimeConfigManager2(ampDoc) {
      _classCallCheck53(this, RealTimeConfigManager2);
      this.ampDoc_ = ampDoc;
      this.win_ = ampDoc.win;
      this.seenUrls_ = {};
    ...
    _createClass52(RealTimeConfigManager2, [{
  ...
  var AmpA4A = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpA4A2(element) {
      var _this;
      _classCallCheck54(this, AmpA4A2);
  ...
  var ResponsiveState = /* @__PURE__ */ function() {
    function ResponsiveState2(element, isContainerWidth) {
      _classCallCheck55(this, ResponsiveState2);
    ...
    _createClass54(ResponsiveState2, [{
      key: "isValidElement",
      value: function isValidElement() {
        ...
        if (!this.element_.hasAttribute("data-full-width")) {
          user().warn(TAG16, "Responsive AdSense ad units require the attribute data-full-width.");
          return false;
        }
        ...
        if (height != 0 && height != ADSENSE_RSPV_ALLOWED_HEIGHT) {
          user().warn(TAG16, "Specified height " + height + " in <amp-ad> tag is not equal to the " + ("required height of " + ADSENSE_RSPV_ALLOWED_HEIGHT + " for ") + "responsive AdSense ad units.");
          return false;
        }
        if (width != "100vw") {
          user().warn(TAG16, "Invalid width " + width + " for full-width responsive <amp-ad> tag. Width must be 100vw.");
          return false;
        }
        return true;
      }
      ...
      key: "alignToViewport",
      value: function alignToViewport() {
        var _this = this;
      ...
      key: "isContainerWidthState",
      value: function isContainerWidthState() {
        return this.isContainerWidth_;
      }
    }, {
      key: "getAutoFormat_",
      value: function getAutoFormat_() {
        return this.element_.getAttribute("data-auto-format");
      }
    }, {
      key: "getRafmtParam",
      value: function getRafmtParam() {
        return RAFMT_PARAMS[this.getAutoFormat_()];
      }
    }, {
      key: "isInResponsiveHeightFixExperimentBranch_",
      value: function isInResponsiveHeightFixExperimentBranch_() {
        var _this2 = this;
      ...
      key: "attemptToMatchResponsiveHeight",
      value: function attemptToMatchResponsiveHeight() {
        var _this3 = this;
        var viewportSize = Services.viewportForDoc(this.element_.getAmpDoc()).getSize();
        return this.element_.getImpl(false).then(function(impl) {
          return impl.attemptChangeSize(_this3.getResponsiveHeight_(viewportSize), viewportSize.width).catch(function() {
            dev().info(TAG16, "Change size attempt failed.");
          });
        });
      }
    }, {
      key: "getResponsiveHeight_",
      value: function getResponsiveHeight_(viewportSize) {
      ...
      key: "createIfResponsive",
      value: function createIfResponsive(element) {
      ...
      key: "createContainerWidthState",
      value: function createContainerWidthState(element) {
        return new ResponsiveState2(element, true);
      }
    }, {
      key: "maybeUpgradeToResponsive",
      value: function maybeUpgradeToResponsive(element, adClientId) {
        ...
        return Services.storageForDoc(element).then(function(storage) {
          ...
          dev().warn(TAG16, "Failed to look up publisher ad size settings.");
          return null;
        });
      }
    }, {
      key: "upgradeToResponsive_",
      value: function upgradeToResponsive_(element) {
      ...
      key: "convertToContainerWidth",
      value: function convertToContainerWidth(element) {
      ...
      key: "maybeAttachSettingsListener",
      value: function maybeAttachSettingsListener(element, iframe, adClientId) {
        var promiseResolver;
        ...
        var listener = function listener2(event) {
          ...
          Services.storageForDoc(element).then(function(storage) {
            return storage.set(ResponsiveState2.getAdSizeOptimizationStorageKey_(adClientId), autoAdSizeStatus).then(function() {
              dev().info(TAG16, "Saved publisher auto ad size setting: " + autoAdSizeStatus);
              promiseResolver();
            });
          }).catch(function() {
            dev().warn(TAG16, "Failed to persist publisher auto ad size setting.");
          });
        };
      ...
      key: "getAdSizeOptimizationStorageKey_",
      value: function getAdSizeOptimizationStorageKey_(adClientId) {
        return "aas-" + adClientId;
      }
    }, {
      key: "isLayoutViewportNarrow",
      value: function isLayoutViewportNarrow(element) {
  ...
  var TAG17 = "amp-ad-network-adsense-impl";
  ...
  var AmpAdNetworkAdsenseImpl = /* @__PURE__ */ function(_AmpA4A) {
    ...
    function AmpAdNetworkAdsenseImpl2(element) {
      var _this;
      _classCallCheck56(this, AmpAdNetworkAdsenseImpl2);
      _this = _super.call(this, element);
    ...
    _createClass55(AmpAdNetworkAdsenseImpl2, [{
      key: "isValidElement",
      value: function isValidElement() {
      ...
      value: function buildCallback() {
        var _this2 = this;
        _get2(_getPrototypeOf5(AmpAdNetworkAdsenseImpl2.prototype), "buildCallback", this).call(this);
        this.identityTokenPromise_ = this.getAmpDoc().whenFirstVisible().then(function() {
          return getIdentityToken(_this2.win, _this2.getAmpDoc(), _get2(_getPrototypeOf5(AmpAdNetworkAdsenseImpl2.prototype), "getConsentPolicy", _this2).call(_this2));
        });
      ...
      key: "getAdUrl",
      value: function getAdUrl(consentTuple, opt_unusedRtcResponsesPromise, opt_serveNpaSignal) {
        var _this4 = this;
        ...
        if (consentState == CONSENT_POLICY_STATE.UNKNOWN && this.element.getAttribute("data-npa-on-unknown-consent") != "true") {
          user().info(TAG17, "Ad request suppressed due to unknown consent");
          return Promise.resolve("");
        }
        var startTime = Date.now();
        var global = this.win;
        ...
        var parameters = {
          ...
          "spsa": this.isSinglePageStoryAd ? viewportSize.width + "x" + viewportSize.height : null
        };
        var experimentIds = [];
        ...
        return identityPromise.then(function(identity) {
          return googleAdUrl(_this4, ADSENSE_BASE_URL, startTime, _extends6({
      ...
      value: function onNetworkFailure(error, adUrl) {
        dev().info(TAG17, "network error, attempt adding of error parameter", error);
        return {
      ...
      value: function maybeValidateAmpCreative(bytes, headers) {
        if (headers.get("AMP-Verification-Checksum-Algorithm") !== "djb2a-32") {
          return _get2(_getPrototypeOf5(AmpAdNetworkAdsenseImpl2.prototype), "maybeValidateAmpCreative", this).call(this, bytes, headers);
        }
      ...
      value: function onCreativeRender(creativeMetaData) {
        _get2(_getPrototypeOf5(AmpAdNetworkAdsenseImpl2.prototype), "onCreativeRender", this).call(this, creativeMetaData);
        if (this.iframe != null) {
      ...
      value: function unlayoutCallback() {
        ...
        var superResult = _get2(_getPrototypeOf5(AmpAdNetworkAdsenseImpl2.prototype), "unlayoutCallback", this).call(this);
      ...
      key: "onLayoutMeasure",
      value: function onLayoutMeasure() {
        _get2(_getPrototypeOf5(AmpAdNetworkAdsenseImpl2.prototype), "onLayoutMeasure", this).call(this);
  ...
  AMP.extension(TAG17, "0.1", function(AMP2) {
    AMP2.registerElement(TAG17, AmpAdNetworkAdsenseImpl);
  });
})();
