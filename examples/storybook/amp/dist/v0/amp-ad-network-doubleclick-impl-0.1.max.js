(self.AMP=self.AMP||[]).push({n:"amp-ad-network-doubleclick-impl",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var RealTimeConfigService = /* @__PURE__ */ function() {
    function RealTimeConfigService2(ampDoc) {
      _classCallCheck4(this, RealTimeConfigService2);
      this.ampDoc_ = ampDoc;
    }
    _createClass3(RealTimeConfigService2, [{
  ...
  var RealTimeConfigManager = /* @__PURE__ */ function() {
    function RealTimeConfigManager2(ampDoc) {
      _classCallCheck4(this, RealTimeConfigManager2);
      this.ampDoc_ = ampDoc;
    ...
    _createClass3(RealTimeConfigManager2, [{
  ...
  var A4AVariableSource = /* @__PURE__ */ function(_VariableSource) {
    ...
    function A4AVariableSource2(parentAmpdoc, embedWin) {
      var _this;
      _classCallCheck6(this, A4AVariableSource2);
    ...
    _createClass5(A4AVariableSource2, [{
      key: "initialize",
      value: function initialize() {
        var _this2 = this;
      ...
      value: function htmlAttributeBinding_(cssSelector, var_args) {
        ...
        if (attributeNames.length > HTML_ATTR_MAX_ATTRS) {
          user().error(TAG20, "At most " + HTML_ATTR_MAX_ATTRS + " may be requested.");
          return "[]";
        }
        ...
        try {
          ...
          user().error(TAG20, "Invalid selector: " + cssSelector);
          return "[]";
        }
        if (elements2.length > HTML_ATTR_MAX_ELEMENTS_TO_TRAVERSE) {
          user().error(TAG20, "CSS selector may match at most " + (HTML_ATTR_MAX_ELEMENTS_TO_TRAVERSE + " elements."));
          return "[]";
        }
        var result = [];
  ...
  var DetachedDomStream = /* @__PURE__ */ function() {
    function DetachedDomStream2(win, onChunk, onEnd) {
      _classCallCheck7(this, DetachedDomStream2);
    ...
    _createClass6(DetachedDomStream2, [{
      key: "write",
  ...
  var DomTransformStream = /* @__PURE__ */ function() {
    function DomTransformStream2(win, opt_transferThrottleFunc) {
      _classCallCheck8(this, DomTransformStream2);
    ...
    _createClass7(DomTransformStream2, [{
      key: "onChunk",
  ...
  var SignatureVerifier = /* @__PURE__ */ function() {
    function SignatureVerifier2(win, signingServerURLs2) {
      _classCallCheck9(this, SignatureVerifier2);
      this.win_ = win;
    ...
    _createClass8(SignatureVerifier2, [{
      key: "loadKeyset",
  ...
  var DomFingerprint = /* @__PURE__ */ function() {
    function DomFingerprint2() {
      _classCallCheck10(this, DomFingerprint2);
    }
    _createClass9(DomFingerprint2, null, [{
      key: "generate",
  ...
  var Signals = /* @__PURE__ */ function() {
    function Signals2() {
      _classCallCheck11(this, Signals2);
      this.map_ = map();
      this.promiseMap_ = null;
    }
    _createClass10(Signals2, [{
      key: "get",
      value: function get(name) {
  ...
  var AbortController2 = /* @__PURE__ */ function() {
    function AbortController3() {
      _classCallCheck12(this, AbortController3);
      this.signal_ = new AbortSignal();
    }
    _createClass11(AbortController3, [{
      key: "abort",
  ...
  var AbortSignal = /* @__PURE__ */ function() {
    function AbortSignal2() {
      _classCallCheck12(this, AbortSignal2);
      this.isAborted_ = false;
      this.onabort_ = null;
    }
    _createClass11(AbortSignal2, [{
      key: "aborted",
      get: function get() {
  ...
  var ActionInvocation = /* @__PURE__ */ function() {
    function ActionInvocation2(node, method, args, source, caller, event, trust, actionEventType, tagOrTarget, sequenceId) {
      ...
      _classCallCheck13(this, ActionInvocation2);
      this.node = node;
      this.method = method;
      this.args = args;
      this.source = source;
    ...
    _createClass12(ActionInvocation2, [{
      key: "satisfiesTrust",
  ...
  var ActionService = /* @__PURE__ */ function() {
    function ActionService2(ampdoc, opt_root) {
      _classCallCheck13(this, ActionService2);
      this.ampdoc = ampdoc;
  ...
  var DeferredEvent = function DeferredEvent2(event) {
    _classCallCheck13(this, DeferredEvent2);
    this.detail = null;
  ...
  var ParserTokenizer = /* @__PURE__ */ function() {
    function ParserTokenizer2(str) {
      _classCallCheck13(this, ParserTokenizer2);
      this.str_ = str;
      this.index_ = -1;
    }
    _createClass12(ParserTokenizer2, [{
      key: "next",
  ...
  var CacheCidApi = /* @__PURE__ */ function() {
    function CacheCidApi2(ampdoc) {
      _classCallCheck14(this, CacheCidApi2);
      this.ampdoc_ = ampdoc;
  ...
  var WindowInterface = /* @__PURE__ */ function() {
    function WindowInterface2() {
      _classCallCheck15(this, WindowInterface2);
    }
  ...
  var GoogleCidApi = /* @__PURE__ */ function() {
    function GoogleCidApi2(ampdoc) {
      _classCallCheck16(this, GoogleCidApi2);
      this.win_ = ampdoc.win;
      ...
      value: function getScopedCid(apiKey, scope) {
        ...
        return this.cidPromise_[scope] = this.timer_.poll(200, function() {
          ...
          return _this.fetchCid_(dev().assertString(url), scope, token).then(function(response) {
            ...
            if (e && e.response) {
              e.response.json().then(function(res) {
                dev().error(TAG4, JSON.stringify(res));
              });
            } else {
              dev().error(TAG4, e);
            }
  ...
  var ViewerCidApi = /* @__PURE__ */ function() {
    function ViewerCidApi2(ampdoc) {
      _classCallCheck17(this, ViewerCidApi2);
      this.ampdoc_ = ampdoc;
      this.viewer_ = Services.viewerForDoc(this.ampdoc_);
  ...
  var PriorityQueue = /* @__PURE__ */ function() {
    function PriorityQueue2() {
      _classCallCheck20(this, PriorityQueue2);
      this.queue_ = [];
    }
    _createClass19(PriorityQueue2, [{
      key: "peek",
      value: function peek() {
        var l = this.length;
        if (!l) {
  ...
  function installGlobalNavigationHandlerForDoc(ampdoc) {
    registerServiceBuilderForDoc(ampdoc, TAG5, Navigation, true);
  }
  var Navigation = /* @__PURE__ */ function() {
    function Navigation2(ampdoc) {
      var _this = this;
      _classCallCheck21(this, Navigation2);
      this.ampdoc = ampdoc;
    ...
    _createClass20(Navigation2, [{
      ...
      value: function navigateTo(win, url, opt_requestedBy, options) {
        ...
        if (!urlService.isProtocolValid(url)) {
          user().error(TAG5, "Cannot navigate to invalid protocol: " + url);
          return;
        }
      ...
      value: function removeViewerQueryBeforeNavigation_(win, fromLocation, target) {
        dev().info(TAG5, "Removing iframe query string before navigation:", fromLocation.search);
        ...
        var restoreQuery = function restoreQuery2() {
          ...
          if (currentHref == noQuery) {
            dev().info(TAG5, "Restored iframe URL with query string:", original);
            win.history.replaceState(null, "", original);
          } else {
            dev().error(TAG5, "Unexpected iframe URL change:", currentHref, noQuery);
          }
        };
        if (target === "_blank") {
      ...
      value: function scrollToElement_(elem, hash) {
        ...
        if (elem) {
          ...
          dev().warn(TAG5, "failed to find element with id=" + hash + " or a[name=" + hash + "]");
        }
      }
    }, {
      key: "parseUrl_",
  ...
  var Observable = /* @__PURE__ */ function() {
    function Observable2() {
      _classCallCheck22(this, Observable2);
      this.handlers_ = null;
    }
    _createClass21(Observable2, [{
      key: "add",
  ...
  var HiddenObserver = /* @__PURE__ */ function() {
    function HiddenObserver2(ampdoc) {
      _classCallCheck23(this, HiddenObserver2);
    ...
    _createClass22(HiddenObserver2, [{
      key: "add",
      value: function add(handler) {
        var _this = this;
        this.init_();
  ...
  var History = /* @__PURE__ */ function() {
    function History2(ampdoc, binding) {
      _classCallCheck24(this, History2);
      this.ampdoc_ = ampdoc;
  ...
  var HistoryBindingNatural_ = /* @__PURE__ */ function() {
    function HistoryBindingNatural_2(win) {
      var _this9 = this;
      _classCallCheck24(this, HistoryBindingNatural_2);
      this.win = win;
    ...
    _createClass23(HistoryBindingNatural_2, [{
      key: "cleanup",
      value: function cleanup() {
      ...
      value: function mergeStateUpdate_(state, update) {
        var mergedData = _extends3({}, state && state.data || {}, update.data || {});
        return _extends3({}, state || {}, update, {
          data: mergedData
        });
      }
    }]);
  ...
  var HistoryBindingVirtual_ = /* @__PURE__ */ function() {
    function HistoryBindingVirtual_2(win, viewer) {
      var _this17 = this;
      _classCallCheck24(this, HistoryBindingVirtual_2);
      this.win = win;
      this.viewer_ = viewer;
      this.stackIndex_ = 0;
      this.onStateUpdated_ = null;
    ...
    _createClass23(HistoryBindingVirtual_2, [{
      key: "replaceStateForTarget",
      value: function replaceStateForTarget(target) {
        devAssert(target[0] == "#", "target should start with a #");
  ...
  var StartupTask = /* @__PURE__ */ function(_Task) {
    ...
    function StartupTask2(fn, win, chunks) {
      var _this;
      _classCallCheck26(this, StartupTask2);
  ...
  var Chunks = /* @__PURE__ */ function() {
    function Chunks2(ampDoc) {
      var _this2 = this;
      _classCallCheck26(this, Chunks2);
      this.ampdoc = ampDoc;
      this.win_ = ampDoc.win;
  ...
  var InaboxResources = /* @__PURE__ */ function() {
    function InaboxResources2(ampdoc) {
      var _this = this;
      _classCallCheck28(this, InaboxResources2);
      this.ampdoc_ = ampdoc;
      this.win = ampdoc.win;
      this.resources_ = [];
    ...
    _createClass27(InaboxResources2, [{
      key: "dispose",
      value: function dispose() {
  ...
  var LoadingIndicatorImpl = /* @__PURE__ */ function() {
    function LoadingIndicatorImpl2(ampdoc) {
      _classCallCheck29(this, LoadingIndicatorImpl2);
      this.ampdoc_ = ampdoc;
      var win = ampdoc.win;
    ...
    _createClass28(LoadingIndicatorImpl2, [{
      key: "dispose",
      value: function dispose() {
        this.io_.disconnect();
      }
  ...
  var FocusHistory = /* @__PURE__ */ function() {
    function FocusHistory2(win, purgeTimeout) {
      var _this = this;
      _classCallCheck30(this, FocusHistory2);
      this.win = win;
  ...
  var MutatorImpl = /* @__PURE__ */ function() {
    function MutatorImpl2(ampdoc) {
      var _this = this;
      _classCallCheck31(this, MutatorImpl2);
      this.ampdoc = ampdoc;
      this.win = ampdoc.win;
  ...
  var OwnersImpl = /* @__PURE__ */ function() {
    function OwnersImpl2(ampdoc) {
      _classCallCheck32(this, OwnersImpl2);
      this.resources_ = Services.resourcesForDoc(ampdoc);
    }
    _createClass31(OwnersImpl2, [{
      key: "setOwner",
      value: function setOwner(element, owner) {
  ...
  var FiniteStateMachine = /* @__PURE__ */ function() {
    function FiniteStateMachine2(initialState) {
      _classCallCheck33(this, FiniteStateMachine2);
      this.state_ = initialState;
      this.transitions_ = map();
    }
    _createClass32(FiniteStateMachine2, [{
      key: "addTransition",
  ...
  var TaskQueue = /* @__PURE__ */ function() {
    function TaskQueue2() {
      _classCallCheck34(this, TaskQueue2);
      this.tasks_ = [];
      this.taskIdMap_ = {};
      this.lastEnqueueTime_ = 0;
      this.lastDequeueTime_ = 0;
    }
    _createClass33(TaskQueue2, [{
      key: "getSize",
    ...
    return new Promise(function(resolve) {
      ...
      var interval = win.setInterval(function() {
        ...
        if (matches2 || now > endTime) {
          ...
          resolve();
          if (!matches2) {
            dev().error(TAG9, "IE media never resolved");
          }
        }
      }, 10);
    });
  ...
  function matchMediaIeQuite(win) {
    ...
    try {
      ...
      dev().error(TAG9, "IE matchMedia failed: ", e);
      return true;
    }
  }
  ...
  var ResourcesImpl = /* @__PURE__ */ function() {
    function ResourcesImpl2(ampdoc) {
      var _this = this;
      _classCallCheck35(this, ResourcesImpl2);
      this.ampdoc = ampdoc;
      this.win = ampdoc.win;
  ...
  var StandardActions = /* @__PURE__ */ function() {
    function StandardActions2(ampdoc) {
      _classCallCheck36(this, StandardActions2);
      this.ampdoc = ampdoc;
    ...
    _createClass35(StandardActions2, [{
      key: "installActions_",
  ...
  var Storage = /* @__PURE__ */ function() {
    function Storage2(ampdoc, viewer, binding) {
      _classCallCheck37(this, Storage2);
      this.ampdoc = ampdoc;
      this.viewer_ = viewer;
      this.binding_ = binding;
  ...
  var LocalStorageBinding = /* @__PURE__ */ function() {
    function LocalStorageBinding2(win) {
      _classCallCheck37(this, LocalStorageBinding2);
      this.win = win;
    ...
    _createClass36(LocalStorageBinding2, [{
  ...
  var ViewerStorageBinding = /* @__PURE__ */ function() {
    function ViewerStorageBinding2(viewer) {
      _classCallCheck37(this, ViewerStorageBinding2);
      this.viewer_ = viewer;
    }
    _createClass36(ViewerStorageBinding2, [{
      key: "loadBlob",
      value: function loadBlob(origin) {
  ...
  var Templates = /* @__PURE__ */ function() {
    function Templates2(ampdoc) {
      _classCallCheck38(this, Templates2);
      this.ampdoc_ = ampdoc;
  ...
  var Expander = /* @__PURE__ */ function() {
    function Expander2(variableSource, opt_bindings, opt_collectVars, opt_sync, opt_allowlist, opt_noEncode) {
      _classCallCheck41(this, Expander2);
  ...
  var GlobalVariableSource = /* @__PURE__ */ function(_VariableSource) {
    ...
    function GlobalVariableSource2() {
      _classCallCheck42(this, GlobalVariableSource2);
      return _super.apply(this, arguments);
    }
    _createClass41(GlobalVariableSource2, [{
  ...
  var UrlReplacements = /* @__PURE__ */ function() {
    function UrlReplacements2(ampdoc, variableSource) {
      _classCallCheck42(this, UrlReplacements2);
      this.ampdoc = ampdoc;
      this.variableSource_ = variableSource;
    }
    _createClass41(UrlReplacements2, [{
  ...
  var ViewerImpl = /* @__PURE__ */ function() {
    function ViewerImpl2(ampdoc) {
      var _this = this;
      _classCallCheck43(this, ViewerImpl2);
      this.ampdoc = ampdoc;
      this.win = ampdoc.win;
  ...
  var Bezier = /* @__PURE__ */ function() {
    function Bezier2() {
      _classCallCheck44(this, Bezier2);
    }
  ...
  var Animation = /* @__PURE__ */ function() {
    function Animation2(contextNode, opt_vsync) {
      _classCallCheck45(this, Animation2);
      this.contextNode_ = contextNode;
      this.vsync_ = opt_vsync || Services.vsyncFor(self);
      this.curve_ = null;
      this.segments_ = [];
    }
    _createClass44(Animation2, [{
      key: "setCurve",
  ...
  var AnimationPlayer = /* @__PURE__ */ function() {
    function AnimationPlayer2(vsync, contextNode, segments, defaultCurve, duration) {
      _classCallCheck45(this, AnimationPlayer2);
      this.vsync_ = vsync;
      this.contextNode_ = contextNode;
      this.segments_ = [];
    ...
    _createClass44(AnimationPlayer2, [{
      key: "then",
  ...
  var ViewportBindingIosEmbedWrapper_ = /* @__PURE__ */ function() {
    function ViewportBindingIosEmbedWrapper_2(win) {
      var _this = this;
      _classCallCheck46(this, ViewportBindingIosEmbedWrapper_2);
      this.win = win;
    ...
    _createClass45(ViewportBindingIosEmbedWrapper_2, [{
  ...
  var ViewportBindingNatural_ = /* @__PURE__ */ function() {
    function ViewportBindingNatural_2(ampdoc) {
      var _this = this;
      _classCallCheck47(this, ViewportBindingNatural_2);
      this.ampdoc = ampdoc;
      this.win = ampdoc.win;
    ...
    _createClass46(ViewportBindingNatural_2, [{
  ...
  var ViewportImpl = /* @__PURE__ */ function() {
    function ViewportImpl2(ampdoc, binding, viewer) {
      var _this = this;
      _classCallCheck48(this, ViewportImpl2);
      var win = ampdoc.win;
      this.ampdoc = ampdoc;
  ...
  var CustomElementRegistry = /* @__PURE__ */ function() {
    function CustomElementRegistry2(win, registry) {
      _classCallCheck49(this, CustomElementRegistry2);
      this.win_ = win;
      this.registry_ = registry;
      this.pendingDefines_ = map();
    }
    _createClass48(CustomElementRegistry2, [{
      key: "define",
  ...
  var Registry = /* @__PURE__ */ function() {
    function Registry2(win) {
      _classCallCheck49(this, Registry2);
      this.win_ = win;
  ...
  var IntersectionObserverStub = /* @__PURE__ */ function() {
    function IntersectionObserverStub2(callback, options) {
      _classCallCheck50(this, IntersectionObserverStub2);
    ...
    _createClass49(IntersectionObserverStub2, [{
      key: "root",
      get: function get() {
        if (this.inst_) {
  ...
  var ResizeObserverStub = /* @__PURE__ */ function() {
    function ResizeObserverStub2(callback) {
      _classCallCheck51(this, ResizeObserverStub2);
      this.callback_ = callback;
      this.elements_ = [];
      this.inst_ = null;
      ResizeObserverStub2[UPGRADERS2].push(this.upgrade_.bind(this));
    }
    _createClass50(ResizeObserverStub2, [{
      key: "disconnect",
      value: function disconnect() {
        if (this.inst_) {
          this.inst_.disconnect();
  ...
  var FriendlyIframeEmbed = /* @__PURE__ */ function() {
    function FriendlyIframeEmbed2(iframe, spec, loadedPromise, ampdoc) {
      var _this = this;
      _classCallCheck52(this, FriendlyIframeEmbed2);
      this.iframe = iframe;
    ...
    _createClass51(FriendlyIframeEmbed2, [{
      key: "destroy",
  ...
  var Installers = /* @__PURE__ */ function() {
    function Installers2() {
      _classCallCheck52(this, Installers2);
    }
    _createClass51(Installers2, null, [{
  ...
  function maybeAppendErrorParameter(adUrl, parameterValue) {
    ...
    devAssert(modifiedAdUrl.length <= MAX_URL_LENGTH2);
  ...
  var DomAncestorVisitor = /* @__PURE__ */ function() {
    function DomAncestorVisitor2(win) {
      ...
      _classCallCheck54(this, DomAncestorVisitor2);
      this.visitors_ = [];
      this.win_ = win;
    }
    _createClass53(DomAncestorVisitor2, [{
  ...
  var Visitor = /* @__PURE__ */ function() {
    function Visitor2(callback, maxAncestorsToVisit) {
      _classCallCheck54(this, Visitor2);
      devAssert2(maxAncestorsToVisit > 0, "maxAncestorsToVisit must be a positive value.");
      this.callback_ = callback;
      this.maxAncestorsToVisit_ = maxAncestorsToVisit;
      this.complete = false;
    }
    _createClass53(Visitor2, [{
      key: "callback",
      value: function callback(element, style) {
        devAssert2(!this.complete, "Attempted to execute callback on completed visitor.");
        var result;
        try {
  ...
  function checkAndSanitizeRefreshInterval(refreshInterval) {
    ...
    if (isNaN(refreshIntervalNum) || refreshIntervalNum < MIN_REFRESH_INTERVAL) {
      user().warn(TAG16, "invalid refresh interval, must be a number no less than " + (MIN_REFRESH_INTERVAL + ": " + refreshInterval));
      return null;
    }
  ...
  var RefreshManager = /* @__PURE__ */ function() {
    function RefreshManager2(a4a, config, refreshInterval) {
      _classCallCheck55(this, RefreshManager2);
    ...
    _createClass54(RefreshManager2, [{
  ...
  var TAG17 = "AMP-DOUBLECLICK-SAFEFRAME";
  function safeframeListener(event) {
    ...
    if (!safeframeHost) {
      dev().warn(TAG17, "Safeframe Host for sentinel: " + sentinel + " not found.");
      return;
    }
    if (!safeframeHost.equalsSafeframeContentWindow(event.source)) {
      dev().warn(TAG17, "Safeframe source did not match event.source.");
      return;
    }
  ...
  var SafeframeHostApi = /* @__PURE__ */ function() {
    function SafeframeHostApi2(baseInstance, isFluid, creativeSize) {
      _classCallCheck56(this, SafeframeHostApi2);
      ...
      this.initialCreativeSize_ = _extends6({}, creativeSize);
      this.delay_ = null;
    ...
    _createClass55(SafeframeHostApi2, [{
      ...
      value: function updateGeometry_() {
        ...
        this.viewport_.getClientRectAsync(this.iframe_).then(function(iframeBox) {
          ...
          _this.sendMessage_({
            ...
            uid: _this.uid_
          }, SERVICE2.GEOMETRY_UPDATE);
        }).catch(function(err) {
          return dev().error(TAG17, err);
        });
      }
    }, {
      key: "formatGeom_",
      ...
      value: function sendMessage_(payload, serviceName) {
        if (!this.iframe_ || !this.iframe_.contentWindow) {
          dev().expectedError(TAG17, "Frame contentWindow unavailable.");
          return;
        }
        var message = dict();
      ...
      value: function processMessage(payload, service) {
        switch (service) {
          case SERVICE2.CREATIVE_GEOMETRY_UPDATE:
            this.handleFluidMessage_(payload);
            break;
          case SERVICE2.EXPAND_REQUEST:
            this.handleExpandRequest_(payload);
            break;
          case SERVICE2.REGISTER_DONE:
            this.isRegistered_ = true;
            break;
          case SERVICE2.COLLAPSE_REQUEST:
            this.handleCollapseRequest_();
            break;
          case SERVICE2.RESIZE_REQUEST:
      ...
      value: function handleExpandRequest_(payload) {
        ...
        if (isNaN(expandHeight) || isNaN(expandWidth) || payload["push"] && !this.expandByPush_ || !payload["push"] && !this.expandByOverlay_ && (expandWidth > this.creativeSize_.width || expandHeight > this.creativeSize_.height)) {
          dev().error(TAG17, "Invalid expand values.");
          this.sendResizeResponse(false, SERVICE2.EXPAND_RESPONSE);
          return;
        }
        ...
        this.handleSizeChange(expandHeight, expandWidth, SERVICE2.EXPAND_RESPONSE);
      }
    }, {
      key: "handleCollapseRequest_",
      value: function handleCollapseRequest_() {
        if (this.isCollapsed_ || !this.isRegistered_) {
          this.sendResizeResponse(false, SERVICE2.COLLAPSE_RESPONSE);
          return;
        }
        this.handleSizeChange(this.initialCreativeSize_.height, this.initialCreativeSize_.width, SERVICE2.COLLAPSE_RESPONSE, true);
      }
    }, {
      key: "resizeSafeframe",
      value: function resizeSafeframe(height, width, messageType) {
        var _this2 = this;
        this.isCollapsed_ = messageType == SERVICE2.COLLAPSE_RESPONSE;
      ...
      value: function handleResizeRequest_(payload) {
        ...
        if (isNaN(resizeWidth) || isNaN(resizeHeight)) {
          dev().error(TAG17, "Invalid resize values.");
          return;
        }
        this.resizeAmpAdAndSafeframe(resizeHeight, resizeWidth, SERVICE2.RESIZE_RESPONSE, true);
      }
    }, {
      ...
      value: function resizeAmpAdAndSafeframe(height, width, messageType, opt_isShrinking) {
        ...
        this.baseInstance_.attemptChangeSize(height, width).then(function() {
          ...
          dev().error(TAG17, "Resizing failed: " + err);
          _this5.sendResizeResponse(false, messageType);
        });
      }
    }, {
  ...
  function getTargetingAndExclusions(impls) {
    ...
    var _loop = function _loop2(i2) {
      ...
      if (commonKVs) {
        ...
        commonKVs = _extends7({}, impl.jsonTargeting["targeting"]);
      }
    };
    for (var i = 0; i < impls.length; i++) {
      var _ret = _loop(i);
  ...
  function sraBlockCallbackHandler(creative, headersObj, done, sraRequestAdUrlResolvers, sraUrl, isNoSigning) {
    ...
    if (done && sraRequestAdUrlResolvers.length) {
      dev().warn(TAG18, "Premature end of SRA response", sraRequestAdUrlResolvers.length, sraUrl);
    }
  }
  ...
  var TAG19 = "amp-ad-network-doubleclick-impl";
  ...
  var AmpAdNetworkDoubleclickImpl = /* @__PURE__ */ function(_AmpA4A) {
    ...
    function AmpAdNetworkDoubleclickImpl2(element) {
      var _this;
      _classCallCheck57(this, AmpAdNetworkDoubleclickImpl2);
      _this = _super.call(this, element);
      ...
      if ("forceSafeframe" in _this.element.dataset) {
        if (!/^(1|(true))$/i.test(_this.element.dataset["forceSafeframe"])) {
          user().warn(TAG19, "Ignoring invalid data-force-safeframe attribute: " + _this.element.dataset["forceSafeframe"]);
        } else {
    ...
    _createClass56(AmpAdNetworkDoubleclickImpl2, [{
      ...
      value: function setPageLevelExperiments(urlExperimentId) {
        ...
        var moduleNomoduleExpId = this.getModuleNomoduleExpIds_();
      ...
      value: function maybeDeprecationWarn_() {
        var warnDeprecation = function warnDeprecation2(feature) {
          return user().warn(TAG19, feature + " is no longer supported for DoubleClick.Please refer to https://github.com/ampproject/amphtml/issues/11834 for more information");
        };
      ...
      value: function buildCallback() {
        var _this4 = this;
        _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "buildCallback", this).call(this);
        ...
        if (pubEnabledSra && delayFetchEnabled) {
          user().warn(TAG19, "SRA is not compatible with lazy fetching, disabling SRA");
        }
        ...
        this.identityTokenPromise_ = this.getAmpDoc().whenFirstVisible().then(function() {
          return getIdentityToken(_this4.win, _this4.getAmpDoc(), _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "getConsentPolicy", _this4).call(_this4));
        });
      ...
      value: function getAdUrl(opt_consentTuple, opt_rtcResponsesPromise, opt_serveNpaSignal) {
        ...
        if (consentTuple.consentState == CONSENT_POLICY_STATE.UNKNOWN && this.element.getAttribute("data-npa-on-unknown-consent") != "true") {
          user().info(TAG19, "Ad request suppressed due to unknown consent");
          this.getAdUrlDeferred.resolve("");
          return Promise.resolve("");
        }
        if (this.iframe && !this.isRefreshing) {
          dev().warn(TAG19, "Frame already exists, sra: " + this.useSra);
          this.getAdUrlDeferred.resolve("");
          return Promise.resolve("");
        }
        ...
        var targetingExpansionPromise = timerService.timeoutPromise(1e3, this.expandJsonTargeting_(rtcParamsPromise)).catch(function() {
          dev().warn(TAG19, "JSON Targeting expansion failed/timed out.");
        });
        ...
        return {
          ...
          ATTR: function ATTR(name) {
            if (!allowlist[name.toLowerCase()]) {
              dev().warn(TAG19, "Invalid attribute " + name);
            } else {
      ...
      value: function onNetworkFailure(error, adUrl) {
        dev().info(TAG19, "network error, attempt adding of error parameter", error);
        return {
      ...
      value: function maybeValidateAmpCreative(bytes, headers) {
        if (headers.get("AMP-Verification-Checksum-Algorithm") !== "djb2a-32") {
          return _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "maybeValidateAmpCreative", this).call(this, bytes, headers);
        }
      ...
      value: function extractSize(responseHeaders) {
        ...
        var size = _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "extractSize", this).call(this, responseHeaders);
        if (size) {
      ...
      key: "tearDownSlot",
      value: function tearDownSlot() {
        _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "tearDownSlot", this).call(this);
        ...
        if (this.postAdResponseExperimentFeatures["render-idle-throttle"] && this.isIdleRender_) {
          if (is3pThrottled(this.win)) {
            return waitFor3pThrottle().then(function() {
              return _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "renderNonAmpCreative", _this10).call(_this10);
            });
          } else {
            incrementLoadingAds(this.win);
            return _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "renderNonAmpCreative", this).call(this, true);
          }
        }
        return _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "renderNonAmpCreative", this).call(this);
      }
    }, {
      key: "viewportCallbackTemp",
      value: function viewportCallbackTemp(inViewport) {
        _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "viewportCallbackTemp", this).call(this, inViewport);
      ...
      value: function unlayoutCallback() {
        ...
        return _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "unlayoutCallback", this).call(this);
      }
    }, {
      key: "getSafeframePath",
      value: function getSafeframePath() {
      ...
      value: function refresh(refreshEndCallback) {
        this.refreshCount_++;
        return _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "refresh", this).call(this, refreshEndCallback);
      }
    }, {
      key: "onCreativeRender",
      value: function onCreativeRender(creativeMetaData, opt_onLoadPromise) {
        var _this11 = this;
        _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "onCreativeRender", this).call(this, creativeMetaData);
        ...
        this.refreshManager_ = this.refreshManager_ || getRefreshManager(this, function() {
          if (_this11.useSra) {
            user().warn(TAG19, "Refresh not compatible with SRA.");
            return false;
          }
          if (getEnclosingContainerTypes(_this11.element).filter(function(container) {
            ...
            user().warn(TAG19, "Refresh not compatible with ad-containers, except for AMP-CAROUSEL and AMP-STICKY-AD");
            return false;
          }
          return true;
        });
      ...
      value: function expandFluidCreative_() {
        ...
        if (this.isFluidRequest_ && !this.returnedSize_ && this.isVerifiedAmpCreative()) {
          if (!this.iframe || !this.iframe.contentWindow || !this.iframe.contentWindow.document || !this.iframe.contentWindow.document.body) {
            dev().error(TAG19, "Attempting to expand fluid creative without a properly set up friendly frame. Slot id: " + this.element.getAttribute("data-amp-slot-index"));
          ...
          return this.setCssPosition_("static").then(function() {
            return _this12.attemptChangeHeight(_this12.iframe.contentWindow.document.body.clientHeight).then(function() {
              ...
              user().warn(TAG19, "Attempt to change size failed on fluid creative. Will re-attempt when slot is out of the viewport.");
      ...
      value: function sendXhrRequest(adUrl) {
        var _this14 = this;
        if (!this.useSra) {
          return _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "sendXhrRequest", this).call(this, adUrl);
        }
        var checkStillCurrent = this.verifyStillCurrent();
        this.initiateSraRequests().then(function() {
          checkStillCurrent();
          if (!_this14.sraDeferred) {
            dev().warn(TAG19, "SRA failed to include element " + _this14.ifi_);
        ...
        return this.sraDeferred.promise.then(function(response) {
          ...
          return response || _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "sendXhrRequest", _this14).call(_this14, adUrl);
        });
      }
    }, {
        ...
        impressions.split(",").forEach(function(url) {
          try {
            if (!Services.urlForDoc(_this15.element).isSecure(url)) {
              dev().warn(TAG19, "insecure impression url: " + url);
              return;
            }
          ...
          Object.keys(groupIdToBlocksAry).forEach(function(networkId) {
            ...
            sraRequestPromises.push(Promise.all(blocks).then(function(instances) {
              ...
              var typeInstances = instances.filter(function(instance) {
                ...
                if (!isValid) {
                  dev().info(TAG19, "Ignoring instance without ad promise as likely invalid", instance.element);
                }
                return isValid;
              });
              ...
              if (!noFallbackExp && typeInstances.length == 1) {
                dev().info(TAG19, "single block in network " + networkId);
      ...
      key: "getNonAmpCreativeRenderingMethod",
      value: function getNonAmpCreativeRenderingMethod(headerValue) {
        return this.forceSafeframe || this.isFluidRequest_ ? XORIGIN_MODE.SAFEFRAME : _get2(_getPrototypeOf5(AmpAdNetworkDoubleclickImpl2.prototype), "getNonAmpCreativeRenderingMethod", this).call(this, headerValue);
      }
    }, {
  ...
  AMP.extension(TAG19, "0.1", function(AMP2) {
    AMP2.registerElement(TAG19, AmpAdNetworkDoubleclickImpl);
  });
