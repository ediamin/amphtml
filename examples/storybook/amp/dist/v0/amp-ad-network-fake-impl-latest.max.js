(self.AMP=self.AMP||[]).push({n:"amp-ad-network-fake-impl",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpAdMetadataTransformer = /* @__PURE__ */ function() {
    function AmpAdMetadataTransformer2() {
      _classCallCheck54(this, AmpAdMetadataTransformer2);
      this.metadata = dict({});
      this.styles_ = [];
      this.extensions_ = [];
    ...
    _createClass53(AmpAdMetadataTransformer2, [{
      key: "generateMetadata",
      value: function generateMetadata(doc) {
        var head = doc.head;
      ...
      key: "generateHeadMetadata_",
      value: function generateHeadMetadata_(head) {
        if (head == null) {
          return;
        }
      ...
      key: "generateStyleMetadata_",
      value: function generateStyleMetadata_(element) {
        var styleObject = {
      ...
      key: "generateCtaMetadata_",
      value: function generateCtaMetadata_(element) {
      ...
      key: "generateImageMetadata_",
      value: function generateImageMetadata_(doc) {
      ...
      key: "generateJsonMetadata_",
      value: function generateJsonMetadata_(doc) {
      ...
      key: "generateRuntimeOffsets_",
      value: function generateRuntimeOffsets_(creative) {
        var start = 0;
        var end = 0;
        if (this.firstRuntimeElement_ != null) {
      ...
      key: "generateJsonOffsets_",
      value: function generateJsonOffsets_(creative) {
      ...
      key: "generateAmpAnalyticsOffsets_",
      value: function generateAmpAnalyticsOffsets_(doc, creative) {
      ...
      key: "addExtensionsMetadata_",
      value: function addExtensionsMetadata_() {
  ...
  var ExternalReorderHeadTransformer = /* @__PURE__ */ function() {
    function ExternalReorderHeadTransformer2() {
      _classCallCheck55(this, ExternalReorderHeadTransformer2);
    ...
    _createClass54(ExternalReorderHeadTransformer2, [{
      key: "appendIfNotNull_",
      value: function appendIfNotNull_(parent, element) {
        if (element != null) {
      ...
      key: "appendAll_",
      value: function appendAll_(parent, element) {
      ...
      key: "reorderHead",
      value: function reorderHead(head) {
        if (head != null) {
          for (var i = 0; i < head.children.length; i++) {
            var child = head.children.item(i);
      ...
      key: "registerMeta_",
      value: function registerMeta_(element) {
      ...
      key: "registerScript_",
      value: function registerScript_(element) {
      ...
      key: "registerStyle_",
      value: function registerStyle_(element) {
      ...
      key: "registerLink_",
      value: function registerLink_(element) {
      ...
      key: "repopulate_",
      value: function repopulate_(head) {
  ...
  var TAG16 = "AMP-AD-NETWORK-FAKE-IMPL";
  ...
  var AmpAdNetworkFakeImpl = /* @__PURE__ */ function(_AmpA4A) {
    ...
    _createClass55(AmpAdNetworkFakeImpl2, [{
      ...
      value: function buildCallback() {
        ...
        _get2(_getPrototypeOf5(AmpAdNetworkFakeImpl2.prototype), "buildCallback", this).call(this);
      }
    }, {
      key: "isValidElement",
      value: function isValidElement() {
        ...
        if (!id || !id.startsWith("i-amphtml-demo-")) {
          user().warn(TAG16, "Only works with id starts with i-amphtml-demo-");
          return false;
        }
        return true;
      }
      ...
      value: function sendXhrRequest(adUrl) {
        var _this3 = this;
        return _get2(_getPrototypeOf5(AmpAdNetworkFakeImpl2.prototype), "sendXhrRequest", this).call(this, adUrl).then(function(response) {
          if (!response) {
            return null;
          }
  ...
  AMP.extension("amp-ad-network-fake-impl", "0.1", function(AMP2) {
    AMP2.registerElement("amp-ad-network-fake-impl", AmpAdNetworkFakeImpl);
  });
})();
