(self.AMP=self.AMP||[]).push({n:"amp-ad-network-nws-impl",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpAdNetworkNwsImpl = /* @__PURE__ */ function(_AmpA4A) {
    ...
    function AmpAdNetworkNwsImpl2(element) {
      var _this;
      _classCallCheck54(this, AmpAdNetworkNwsImpl2);
      _this = _super.call(this, element);
      _this.ampAnalyticsConfig_ = null;
      _this.ampAnalyticsElement_ = null;
      return _this;
    }
    _createClass53(AmpAdNetworkNwsImpl2, [{
      key: "extractAmpAnalyticsConfig",
      value: function extractAmpAnalyticsConfig(responseHeaders) {
      ...
      value: function extractSize(responseHeaders) {
        ...
        var size = _get2(_getPrototypeOf5(AmpAdNetworkNwsImpl2.prototype), "extractSize", this).call(this, responseHeaders);
        return size;
      }
    }, {
      key: "tearDownSlot",
      value: function tearDownSlot() {
        _get2(_getPrototypeOf5(AmpAdNetworkNwsImpl2.prototype), "tearDownSlot", this).call(this);
      ...
      key: "onCreativeRender",
      value: function onCreativeRender(creativeMetaData, opt_onLoadPromise) {
        _get2(_getPrototypeOf5(AmpAdNetworkNwsImpl2.prototype), "onCreativeRender", this).call(this, creativeMetaData);
  ...
  AMP.extension("amp-ad-network-nws-impl", "0.1", function(AMP2) {
    AMP2.registerElement("amp-ad-network-nws-impl", AmpAdNetworkNwsImpl);
  });
})();
