(self.AMP=self.AMP||[]).push({n:"amp-audio",ev:"1.0",l:false,v:"2106040012001",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function internalListenImplementation(element, eventType, listener, opt_evtListenerOpts) {
    ...
    var wrapped = function wrapped2(event) {
      try {
        ...
        self.__AMP_REPORT_ERROR == null ? void 0 : self.__AMP_REPORT_ERROR(e3);
        throw e3;
      }
    };
  ...
  // extensions/amp-audio/1.0/component.js
  var _excluded3 = ["album", "artist", "artwork", "autoplay", "controlsList", "loop", "muted", "preload", "src", "title"];
  function _extends3() {
  ...
  var useRef2 = useRef;
  function Audio(_ref) {
    var album = _ref.album, artist = _ref.artist, artwork = _ref.artwork, autoplay = _ref.autoplay, controlsList = _ref.controlsList, loop = _ref.loop, muted = _ref.muted, preload = _ref.preload, src = _ref.src, title = _ref.title, rest = _objectWithoutPropertiesLoose3(_ref, _excluded3);
    var containerRef = useRef2();
    var audioRef = useRef2();
    useEffect2(function() {
      var unlistenPlaying = listen(audioRef.current, "playing", function() {
        return audioPlaying();
      });
      return function() {
        unlistenPlaying();
    ...
    var metaData = useMemo2(function() {
      return {
        title,
        artist,
        album,
    ...
    var audioPlaying = useCallback2(function() {
      var _audioRef$current, _audioRef$current$own;
      var win = (_audioRef$current = audioRef.current) == null ? void 0 : (_audioRef$current$own = _audioRef$current.ownerDocument) == null ? void 0 : _audioRef$current$own.defaultView;
  ...
  // extensions/amp-audio/1.0/component.jss.js
  var CSS2 = "";
  ...
  // extensions/amp-audio/1.0/base-element.js
  ...
  BaseElement["props"] = {
    ...
    album: {
      attr: "album",
      type: "string",
      default: EMPTY_METADATA.album
    },
    artist: {
      attr: "artist",
      type: "string",
      default: EMPTY_METADATA.artist
    },
    artwork: {
      attr: "artwork",
      type: "string",
      default: EMPTY_METADATA.artwork
    },
    autoplay: {
      attr: "autoplay",
      type: "boolean",
    ...
    title: {
      attr: "title",
      type: "string",
      default: EMPTY_METADATA.title
    }
  };
  BaseElement["layoutSizeDefined"] = true;
  BaseElement["usesShadowDom"] = true;
  BaseElement["shadowCss"] = CSS2;

  // build/amp-audio-1.0.css.js
  var CSS3 = "\n/*# sourceURL=/extensions/amp-audio/1.0/amp-audio.css*/";

  // extensions/amp-audio/1.0/amp-audio.js
  ...
  var TAG2 = "amp-audio";
  var AmpAudio = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpAudio2, _BaseElement);
    var _super = _createSuper3(AmpAudio2);
    function AmpAudio2() {
      _classCallCheck10(this, AmpAudio2);
      return _super.apply(this, arguments);
    }
    _createClass8(AmpAudio2, [{
      key: "init",
      value: function init() {
        this.registerApiAction("exampleToggle", function(api) {
          return api.exampleToggle();
        });
        return dict({
      ...
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-audio"), 'expected global "bento" or specific "bento-audio" experiment to be enabled');
        return _get2(_getPrototypeOf3(AmpAudio2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
    return AmpAudio2;
  }(BaseElement);
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpAudio, CSS3);
  });
})();
...
//# sourceMappingURL=amp-audio-1.0.max.js.map
