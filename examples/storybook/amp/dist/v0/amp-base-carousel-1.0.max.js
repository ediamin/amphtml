(self.AMP=self.AMP||[]).push({n:"amp-base-carousel",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function ScreenReaderCloseButton(props) {
    return createElement("button", _extends5({}, props, {
      tabIndex: -1,
  ...
  var AmpBaseCarousel = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpBaseCarousel2, _BaseElement);
    var _super = _createSuper3(AmpBaseCarousel2);
    function AmpBaseCarousel2() {
      _classCallCheck10(this, AmpBaseCarousel2);
      return _super.apply(this, arguments);
    }
    _createClass9(AmpBaseCarousel2, [{
      key: "init",
      value: function init() {
        ...
        return _get2(_getPrototypeOf3(AmpBaseCarousel2.prototype), "init", this).call(this);
      }
    }, {
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
      ...
      key: "triggerEvent",
      value: function triggerEvent(element, eventName, detail) {
        var event = createCustomEvent(toWin(element.ownerDocument.defaultView), "amp-base-carousel." + eventName, detail);
        Services.actionServiceForDoc(element).trigger(element, eventName, event, ActionTrust.HIGH);
        _get2(_getPrototypeOf3(AmpBaseCarousel2.prototype), "triggerEvent", this).call(this, element, eventName, detail);
      }
    }]);
