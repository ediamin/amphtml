(self.AMP=self.AMP||[]).push({n:"amp-bodymovin-animation",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpBodymovinAnimation = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpBodymovinAnimation2(element) {
      var _this;
      _classCallCheck5(this, AmpBodymovinAnimation2);
    ...
    _createClass4(AmpBodymovinAnimation2, [{
      ...
      value: function buildCallback() {
        ...
        userAssert(this.element.hasAttribute("src"), "The src attribute must be specified for <amp-bodymovin-animation>");
  ...
  AMP.extension(TAG3, "0.1", function(AMP2) {
    AMP2.registerElement(TAG3, AmpBodymovinAnimation);
  });
})();
