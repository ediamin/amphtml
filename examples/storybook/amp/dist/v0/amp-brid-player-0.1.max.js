(self.AMP=self.AMP||[]).push({n:"amp-brid-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var VideoSessionManager = /* @__PURE__ */ function() {
    function VideoSessionManager2() {
      _classCallCheck7(this, VideoSessionManager2);
      this.isSessionActive_ = false;
      this.endSessionObservable_ = new Observable();
    }
    _createClass6(VideoSessionManager2, [{
      key: "onSessionEnd",
  ...
  var VideoManager = /* @__PURE__ */ function() {
    function VideoManager2(ampdoc) {
      var _this = this;
      _classCallCheck8(this, VideoManager2);
      this.ampdoc = ampdoc;
  ...
  var VideoEntry = /* @__PURE__ */ function() {
    function VideoEntry2(manager, video) {
      var _this3 = this;
      _classCallCheck8(this, VideoEntry2);
  ...
  var AutoFullscreenManager = /* @__PURE__ */ function() {
    function AutoFullscreenManager2(ampdoc, manager) {
      var _this9 = this;
      _classCallCheck8(this, AutoFullscreenManager2);
      this.manager_ = manager;
      this.ampdoc_ = ampdoc;
    ...
    _createClass7(AutoFullscreenManager2, [{
      key: "dispose",
      value: function dispose() {
  ...
  var AnalyticsPercentageTracker = /* @__PURE__ */ function() {
    function AnalyticsPercentageTracker2(win, entry) {
      _classCallCheck8(this, AnalyticsPercentageTracker2);
    ...
    _createClass7(AnalyticsPercentageTracker2, [{
      key: "start",
  ...
  var AmpBridPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpBridPlayer2(element) {
      var _this;
      _classCallCheck9(this, AmpBridPlayer2);
    ...
    _createClass8(AmpBridPlayer2, [{
      ...
      value: function buildCallback() {
        ...
        this.partnerID_ = userAssert(element.getAttribute("data-partner"), "The data-partner attribute is required for <amp-brid-player> %s", element);
        this.playerID_ = userAssert(element.getAttribute("data-player"), "The data-player attribute is required for <amp-brid-player> %s", element);
        this.feedID_ = userAssert(element.getAttribute("data-video") || element.getAttribute("data-playlist") || element.getAttribute("data-carousel") || element.getAttribute("data-outstream"), "Either the data-video, data-playlist, data-carousel or data-outstream attributes must be specified for <amp-brid-player> %s", element);
        var deferred = new Deferred();
      ...
      value: function createPlaceholderCallback() {
        ...
        var placeholder = html2(_templateObject3 || (_templateObject3 = _taggedTemplateLiteralLoose3(['\n      <img placeholder referrerpolicy="origin" loading="lazy" />\n    '])));
      ...
      key: "getConsentData_",
      value: function getConsentData_() {
        var _this4 = this;
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpBridPlayer);
  });
})();
