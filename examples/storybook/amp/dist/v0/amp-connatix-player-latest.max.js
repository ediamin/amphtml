(self.AMP=self.AMP||[]).push({n:"amp-connatix-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpConnatixPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpConnatixPlayer2(element) {
      var _this;
      _classCallCheck5(this, AmpConnatixPlayer2);
      _this = _super.call(this, element);
      _this.playerId_ = "";
      _this.mediaId_ = "";
      _this.iframeDomain_ = "https://cdm.connatix.com";
      _this.iframe_ = null;
    ...
    _createClass4(AmpConnatixPlayer2, [{
      key: "sendCommand_",
      ...
      key: "bindToPlayerCommands_",
      value: function bindToPlayerCommands_() {
        var _this3 = this;
      ...
      key: "bindToAmpConsent_",
      value: function bindToAmpConsent_() {
        var _this4 = this;
        var consentPolicyId = _get(_getPrototypeOf(AmpConnatixPlayer2.prototype), "getConsentPolicy", this).call(this) || "default";
      ...
      key: "destroyPlayerFrame_",
      value: function destroyPlayerFrame_() {
        if (this.iframe_) {
      ...
      value: function buildCallback() {
        ...
        this.playerId_ = userAssert(element.getAttribute("data-player-id"), "The data-player-id attribute is required for <amp-connatix-player> %s", element);
      ...
      key: "onResized_",
      value: function onResized_(_ref) {
  ...
  AMP.extension("amp-connatix-player", "0.1", function(AMP2) {
    AMP2.registerElement("amp-connatix-player", AmpConnatixPlayer);
  });
})();
