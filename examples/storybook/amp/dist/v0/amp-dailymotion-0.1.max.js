(self.AMP=self.AMP||[]).push({n:"amp-dailymotion",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpDailymotion = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpDailymotion2(element) {
      var _this;
      _classCallCheck8(this, AmpDailymotion2);
    ...
    _createClass7(AmpDailymotion2, [{
      ...
      value: function sendCommand_(command, opt_args) {
        ...
        this.playerReadyPromise_.then(function() {
          if (_this2.iframe_ && _this2.iframe_.contentWindow) {
            ...
            _this2.iframe_.contentWindow.postMessage(message, endpoint);
          }
        });
      }
    }, {
      ...
      value: function mute() {
        ...
        this.playerReadyPromise_.then(function() {
          dispatchCustomEvent(_this5.element, VideoEvents.MUTED);
          _this5.muted_ = true;
        });
      }
    }, {
      ...
      value: function unmute() {
        ...
        this.playerReadyPromise_.then(function() {
          dispatchCustomEvent(_this6.element, VideoEvents.UNMUTED);
          _this6.muted_ = false;
        });
      }
    }, {
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpDailymotion);
  });
})();
