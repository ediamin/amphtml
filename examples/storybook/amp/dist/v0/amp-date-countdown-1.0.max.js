(self.AMP=self.AMP||[]).push({n:"amp-date-countdown",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function getDataForTemplate(timeleft, biggestUnit, localeStrings, countUp) {
    return _extends3({}, getYDHMSFromMs(timeleft, biggestUnit, countUp), localeStrings);
  }
  ...
  var AmpDateCountdown = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpDateCountdown2, _BaseElement);
    var _super = _createSuper3(AmpDateCountdown2);
    function AmpDateCountdown2(element) {
      var _this;
      _classCallCheck10(this, AmpDateCountdown2);
      _this = _super.call(this, element);
      _this.templates_ = null;
      _this.template_ = null;
      return _this;
    }
    _createClass8(AmpDateCountdown2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
  ...
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpDateCountdown);
  });
})();
