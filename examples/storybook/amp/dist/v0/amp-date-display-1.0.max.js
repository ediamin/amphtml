(self.AMP=self.AMP||[]).push({n:"amp-date-display",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function DateDisplay(_ref) {
    ...
    useResourcesNotify();
    return createElement(Wrapper, _extends3({}, rest, {
      as: "div",
      datetime: data["iso"],
  ...
  function getVariablesInUTC(date, locale, localeOptions) {
    ...
    var localeOptionsInUTC = _extends3({}, localeOptions, {
      timeZone: "UTC"
    });
    return {
  ...
  var AmpDateDisplay = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpDateDisplay2, _BaseElement);
    var _super = _createSuper3(AmpDateDisplay2);
    function AmpDateDisplay2(element) {
      var _this;
      _classCallCheck10(this, AmpDateDisplay2);
      _this = _super.call(this, element);
      _this.templates_ = null;
      _this.template_ = null;
      return _this;
    }
    _createClass8(AmpDateDisplay2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        ...
        return _get2(_getPrototypeOf3(AmpDateDisplay2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }, {
      key: "checkPropsPostMutations",
      value: function checkPropsPostMutations() {
  ...
  AMP.extension(TAG3, "1.0", function(AMP2) {
    AMP2.registerElement(TAG3, AmpDateDisplay);
  });
})();
