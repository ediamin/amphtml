(self.AMP=self.AMP||[]).push({n:"amp-delight-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpDelightPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpDelightPlayer2(element) {
      var _this;
      _classCallCheck8(this, AmpDelightPlayer2);
    ...
    _createClass7(AmpDelightPlayer2, [{
      ...
      value: function buildCallback() {
        this.contentID_ = userAssert(this.element.getAttribute("data-content-id"), "The data-content-id attribute is required");
        var deferred = new Deferred();
      ...
      value: function layoutCallback() {
        var _this2 = this;
        observeWithSharedInOb(this.element, function(isInViewport) {
          return _this2.isInViewport_ = isInViewport;
        });
      ...
      value: function firstLayoutCompleted() {
        ...
        return promise.then(function() {
          return _get(_getPrototypeOf(AmpDelightPlayer2.prototype), "firstLayoutCompleted", _this3).call(_this3);
        });
      }
    }, {
      key: "pauseCallback",
      ...
      key: "handleDelightMessage_",
      value: function handleDelightMessage_(event) {
        var _redispatch;
      ...
      key: "sendCommand_",
      value: function sendCommand_(type, payload) {
        if (payload === void 0) {
          payload = {};
        }
      ...
      key: "setFullHeight_",
      value: function setFullHeight_() {
        setStyle(this.iframe_, "position", "fixed");
      }
    }, {
      key: "setInlineHeight_",
      value: function setInlineHeight_() {
        setStyle(this.iframe_, "position", "absolute");
      }
    }, {
      key: "registerEventHandlers_",
      value: function registerEventHandlers_() {
        var _this4 = this;
      ...
      key: "unregisterEventHandlers_",
      value: function unregisterEventHandlers_() {
      ...
      value: function sendConsentData_() {
        var _this5 = this;
        var consentPolicyId = _get(_getPrototypeOf(AmpDelightPlayer2.prototype), "getConsentPolicy", this).call(this) || "default";
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpDelightPlayer, CSS2);
  });
})();
