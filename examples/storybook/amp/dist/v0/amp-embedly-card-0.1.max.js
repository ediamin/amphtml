(self.AMP=self.AMP||[]).push({n:"amp-embedly-card",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpEmbedlyKey = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpEmbedlyKey2(element) {
      _classCallCheck2(this, AmpEmbedlyKey2);
      return _super.call(this, element);
    }
    _createClass(AmpEmbedlyKey2, [{
      key: "buildCallback",
      value: function buildCallback() {
        userAssert(this.element.getAttribute("value"), "The value attribute is required for <%s>", TAG2, this.element);
      }
    }, {
  ...
  var AmpEmbedlyCard = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpEmbedlyCard2(element) {
      var _this;
      _classCallCheck6(this, AmpEmbedlyCard2);
      _this = _super.call(this, element);
      _this.iframe_ = null;
      _this.apiKey_ = null;
      return _this;
    }
    _createClass5(AmpEmbedlyCard2, [{
      key: "buildCallback",
      value: function buildCallback() {
        userAssert(this.element.getAttribute("data-url"), "The data-url attribute is required for <%s> %s", TAG4, this.element);
        var ampEmbedlyKeyElement = document.querySelector(TAG2);
  ...
  AMP.extension(TAG4, "0.1", function(AMP2) {
    AMP2.registerElement(TAG4, AmpEmbedlyCard);
    AMP2.registerElement(TAG2, AmpEmbedlyKey);
  });
})();
