(self.AMP=self.AMP||[]).push({n:"amp-experiment",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function allocateVariant(ampdoc, experimentName, config) {
    ...
    if (sticky && config["consentNotificationId"]) {
      ...
      hasConsentPromise = Services.userNotificationManagerForDoc(element).then(function(manager) {
        ...
        userAssert(userNotification, "Notification not found: " + config["consentNotificationId"]);
  ...
  function validateConfig(config) {
    ...
    userAssert(isObject(variants) && Object.keys(variants).length > 0, "Missing experiment variants config.");
    if (config["group"]) {
    ...
    for (var variantName in variants) {
      if (hasOwn(variants, variantName)) {
        ...
        userAssert(typeof percentage === "number" && percentage > 0 && percentage < 100, "Invalid percentage %s:%s. Has to be greater than 0 and less than 100", variantName, percentage);
  ...
  var AmpExperiment = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpExperiment2() {
      _classCallCheck4(this, AmpExperiment2);
      return _super.apply(this, arguments);
    }
    _createClass3(AmpExperiment2, [{
  ...
  AMP.extension(TAG, "0.1", function(AMP2) {
    ...
    AMP2.registerElement(TAG, AmpExperiment);
  });
})();
