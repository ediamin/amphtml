(self.AMP=self.AMP||[]).push({n:"amp-facebook",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpFacebook = /* @__PURE__ */ function(_BaseElement) {
    ...
    function AmpFacebook2() {
      _classCallCheck11(this, AmpFacebook2);
      return _super.apply(this, arguments);
    }
    _createClass8(AmpFacebook2, [{
      key: "init",
      value: function init() {
        var _this = this;
        return dict({
      ...
      value: function isLayoutSupported(layout) {
        ...
        return _get2(_getPrototypeOf4(AmpFacebook2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }], [{
  ...
  AmpFacebook["props"] = _extends10({}, BaseElement["props"], {
    "embedAs": {
      attrs: ["data-embed-as"],
  ...
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpFacebook);
  });
})();
