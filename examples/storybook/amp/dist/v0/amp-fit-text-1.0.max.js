(self.AMP=self.AMP||[]).push({n:"amp-fit-text",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function resetStyles(element, properties) {
    for (var i3 = 0; i3 < properties.length; i3++) {
      setStyle(element, properties[i3], null);
    }
  }
  ...
  var CSS3 = "amp-fit-text{display:block;overflow:hidden;position:relative}amp-fit-text:not(.i-amphtml-built){color:transparent!important}amp-fit-text:not(.i-amphtml-built)>:not([placeholder]):not(.i-amphtml-svc){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-fit-text/1.0/amp-fit-text.css*/";
  ...
  var AmpFitText = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpFitText2, _BaseElement);
    var _super = _createSuper3(AmpFitText2);
    function AmpFitText2() {
      _classCallCheck9(this, AmpFitText2);
      return _super.apply(this, arguments);
    }
    _createClass7(AmpFitText2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-fit-text"), 'expected global "bento" or specific "bento-fit-text" experiment to be enabled');
        return _get2(_getPrototypeOf3(AmpFitText2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
    return AmpFitText2;
  }(BaseElement);
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpFitText, CSS3);
  });
})();
