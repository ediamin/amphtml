(self.AMP=self.AMP||[]).push({n:"amp-font",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var FontLoader = /* @__PURE__ */ function() {
    function FontLoader2(ampdoc) {
      _classCallCheck3(this, FontLoader2);
      this.ampdoc_ = ampdoc;
  ...
  var FontComparator = /* @__PURE__ */ function() {
    function FontComparator2(container, customFont, defaultFont) {
      _classCallCheck3(this, FontComparator2);
  ...
  var AmpFont = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpFont2(element) {
      var _this;
      _classCallCheck4(this, AmpFont2);
  ...
  AMP.extension(TAG, "0.1", function(AMP2) {
    AMP2.registerElement(TAG, AmpFont);
  });
})();
