(self.AMP=self.AMP||[]).push({n:"amp-fx-flying-carpet",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpFlyingCarpet = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpFlyingCarpet2(element) {
      var _this;
      _classCallCheck3(this, AmpFlyingCarpet2);
    ...
    _createClass2(AmpFlyingCarpet2, [{
      ...
      value: function assertPosition_() {
        ...
        userAssert(layoutBox.top >= minTop, "<amp-fx-flying-carpet> elements must be positioned after the 75% of first viewport: %s Current position: %s. Min: %s", this.element, layoutBox.top, minTop);
        userAssert(layoutBox.top <= maxTop, "<amp-fx-flying-carpet> elements must be positioned before the last viewport: %s Current position: %s. Max: %s", this.element, layoutBox.top, maxTop);
      }
    }, {
      key: "layoutCallback",
      ...
      key: "observeNewChildren_",
      value: function observeNewChildren_() {
        var _this3 = this;
      ...
      value: function layoutBuiltChild_(node) {
  ...
  AMP.extension(TAG, "0.1", function(AMP2) {
    AMP2.registerElement(TAG, AmpFlyingCarpet, CSS2);
  });
})();
