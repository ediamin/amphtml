(self.AMP=self.AMP||[]).push({n:"amp-geo",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpGeo = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _createClass2(AmpGeo2, [{
      ...
      key: "findCountry_",
      value: function findCountry_(ampdoc) {
        var _this3 = this;
        ...
        if (getMode(this.win).geoOverride && (isCanary(this.win) || getMode(this.win).localDev)) {
          var overrideGeoMatch = GEO_HOTPATCH_STR_REGEX.exec(getMode(this.win).geoOverride.toLowerCase());
        ...
        return this.mode_ !== mode.GEO_API ? resolvedPromise() : this.fetchCountry_().then(function(data) {
          if (data) {
      ...
      key: "validateApiUrl_",
      value: function validateApiUrl_(url) {
      ...
      key: "clearPreRender_",
      value: function clearPreRender_(body) {
  ...
  AMP.extension("amp-geo", "0.1", function(AMP2) {
    geoDeferred = new Deferred();
    AMP2.registerElement(TAG, AmpGeo);
    AMP2.registerServiceForDoc(SERVICE_TAG, function() {
