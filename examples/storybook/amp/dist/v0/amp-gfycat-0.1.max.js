(self.AMP=self.AMP||[]).push({n:"amp-gfycat",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpGfycat = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpGfycat2(element) {
      var _this;
      _classCallCheck7(this, AmpGfycat2);
    ...
    _createClass6(AmpGfycat2, [{
      ...
      value: function getVideoId_() {
        return userAssert(this.element.getAttribute("data-gfyid"), "The data-gfyid attribute is required for <amp-gfycat> %s", this.element);
      }
    }, {
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpGfycat);
  });
})();
