(self.AMP=self.AMP||[]).push({n:"amp-google-document-embed",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpDriveViewer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpDriveViewer2(element) {
      var _this;
      _classCallCheck3(this, AmpDriveViewer2);
      _this = _super.call(this, element);
      _this.iframe_ = null;
      return _this;
    }
    _createClass2(AmpDriveViewer2, [{
      ...
      value: function buildCallback() {
        userAssert(this.element.getAttribute("src"), "The src attribute is required for <amp-google-document-embed> %s", this.element);
      }
    }, {
      key: "layoutCallback",
      ...
      value: function mutatedAttributesCallback(mutations) {
        ...
        this.propagateAttributes(attrs, iframe, true);
  ...
  AMP.extension("amp-google-document-embed", "0.1", function(AMP2) {
    AMP2.registerElement("amp-google-document-embed", AmpDriveViewer);
  });
})();
