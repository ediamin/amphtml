(self.AMP=self.AMP||[]).push({n:"amp-ima-video",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var ImaPlayerData = /* @__PURE__ */ function() {
    function ImaPlayerData2() {
      _classCallCheck2(this, ImaPlayerData2);
      this.currentTime = 0;
      this.duration = 1;
      this.playedRanges = [];
    }
    _createClass(ImaPlayerData2, [{
      key: "update",
  ...
  var AmpImaVideo = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpImaVideo2(element) {
      var _this;
      _classCallCheck11(this, AmpImaVideo2);
    ...
    _createClass10(AmpImaVideo2, [{
      ...
      value: function layoutCallback() {
        ...
        var consentPolicyId = _get(_getPrototypeOf(AmpImaVideo2.prototype), "getConsentPolicy", this).call(this);
  ...
  AMP.extension(TAG4, "0.1", function(AMP2) {
    AMP2.registerElement(TAG4, AmpImaVideo);
  });
})();
