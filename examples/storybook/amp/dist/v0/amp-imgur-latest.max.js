(self.AMP=self.AMP||[]).push({n:"amp-imgur",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpImgur = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpImgur2(element) {
      var _this;
      _classCallCheck3(this, AmpImgur2);
    ...
    _createClass2(AmpImgur2, [{
      ...
      value: function buildCallback() {
        userAssert(this.element.dataset.imgurId, "The data-imgur-id attribute is required for <amp-imgur> %s", this.element);
      }
    }, {
      key: "layoutCallback",
      ...
      key: "insertLoadIframe_",
      value: function insertLoadIframe_(id) {
        var _this3 = this;
  ...
  AMP.extension(TAG, "0.1", function(AMP2) {
    AMP2.registerElement(TAG, AmpImgur);
  });
})();
