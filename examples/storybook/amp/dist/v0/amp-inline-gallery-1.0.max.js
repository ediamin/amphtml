(self.AMP=self.AMP||[]).push({n:"amp-inline-gallery",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function deepScan(startNode, callback, arg, state, includeSelf) {
    ...
    if (includeSelf) {
      ...
      for (var _iterator = _createForOfIteratorHelperLoose(startNode.children), _step; !(_step = _iterator()).done; ) {
  ...
  var ContextNode = /* @__PURE__ */ function() {
    function ContextNode2(node, name) {
      _classCallCheck3(this, ContextNode2);
      this.node = node;
      this.name = name;
  ...
  var Subscriber = /* @__PURE__ */ function() {
    function Subscriber2(contextNode, func, deps) {
      var _this = this;
      _classCallCheck4(this, Subscriber2);
  ...
  function Pagination(_ref) {
    ...
    return createElement(Wrapper, _extends4({
      ...
      currentSlide,
      inset,
      goTo: function goTo(i3) {
        return setCurrentSlide(i3);
      },
      slideCount
    })));
  }
  function Dots(_ref2) {
    ...
    var _loop = function _loop2(i4) {
      dotList.push(createElement("div", {
        ...
        role: "button",
        "aria-selected": String(i4 === currentSlide),
        onClick: function onClick() {
          return goTo(i4);
        },
        class: $dotProgress + " " + (inset ? $inset : ""),
        style: {
          opacity: i4 === currentSlide ? 1 : 0
        }
      }))));
    };
  ...
  var MediaQueryProps = /* @__PURE__ */ function() {
    function MediaQueryProps2(win, callback) {
      _classCallCheck5(this, MediaQueryProps2);
      this.win_ = win;
  ...
  var PreactBaseElement = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _createClass6(PreactBaseElement2, [{
      ...
      value: function buildCallback() {
        ...
        this.observer.observe(this.element, _extends6({
          attributes: true
      ...
      value: function rerender_() {
        ...
        var v3 = createElement(WithAmpContext, _extends6({}, this.context_), comp);
  ...
  var AmpInlineGalleryPagination = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits2(AmpInlineGalleryPagination2, _PreactBaseElement);
    var _super = _createSuper2(AmpInlineGalleryPagination2);
    function AmpInlineGalleryPagination2() {
      _classCallCheck8(this, AmpInlineGalleryPagination2);
      return _super.apply(this, arguments);
    }
    _createClass7(AmpInlineGalleryPagination2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        ...
        return _get2(_getPrototypeOf2(AmpInlineGalleryPagination2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
  ...
  var _excluded4 = ["advance", "as", "by", "disabled", "outsetArrows", "rtl"];
  var _excluded22 = ["by", "className"];
  function _extends7() {
  ...
  function Arrow(_ref) {
    var _objstr;
    var advance = _ref.advance, _ref$as = _ref.as, Comp = _ref$as === void 0 ? DefaultArrow : _ref$as, by = _ref.by, disabled = _ref.disabled, outsetArrows = _ref.outsetArrows, rtl = _ref.rtl, rest = _objectWithoutPropertiesLoose4(_ref, _excluded4);
  ...
  function DefaultArrow(_ref2) {
    var by = _ref2.by, className = _ref2.className, rest = _objectWithoutPropertiesLoose4(_ref2, _excluded22);
    return createElement("div", {
      className
    }, createElement("button", _extends7({
  ...
  function ScrollerWithRef(_ref, ref) {
    ...
    return createElement("div", _extends8({
      ref: containerRef,
  ...
  function LightboxWithRef(_ref, ref) {
    var _ref$animation = _ref.animation, animation = _ref$animation === void 0 ? "fade-in" : _ref$animation, children = _ref.children, closeButtonAs = _ref.closeButtonAs, onAfterClose = _ref.onAfterClose, onAfterOpen = _ref.onAfterOpen, onBeforeOpen = _ref.onBeforeOpen, rest = _objectWithoutPropertiesLoose6(_ref, _excluded6);
  ...
  function ScreenReaderCloseButton(props) {
    return createElement("button", _extends9({}, props, {
      tabIndex: -1,
  ...
  function WithLightbox(_ref) {
    var _ref$as = _ref.as, Comp = _ref$as === void 0 ? "div" : _ref$as, children = _ref.children, _ref$enableActivation = _ref.enableActivation, enableActivation = _ref$enableActivation === void 0 ? true : _ref$enableActivation, customOnClick = _ref.onClick, _ref$render = _ref.render, render2 = _ref$render === void 0 ? function() {
      return children;
    } : _ref$render, rest = _objectWithoutPropertiesLoose7(_ref, _excluded7);
    ...
    return createElement(Comp, _extends10({}, activationProps, rest), children);
  }
  ...
  var _excluded9 = ["aspectRatio", "children", "className", "loop"];
  function _extends12() {
  ...
  function Thumbnails(_ref) {
    var aspectRatio = _ref.aspectRatio, children = _ref.children, _ref$className = _ref.className, className = _ref$className === void 0 ? "" : _ref$className, _ref$loop = _ref.loop, loop = _ref$loop === void 0 ? false : _ref$loop, rest = _objectWithoutPropertiesLoose9(_ref, _excluded9);
    ...
    return createElement(BaseCarousel, _extends12({
      className: className + " " + $thumbnails,
      mixedLength: true,
      snap: false,
      ...
      outsetArrows: true,
      _thumbnails: true
    }, rest), children || slides.map(function(slide, i3) {
  ...
  var AmpInlineGalleryThumbnails = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits3(AmpInlineGalleryThumbnails2, _PreactBaseElement);
    var _super = _createSuper3(AmpInlineGalleryThumbnails2);
    function AmpInlineGalleryThumbnails2() {
      _classCallCheck9(this, AmpInlineGalleryThumbnails2);
      return _super.apply(this, arguments);
    }
    _createClass8(AmpInlineGalleryThumbnails2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-inline-gallery"), 'expected global "bento" or specific "bento-inline-gallery" experiment to be enabled');
        return _get3(_getPrototypeOf3(AmpInlineGalleryThumbnails2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
  ...
  function InlineGallery(_ref) {
    var children = _ref.children, rest = _objectWithoutPropertiesLoose10(_ref, _excluded10);
    ...
    return createElement(ContainWrapper, _extends13({
      size: false,
      layout: true
  ...
  var BaseElement = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits4(BaseElement2, _PreactBaseElement);
    var _super = _createSuper4(BaseElement2);
    function BaseElement2() {
      _classCallCheck10(this, BaseElement2);
      return _super.apply(this, arguments);
    }
    _createClass9(BaseElement2, [{
      key: "init",
      value: function init() {
        return dict({
  ...
  var AmpInlineGallery = /* @__PURE__ */ function(_BaseElement) {
    _inherits5(AmpInlineGallery2, _BaseElement);
    var _super = _createSuper5(AmpInlineGallery2);
    function AmpInlineGallery2() {
      _classCallCheck11(this, AmpInlineGallery2);
      return _super.apply(this, arguments);
    }
    _createClass10(AmpInlineGallery2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-inline-gallery"), 'expected global "bento" or specific "bento-inline-gallery" experiment to be enabled');
  ...
  AMP.extension(TAG4, "1.0", function(AMP2) {
    AMP2.registerElement(TAG4, AmpInlineGallery);
    AMP2.registerElement(TAG2, AmpInlineGalleryPagination, CSS5);
    AMP2.registerElement(TAG3, AmpInlineGalleryThumbnails);
  });
})();
