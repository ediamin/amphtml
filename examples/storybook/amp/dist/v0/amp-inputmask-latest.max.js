(self.AMP=self.AMP||[]).push({n:"amp-inputmask",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var Mask = /* @__PURE__ */ function() {
    ...
    _createClass(Mask2, [{
      key: "getInputmask_",
      value: function getInputmask_(element) {
        if (this.Inputmask_) {
  ...
  var TextMask = /* @__PURE__ */ function() {
    function TextMask2(element) {
      var _this = this;
      _classCallCheck4(this, TextMask2);
      this.element_ = element;
    ...
    _createClass3(TextMask2, [{
      key: "handleBeforeSubmit_",
      value: function handleBeforeSubmit_(form) {
      ...
      key: "isMasked",
      value: function isMasked(element) {
        return Boolean(element[ELEMENT_MASK_PROPERTY]);
      }
    }, {
      key: "isMaskOutputElement",
      value: function isMaskOutputElement(element) {
  ...
  var AmpInputmaskService = /* @__PURE__ */ function() {
    function AmpInputmaskService2(ampdoc) {
      var _this = this;
      _classCallCheck5(this, AmpInputmaskService2);
      this.ampdoc = ampdoc;
      this.masks_ = [];
    ...
    _createClass4(AmpInputmaskService2, [{
      key: "install",
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerServiceForDoc(SERVICE, function(ampdoc) {
