(self.AMP=self.AMP||[]).push({n:"amp-instagram",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpInstagram = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpInstagram2(element) {
      var _this;
      _classCallCheck3(this, AmpInstagram2);
    ...
    _createClass2(AmpInstagram2, [{
      ...
      value: function buildCallback() {
        this.shortcode_ = userAssert(this.element.getAttribute("data-shortcode") || this.element.getAttribute("shortcode"), "The data-shortcode attribute is required for <amp-instagram> %s", this.element);
  ...
  AMP.extension("amp-instagram", "0.1", function(AMP2) {
    AMP2.registerElement("amp-instagram", AmpInstagram, CSS2);
  });
})();
