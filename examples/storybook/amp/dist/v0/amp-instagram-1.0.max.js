(self.AMP=self.AMP||[]).push({n:"amp-instagram",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var CSS2 = "amp-instagram{display:block;overflow:hidden;position:relative}amp-instagram:not(.i-amphtml-built)>:not([placeholder]):not(.i-amphtml-svc){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-instagram/1.0/amp-instagram.css*/";
  ...
  var AmpInstagram = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpInstagram2, _BaseElement);
    var _super = _createSuper3(AmpInstagram2);
    function AmpInstagram2() {
      _classCallCheck9(this, AmpInstagram2);
      return _super.apply(this, arguments);
    }
    _createClass7(AmpInstagram2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        ...
        return _get2(_getPrototypeOf3(AmpInstagram2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }, {
      key: "init",
      value: function init() {
  ...
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpInstagram, CSS2);
  });
})();
