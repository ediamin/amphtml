(self.AMP=self.AMP||[]).push({n:"amp-izlesene",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpIzlesene = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpIzlesene2(element) {
      var _this;
      _classCallCheck5(this, AmpIzlesene2);
    ...
    _createClass4(AmpIzlesene2, [{
      ...
      value: function buildCallback() {
        ...
        this.videoid_ = userAssert(this.element.getAttribute("data-videoid"), "The data-videoid attribute is required for <amp-izlesene> %s", this.element);
      }
    }, {
  ...
  AMP.extension("amp-izlesene", "0.1", function(AMP2) {
    AMP2.registerElement("amp-izlesene", AmpIzlesene);
  });
})();
