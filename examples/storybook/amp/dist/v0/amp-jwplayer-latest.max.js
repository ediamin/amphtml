(self.AMP=self.AMP||[]).push({n:"amp-jwplayer",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpJWPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpJWPlayer2(element) {
      var _this;
      _classCallCheck8(this, AmpJWPlayer2);
    ...
    _createClass7(AmpJWPlayer2, [{
      ...
      value: function buildCallback() {
        ...
        this.contentid_ = userAssert(element.getAttribute("data-playlist-id") || element.getAttribute("data-media-id"), "Either the data-media-id or the data-playlist-id attributes must be specified for <amp-jwplayer> %s", element);
        this.playerid_ = userAssert(element.getAttribute("data-player-id"), "The data-player-id attribute is required for <amp-jwplayer> %s", element);
      ...
      value: function layoutCallback() {
        ...
        var queryParams = dict({
          "search": this.getContextualVal_() || void 0,
          "recency": this.contentRecency_ || void 0,
          "backfill": this.contentBackfill_ || void 0,
          "isAMP": true
        });
        var url = this.getSingleLineEmbed_();
        var src = addParamsToUrl(url, queryParams);
        var frame = disableScrollingOnIframe(createFrameFor(this, src, this.element.id));
        addUnsafeAllowAutoplay(frame);
        disableScrollingOnIframe(frame);
        this.unlistenFrame_ = listen(this.win, "message", this.onMessage_);
        this.unlistenFullscreen_ = listen(frame, "fullscreenchange", function() {
      ...
      key: "onReady_",
      value: function onReady_(detail) {
        var element = this.element;
      ...
      key: "onMessage_",
      value: function onMessage_(messageEvent) {
      ...
      key: "sendCommand_",
      value: function sendCommand_(method, optParams) {
        var _this4 = this;
      ...
      key: "isSafariOrIos_",
      value: function isSafariOrIos_() {
        var platform = Services.platformFor(this.win);
        return platform.isSafari() || platform.isIos();
      }
    }, {
      key: "getSingleLineEmbed_",
      value: function getSingleLineEmbed_() {
      ...
      key: "getContextualVal_",
      value: function getContextualVal_() {
  ...
  AMP.extension("amp-jwplayer", "0.1", function(AMP2) {
    AMP2.registerElement("amp-jwplayer", AmpJWPlayer);
  });
})();
