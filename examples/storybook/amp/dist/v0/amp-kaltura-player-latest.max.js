(self.AMP=self.AMP||[]).push({n:"amp-kaltura-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpKaltura = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpKaltura2(element) {
      var _this;
      _classCallCheck5(this, AmpKaltura2);
    ...
    _createClass4(AmpKaltura2, [{
      ...
      value: function buildCallback() {
        this.partnerId_ = userAssert(this.element.getAttribute("data-partner"), "The data-partner attribute is required for <amp-kaltura-player> %s", this.element);
  ...
  AMP.extension("amp-kaltura-player", "0.1", function(AMP2) {
    AMP2.registerElement("amp-kaltura-player", AmpKaltura);
  });
})();
