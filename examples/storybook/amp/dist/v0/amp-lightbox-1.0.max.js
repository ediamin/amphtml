(self.AMP=self.AMP||[]).push({n:"amp-lightbox",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function ScreenReaderCloseButton(props) {
    return createElement("button", _extends3({}, props, {
      tabIndex: -1,
      ...
      value: function init() {
        ...
        return dict({
          "onBeforeOpen": function onBeforeOpen() {
            return _this2.beforeOpen_();
          },
          "onAfterOpen": function onAfterOpen() {
            return _this2.afterOpen_();
          },
          "onAfterClose": function onAfterClose() {
            return _this2.afterClose_();
          }
        });
      }
    }, {
  ...
  var AmpLightbox = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpLightbox2, _BaseElement);
    var _super = _createSuper3(AmpLightbox2);
    function AmpLightbox2() {
      _classCallCheck10(this, AmpLightbox2);
      return _super.apply(this, arguments);
    }
    _createClass9(AmpLightbox2, [{
      key: "init",
      value: function init() {
        ...
        return _get2(_getPrototypeOf3(AmpLightbox2.prototype), "init", this).call(this);
      }
    }, {
      key: "triggerEvent",
      value: function triggerEvent(element, eventName, detail) {
        var event = createCustomEvent(toWin(element.ownerDocument.defaultView), "amp-lightbox." + eventName, detail);
        Services.actionServiceForDoc(element).trigger(element, eventName, event, ActionTrust.HIGH);
        _get2(_getPrototypeOf3(AmpLightbox2.prototype), "triggerEvent", this).call(this, element, eventName, detail);
      }
    }, {
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-lightbox"), 'expected global "bento" or specific "bento-lightbox" experiment to be enabled');
        return _get2(_getPrototypeOf3(AmpLightbox2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
    return AmpLightbox2;
  }(BaseElement);
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpLightbox, CSS3);
  });
})();
