(self.AMP=self.AMP||[]).push({n:"amp-minute-media-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpMinuteMediaPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpMinuteMediaPlayer2(element) {
      var _this;
      _classCallCheck7(this, AmpMinuteMediaPlayer2);
    ...
    _createClass6(AmpMinuteMediaPlayer2, [{
      ...
      key: "initFields_",
      value: function initFields_() {
        var element = this.element;
        this.contentType_ = userAssert(element.getAttribute("data-content-type"), "The data-content-type must be specified for <amp-minute-media-player> %s", element);
        if (this.contentType_ != "semantic") {
          this.contentId_ = userAssert(element.getAttribute("data-content-id"), "The data-content-id must be specified for %s data-content-type in <amp-minute-media-player> %s", this.contentType_, element);
        } else {
          this.initSemanticFields_();
        }
      }
    }, {
      key: "initSemanticFields_",
      value: function initSemanticFields_() {
        var element = this.element;
      ...
      key: "handleMinuteMediaPlayerMessage_",
      value: function handleMinuteMediaPlayerMessage_(event) {
      ...
      key: "sendCommand_",
      value: function sendCommand_(message) {
        var _this3 = this;
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpMinuteMediaPlayer);
  });
})();
