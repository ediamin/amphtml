(self.AMP=self.AMP||[]).push({n:"amp-mowplayer",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpMowplayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpMowplayer2(element) {
      var _this;
      _classCallCheck8(this, AmpMowplayer2);
    ...
    _createClass7(AmpMowplayer2, [{
      ...
      value: function buildCallback() {
        this.mediaid_ = userAssert(this.element.getAttribute("data-mediaid"), "/The data-mediaid attribute is required for <amp-mowplayer> %s", this.element);
        var deferred = new Deferred();
      ...
      key: "handleMowMessage_",
      value: function handleMowMessage_(event) {
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpMowplayer);
  });
})();
