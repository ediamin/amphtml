(self.AMP=self.AMP||[]).push({n:"amp-mraid",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var HostServices = /* @__PURE__ */ function() {
    function HostServices2() {
      _classCallCheck3(this, HostServices2);
    }
    _createClass2(HostServices2, null, [{
      key: "isAvailable",
  ...
  var MraidService = /* @__PURE__ */ function() {
    function MraidService2(mraid) {
      _classCallCheck4(this, MraidService2);
      this.mraid_ = mraid;
      this.expanded_ = false;
    }
    _createClass3(MraidService2, [{
      ...
      key: "enterFullscreenOverlay",
      value: function enterFullscreenOverlay(unusedTargetElement) {
        if (this.expanded_) {
      ...
      key: "exitFullscreenOverlay",
      value: function exitFullscreenOverlay(unusedTargetElement) {
        if (!this.expanded_) {
          return Promise.resolve(false);
        }
        this.mraid_.close();
  ...
  var MraidInitializer = /* @__PURE__ */ function() {
    function MraidInitializer2(ampdoc) {
      var _this = this;
      _classCallCheck5(this, MraidInitializer2);
      this.ampdoc_ = ampdoc;
    ...
    _createClass4(MraidInitializer2, [{
      key: "mraidReady_",
      value: function mraidReady_() {
      ...
      key: "mraidLoadSuccess_",
      value: function mraidLoadSuccess_() {
        var _this2 = this;
      ...
      key: "handleMismatch_",
      value: function handleMismatch_() {
        HostServices.rejectVisibilityServiceForDoc(this.ampdoc_, {
  ...
  AMP.extension(TAG, "0.1", function(AMP2) {
    AMP2.registerServiceForDoc(TAG, MraidInitializer);
  });
})();
