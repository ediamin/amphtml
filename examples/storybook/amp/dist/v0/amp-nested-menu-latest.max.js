(self.AMP=self.AMP||[]).push({n:"amp-nested-menu",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpNestedMenu = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpNestedMenu2(element) {
      var _this;
      _classCallCheck3(this, AmpNestedMenu2);
    ...
    _createClass2(AmpNestedMenu2, [{
      ...
      key: "registerSubmenuElements_",
      value: function registerSubmenuElements_() {
        var _this2 = this;
        ...
        submenuBtns.forEach(function(submenuBtn) {
          ...
          userAssert(_this2.action_.hasAction(submenuBtn, "tap") == false, "submenu open/close buttons should not have tap actions registered.");
        });
      }
    }, {
      ...
      value: function shouldHandleClick_(target, submenuBtn) {
      ...
      key: "handleSubmenuOpenClick_",
      value: function handleSubmenuOpenClick_(openElement) {
        ...
        userAssert(submenu, TAG + " requires each submenu open button to have a submenu as its sibling");
        this.open_(submenu);
      }
    }, {
      key: "open_",
      value: function open_(submenu) {
        var _this3 = this;
        ...
        if (parentMenu) {
          ...
          Services.timerFor(this.win).delay(function() {
            ...
            userAssert(submenuClose, TAG + " requires each submenu to contain at least one submenu close button");
            tryFocus(submenuClose);
          }, ANIMATION_TIMEOUT);
        }
      }
    }, {
      key: "handleSubmenuCloseClick_",
      value: function handleSubmenuCloseClick_(closeElement) {
        var submenu = closestAncestorElementBySelector(closeElement, "[amp-nested-submenu]");
        userAssert(submenu, TAG + ": submenu close buttons are only allowed inside submenus");
        this.close_(submenu);
      }
    }, {
      key: "close_",
      value: function close_(submenu) {
        if (!submenu.hasAttribute("open")) {
          return;
        }
        var parentMenu = this.getParentMenu_(submenu);
      ...
      key: "handleMenuNavigation_",
      value: function handleMenuNavigation_(e) {
      ...
      key: "handleMenuItemNavigation_",
      value: function handleMenuItemNavigation_(e) {
        var target = dev().assertElement(e.target);
      ...
      key: "getParentMenu_",
      value: function getParentMenu_(element) {
  ...
  AMP.extension(TAG, "0.1", function(AMP2) {
    AMP2.registerElement(TAG, AmpNestedMenu, CSS2);
  });
})();
