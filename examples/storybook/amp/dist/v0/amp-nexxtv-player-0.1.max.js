(self.AMP=self.AMP||[]).push({n:"amp-nexxtv-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpNexxtvPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpNexxtvPlayer2(element) {
      var _this;
      _classCallCheck9(this, AmpNexxtvPlayer2);
    ...
    _createClass8(AmpNexxtvPlayer2, [{
      ...
      key: "playerReady_",
      value: function playerReady_(data) {
        this.playerReadyResolver_(this.iframe_);
        dev().info(TAG2, "nexx player ready", data);
      }
    }, {
      key: "getVideoIframeSrc_",
      value: function getVideoIframeSrc_(consentString) {
        var el = this.element;
        var _el$dataset = el.dataset, client = _el$dataset.client, disableAds = _el$dataset.disableAds, domainId = _el$dataset.domainId, exitMode = _el$dataset.exitMode, mediaid = _el$dataset.mediaid, mode = _el$dataset.mode, streamingFilter = _el$dataset.streamingFilter, streamtype = _el$dataset.streamtype;
        var clientId = userAssert(client || domainId, "One of data-client or data-domain-id attributes is required for <amp-nexxtv-player> %s", el);
        userAssert(mediaid, "The data-mediaid attribute is required for <amp-nexxtv-player> %s", el);
      ...
      key: "getConsentPolicyInfo_",
      value: function getConsentPolicyInfo_() {
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpNexxtvPlayer);
  });
})();
