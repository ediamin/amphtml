(self.AMP=self.AMP||[]).push({n:"amp-ooyala-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpOoyalaPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpOoyalaPlayer2(element) {
      var _this;
      _classCallCheck8(this, AmpOoyalaPlayer2);
    ...
    _createClass7(AmpOoyalaPlayer2, [{
      ...
      value: function buildCallback() {
        var el = this.element;
        this.embedCode_ = userAssert(el.getAttribute("data-embedcode"), "The data-embedcode attribute is required for %s", el);
        this.pCode_ = userAssert(el.getAttribute("data-pcode"), "The data-pcode attribute is required for %s", el);
        this.playerId_ = userAssert(el.getAttribute("data-playerid"), "The data-playerid attribute is required for %s", el);
        var deferred = new Deferred();
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpOoyalaPlayer);
  });
})();
