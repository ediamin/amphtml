(self.AMP=self.AMP||[]).push({n:"amp-powr-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpPowrPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpPowrPlayer2(element) {
      var _this;
      _classCallCheck8(this, AmpPowrPlayer2);
    ...
    _createClass7(AmpPowrPlayer2, [{
      ...
      value: function getIframeSrc_() {
        var el = this.element;
        var account = userAssert(el.getAttribute("data-account"), "The data-account attribute is required for <amp-powr-player> %s", el);
        this.playerId_ = userAssert(el.getAttribute("data-player"), "The data-player attribute is required for <amp-powr-player> %s", el);
        var video = el.getAttribute("data-video");
        var terms = el.getAttribute("data-terms");
        userAssert(video || terms, "The data-video or data-terms attribute is required for <amp-powr-player> %s", el);
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpPowrPlayer);
  });
})();
