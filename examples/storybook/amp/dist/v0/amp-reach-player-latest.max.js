(self.AMP=self.AMP||[]).push({n:"amp-reach-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpReachPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpReachPlayer2(element) {
      var _this;
      _classCallCheck5(this, AmpReachPlayer2);
      _this = _super.call(this, element);
      _this.iframe_ = null;
      _this.pauseHelper_ = new PauseHelper(_this.element);
      return _this;
    }
    _createClass4(AmpReachPlayer2, [{
  ...
  AMP.extension("amp-reach-player", "0.1", function(AMP2) {
    AMP2.registerElement("amp-reach-player", AmpReachPlayer);
  });
})();
