(self.AMP=self.AMP||[]).push({n:"amp-render",ev:"1.0",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function deepScan(startNode, callback, arg, state, includeSelf) {
    ...
    if (includeSelf) {
      ...
      for (var _iterator = _createForOfIteratorHelperLoose4(startNode.children), _step; !(_step = _iterator()).done; ) {
  ...
  var Values = /* @__PURE__ */ function() {
    ...
    _createClass3(Values2, [{
      ...
      value: function maybeUpdated_(used, value) {
        ...
        for (var _iterator = _createForOfIteratorHelperLoose5(subscribers), _step; !(_step = _iterator()).done; ) {
      ...
      value: function updateTree_(parent, parentOverridden) {
        ...
        if (parent != oldParent) {
          ...
          if (parent) {
            ...
            for (var _iterator = _createForOfIteratorHelperLoose6(parentChildren), _step; !(_step = _iterator()).done; ) {
  ...
  function forEachContained(node, callback, includeSelf) {
    ...
    if (closest.node == node) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose6(closest.children), _step2; !(_step2 = _iterator2()).done; ) {
  ...
  var _excluded3 = ["src", "getJson", "render", "ariaLiveValue", "onLoading", "onReady", "onRefresh", "onError"];
  function _extends6() {
  ...
  function RenderWithRef(_ref, ref) {
    var _ref$src = _ref.src, src = _ref$src === void 0 ? "" : _ref$src, _ref$getJson = _ref.getJson, getJson = _ref$getJson === void 0 ? DEFAULT_GET_JSON : _ref$getJson, _ref$render = _ref.render, render2 = _ref$render === void 0 ? DEFAULT_RENDER : _ref$render, _ref$ariaLiveValue = _ref.ariaLiveValue, ariaLiveValue = _ref$ariaLiveValue === void 0 ? "polite" : _ref$ariaLiveValue, onLoading = _ref.onLoading, onReady = _ref.onReady, onRefresh = _ref.onRefresh, onError = _ref.onError, rest = _objectWithoutPropertiesLoose3(_ref, _excluded3);
    useResourcesNotify();
  ...
  function parseUrlDeprecated(url, opt_nocache) {
    if (!a3) {
      ...
      cache2 = false ? null : self.__AMP_URL_CACHE || (self.__AMP_URL_CACHE = new LruCache(100));
    }
    return parseUrlWithA(a3, url, opt_nocache ? null : cache2);
  }
  ...
  var getAmpStateJson = function getAmpStateJson2(element, src) {
    return Services.bindForDocOrNull(element).then(function(bind) {
      ...
      userAssert(json !== void 0, "[amp-render] No data was found at provided uri: " + src);
      return json;
    });
  };
  function getUpdateValue(bindingValue, isFirstMutation) {
    ...
    if (bindingValue === Binding.ALWAYS) {
      user().warn(TAG2, 'binding="always" has performance implications.');
      return true;
    }
    return false;
  }
  var AmpRender = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpRender2, _BaseElement);
    var _super = _createSuper3(AmpRender2);
    function AmpRender2(element) {
      var _this;
      _classCallCheck11(this, AmpRender2);
      _this = _super.call(this, element);
    ...
    _createClass9(AmpRender2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        userAssert(isExperimentOn(this.win, "amp-render"), 'Experiment "amp-render" is not turned on.');
        return _get2(_getPrototypeOf3(AmpRender2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }, {
      key: "getPolicy_",
      ...
      key: "buildOptionsObject_",
      value: function buildOptionsObject_(shouldRefresh) {
      ...
      value: function init() {
        ...
        this.registerApiAction("refresh", function(api) {
          var src = _this3.element.getAttribute("src");
        ...
        return dict({
          ...
          "onRefresh": function onRefresh() {
            _this3.togglePlaceholder(true);
            _this3.toggleFallback(false);
          },
          "onError": function onError() {
            _this3.toggleLoading(false);
            if (_this3.getFallback()) {
              _this3.togglePlaceholder(false);
      ...
      key: "renderTemplateAsString_",
      value: function renderTemplateAsString_(data) {
      ...
      value: function checkPropsPostMutations() {
        ...
        templates.whenReady(template).then(function() {
          if (template != _this4.template_) {
            return;
          }
          _this4.mutateProps(dict({
            "render": function render2(data) {
              var bindingValue = _this4.element.getAttribute("binding");
              if (bindingValue === Binding.NEVER || bindingValue === Binding.NO) {
                return _this4.renderTemplateAsString_(data);
              }
              return Services.bindForDocOrNull(_this4.element).then(function(bind) {
                if (!bind) {
                  return _this4.renderTemplateAsString_(data);
                }
  ...
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpRender);
  });
})();
