(self.AMP=self.AMP||[]).push({n:"amp-sidebar",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function SidebarWithRef(_ref, ref) {
    ...
    return createElement("div", {
      className: obj_str_default((_objstr = {}, _objstr[$unmounted] = !mounted, _objstr)),
      part: "wrapper"
    }, createElement(ContainWrapper, _extends6({
      as: Comp,
      ref: sidebarRef,
      size: false,
      layout: true,
      ...
      part: "backdrop",
      style: backdropStyle,
      className: obj_str_default((_objstr3 = {}, _objstr3[$backdrop] = true, _objstr3[$defaultBackdropStyles] = true, _objstr3[backdropClassName] = backdropClassName, _objstr3)),
      hidden: !side
    }, createElement("div", {
      className: $backdropOverscrollBlocker
    })));
  }
  var Sidebar = forwardRef(SidebarWithRef);
  ...
  var AmpSidebar = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpSidebar2, _BaseElement);
    var _super = _createSuper3(AmpSidebar2);
    function AmpSidebar2() {
    ...
    _createClass8(AmpSidebar2, [{
      ...
      value: function init() {
        ...
        return _get2(_getPrototypeOf3(AmpSidebar2.prototype), "init", this).call(this);
      }
    }, {
      key: "attachedCallback",
      value: function attachedCallback() {
        _get2(_getPrototypeOf3(AmpSidebar2.prototype), "attachedCallback", this).call(this);
      ...
      value: function isLayoutSupported(unusedLayout) {
        userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-sidebar"), 'expected global "bento" or specific "bento-sidbar" experiment to be enabled');
        return true;
      }
    }]);
    return AmpSidebar2;
  ...
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpSidebar, CSS3);
  });
})();
