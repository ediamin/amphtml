(self.AMP=self.AMP||[]).push({n:"amp-sidebar",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpSidebar = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _createClass8(AmpSidebar2, [{
      ...
      key: "dismiss_",
      value: function dismiss_(skipAnimation, trust) {
        var _this9 = this;
        if (!this.opened_) {
          return false;
        }
      ...
      key: "handleSwipe_",
      value: function handleSwipe_(data, event) {
        if (data.first) {
  ...
  AMP.extension("amp-sidebar", "0.1", function(AMP2) {
