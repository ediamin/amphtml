(self.AMP=self.AMP||[]).push({n:"amp-soundcloud",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpSoundcloud = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpSoundcloud2(element) {
      var _this;
      _classCallCheck5(this, AmpSoundcloud2);
      _this = _super.call(this, element);
      _this.iframe_ = null;
      _this.pauseHelper_ = new PauseHelper(_this.element);
      return _this;
    }
    _createClass4(AmpSoundcloud2, [{
      ...
      value: function layoutCallback() {
        ...
        var mediaid = userAssert(this.element.getAttribute("data-trackid") || this.element.getAttribute("data-playlistid"), "data-trackid or data-playlistid is required for <amp-soundcloud> %s", this.element);
  ...
  AMP.extension("amp-soundcloud", "0.1", function(AMP2) {
    AMP2.registerElement("amp-soundcloud", AmpSoundcloud);
  });
})();
