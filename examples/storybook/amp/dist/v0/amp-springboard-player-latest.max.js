(self.AMP=self.AMP||[]).push({n:"amp-springboard-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpSpringboardPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpSpringboardPlayer2(element) {
      var _this;
      _classCallCheck5(this, AmpSpringboardPlayer2);
    ...
    _createClass4(AmpSpringboardPlayer2, [{
      ...
      value: function buildCallback() {
        ...
        this.mode_ = userAssert(this.element.getAttribute("data-mode"), "The data-mode attribute is required for <amp-springboard-player> %s", this.element);
        this.contentId_ = userAssert(this.element.getAttribute("data-content-id"), "The data-content-id attribute is required for<amp-springboard-player> %s", this.element);
        this.domain_ = userAssert(this.element.getAttribute("data-domain"), "The data-domain attribute is required for <amp-springboard-player> %s", this.element);
        this.siteId_ = userAssert(this.element.getAttribute("data-site-id"), "The data-site-id attribute is required for<amp-springboard-player> %s", this.element);
        this.playerId_ = userAssert(this.element.getAttribute("data-player-id"), "The data-player-id attribute is required for<amp-springboard-player> %s", this.element);
      }
    }, {
      key: "layoutCallback",
  ...
  AMP.extension("amp-springboard-player", "0.1", function(AMP2) {
    AMP2.registerElement("amp-springboard-player", AmpSpringboardPlayer);
  });
})();
