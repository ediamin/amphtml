(self.AMP=self.AMP||[]).push({n:"amp-standalone",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var StandaloneService = /* @__PURE__ */ function() {
    function StandaloneService2(ampdoc) {
      _classCallCheck4(this, StandaloneService2);
      this.ampdoc_ = ampdoc;
    }
    _createClass3(StandaloneService2, [{
      key: "getPlatform_",
      value: function getPlatform_() {
      ...
      key: "handleChromeStandalone_",
      value: function handleChromeStandalone_(a2) {
        var origin = a2.origin, target = a2.target;
        if (target === "_blank") {
          return;
        }
      ...
      key: "handleSafariStandalone_",
      value: function handleSafariStandalone_(a2) {
        var href = a2.href, origin = a2.origin, target = a2.target;
        if (target === "_blank") {
          return true;
        }
        if (getWinOrigin(this.ampdoc_.win) !== origin) {
  ...
  AMP.extension("amp-standalone", "0.1", function(AMP2) {
    AMP2.registerServiceForDoc("standalone", StandaloneService);
  });
})();
