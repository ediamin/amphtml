(self.AMP=self.AMP||[]).push({n:"amp-story-panning-media",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpStoryPanningMedia = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpStoryPanningMedia2(element) {
      var _this;
      _classCallCheck3(this, AmpStoryPanningMedia2);
      _this = _super.call(this, element);
      _this.element_ = element;
      _this.ampImgEl_ = null;
      _this.animateTo_ = {};
      _this.pageSize_ = null;
      _this.animationState_ = {};
      _this.storeService_ = null;
      _this.pageId_ = null;
      _this.isOnActivePage_ = false;
      _this.pageDistance_ = null;
      _this.maxDistanceToAnimate_ = 1;
      _this.groupId_ = null;
      return _this;
    }
    _createClass2(AmpStoryPanningMedia2, [{
      key: "buildCallback",
      ...
      value: function layoutCallback() {
        ...
        return whenUpgradedToCustomElement(this.ampImgEl_).then(function() {
          ...
          imgEl.classList = "";
          setImportantStyles(_this3.ampImgEl_, {
            left: "auto",
            right: "auto"
          });
        }).catch(function() {
      ...
      value: function initializeListeners_() {
        var _this4 = this;
        this.storeService_.subscribe(StateProperty.PAGE_SIZE, function(pageSize) {
          _this4.pageSize_ = pageSize;
        ...
        this.storeService_.subscribe(StateProperty.UI_STATE, function(uiState) {
          _this4.maxDistanceToAnimate_ = uiState === UIType.DESKTOP_PANELS ? 0 : 1;
        }, true);
        var config = {
          attributes: true,
      ...
      key: "setAnimateTo_",
      value: function setAnimateTo_() {
        var x = parseFloat(this.element_.getAttribute("x") || 0);
        var y = parseFloat(this.element_.getAttribute("y") || 0);
        var zoom = parseFloat(this.element_.getAttribute("zoom") || 1);
      ...
      key: "getMaxBounds_",
      value: function getMaxBounds_() {
        var _this$pageSize_ = this.pageSize_, containerHeight = _this$pageSize_.height, containerWidth = _this$pageSize_.width;
        ...
        var percentScaledToFitViewport = containerHeight / ampImgHeight;
        var scaledImageWidth = percentScaledToFitViewport * ampImgWidth;
        var scaledImageHeight = percentScaledToFitViewport * ampImgHeight;
        var widthFraction = 1 - containerWidth / (scaledImageWidth * this.animateTo_.zoom);
        var heightFraction = 1 - containerHeight / (scaledImageHeight * this.animateTo_.zoom);
        return {
      ...
      key: "onPanningMediaStateChange_",
      value: function onPanningMediaStateChange_(panningMediaState) {
        if (this.pageDistance_ <= this.maxDistanceToAnimate_ && panningMediaState[this.groupId_] && !deepEquals(this.animationState_, panningMediaState[this.groupId_])) {
          this.animationState_ = panningMediaState[this.groupId_];
          this.updateTransform_();
        }
      }
    }, {
      key: "updateTransform_",
      value: function updateTransform_() {
        var _this6 = this;
        ...
        return this.mutateElement(function() {
          setImportantStyles(_this6.ampImgEl_, {
            transform: "translate3d(" + x + "%, " + y + "%, " + _this6.calculateZoom_(zoom) + "px)"
          });
        });
      }
    }, {
      key: "calculateZoom_",
      value: function calculateZoom_(zoom) {
  ...
  AMP.extension("amp-story-panning-media", "0.1", function(AMP2) {
    AMP2.registerElement("amp-story-panning-media", AmpStoryPanningMedia, CSS2);
  });
})();
