(self.AMP=self.AMP||[]).push({n:"amp-stream-gallery",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
/*# sourceURL=/extensions/amp-stream-gallery/0.1/amp-stream-gallery.css*/`;
  ...
  var AmpStreamGallery = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpStreamGallery2(element) {
      var _this;
      _classCallCheck8(this, AmpStreamGallery2);
    ...
    _createClass7(AmpStreamGallery2, [{
      ...
      key: "getItemsForWidth_",
      value: function getItemsForWidth_(containerWidth, itemWidth) {
      ...
      key: "getWidthTakenByArrows_",
      value: function getWidthTakenByArrows_() {
      ...
      key: "shouldHideInsetButtons_",
      value: function shouldHideInsetButtons_() {
      ...
      key: "updatePeek_",
      value: function updatePeek_(peek) {
        this.peek_ = Math.max(0, peek || 0);
        this.updateVisibleCount_();
      }
    }, {
      key: "updateMaxItemWidth_",
      value: function updateMaxItemWidth_(maxItemWidth) {
        this.maxItemWidth_ = maxItemWidth || Number.MAX_VALUE;
        this.updateVisibleCount_();
      }
    }, {
      key: "updateMaxVisibleCount_",
      value: function updateMaxVisibleCount_(maxVisibleCount) {
        this.maxVisibleCount_ = maxVisibleCount || Number.MAX_VALUE;
        this.updateVisibleCount_();
      }
    }, {
      key: "updateMinItemWidth_",
      value: function updateMinItemWidth_(minItemWidth) {
        this.minItemWidth_ = minItemWidth || 1;
        this.updateVisibleCount_();
      }
    }, {
      key: "updateMinVisibleCount_",
      value: function updateMinVisibleCount_(minVisibleCount) {
        this.minVisibleCount_ = minVisibleCount || 1;
        this.updateVisibleCount_();
      }
    }, {
      key: "updateVisibleCount_",
      value: function updateVisibleCount_() {
        var _this7 = this;
      ...
      key: "updateOutsetArrows_",
      value: function updateOutsetArrows_(outsetArrows) {
        this.outsetArrows_ = outsetArrows;
        this.updateUi_();
      }
    }, {
      key: "updateExtraSpace_",
      value: function updateExtraSpace_(extraSpace) {
        this.content_.setAttribute("i-amphtml-stream-gallery-extra-space", extraSpace);
      }
    }, {
      key: "updateInsetArrowVisibility_",
      value: function updateInsetArrowVisibility_(insetArrowVisibility) {
        this.insetArrowVisibility_ = insetArrowVisibilityMapping[insetArrowVisibility] || InsetArrowVisibility.AUTO;
        this.updateUi_();
      }
    }, {
      key: "updateLoop_",
      value: function updateLoop_(loop) {
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpStreamGallery, CSS2);
  });
})();
