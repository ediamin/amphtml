(self.AMP=self.AMP||[]).push({n:"amp-test-comp",ev:"1.0",l:true,v:"2106040012001",m:0,f:(function(AMP,_){

(() => {
  // extensions/amp-test-comp/1.0/component.jss.js
  var $exampleContentHidden = "example-content-hidden-42646a8";
  var CSS2 = ".example-content-hidden-42646a8{display:none}";
  ...
  // extensions/amp-test-comp/1.0/component.js
  var _excluded3 = ["exampleTagNameProp"];
  function _extends6() {
  ...
  function TestComp(_ref) {
    var exampleTagNameProp = _ref.exampleTagNameProp, rest = _objectWithoutPropertiesLoose3(_ref, _excluded3);
    var _useState = useState(0), exampleValue = _useState[0], setExampleValue = _useState[1];
    ...
    return createElement(ContainWrapper, _extends6({
      ...
      className: "" + $exampleContentHidden
    }, "This is hidden"));
  }

  // extensions/amp-test-comp/1.0/base-element.js
  ...
  BaseElement["Component"] = TestComp;
  BaseElement["props"] = {
    "children": {
      passthrough: true
    }
  ...
  // build/amp-test-comp-1.0.css.js
  var CSS3 = "\n/*# sourceURL=/extensions/amp-test-comp/1.0/amp-test-comp.css*/";

  // extensions/amp-test-comp/1.0/amp-test-comp.js
  ...
  var TAG2 = "amp-test-comp";
  var AmpTestComp = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpTestComp2, _BaseElement);
    var _super = _createSuper3(AmpTestComp2);
    function AmpTestComp2() {
      _classCallCheck9(this, AmpTestComp2);
      return _super.apply(this, arguments);
    }
    _createClass7(AmpTestComp2, [{
      key: "init",
      value: function init() {
      ...
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-test-comp"), 'expected global "bento" or specific "bento-test-comp" experiment to be enabled');
        return _get2(_getPrototypeOf3(AmpTestComp2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
    return AmpTestComp2;
  }(BaseElement);
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpTestComp, CSS3);
  });
})();
...
//# sourceMappingURL=amp-test-comp-1.0.max.js.map
