(self.AMP=self.AMP||[]).push({n:"amp-test",ev:"1.0",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  // extensions/amp-test/1.0/component.jss.js
  var CSS2 = ".example-content-hidden-1be71b7{display:none}";
  ...
  // extensions/amp-test/1.0/component.js
  var _excluded3 = ["children", "exampleTagNameProp"];
  function _extends6() {
  ...
  function Test(_ref) {
    var children = _ref.children, exampleTagNameProp = _ref.exampleTagNameProp, rest = _objectWithoutPropertiesLoose3(_ref, _excluded3);
  ...
  // extensions/amp-test/1.0/base-element.js
  ...
  // build/amp-test-1.0.css.js
  var CSS3 = "amp-test{color:red!important}\n/*# sourceURL=/extensions/amp-test/1.0/amp-test.css*/";

  // extensions/amp-test/1.0/amp-test.js
  ...
  var TAG2 = "amp-test";
  var AmpTest = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpTest2, _BaseElement);
    var _super = _createSuper3(AmpTest2);
    function AmpTest2() {
      _classCallCheck9(this, AmpTest2);
      return _super.apply(this, arguments);
    }
    _createClass7(AmpTest2, [{
      key: "init",
      value: function init() {
      ...
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-test"), 'expected global "bento" or specific "bento-test" experiment to be enabled');
        return _get2(_getPrototypeOf3(AmpTest2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
    return AmpTest2;
  }(BaseElement);
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpTest, CSS3);
  });
})();
...
//# sourceMappingURL=amp-test-1.0.max.js.map
