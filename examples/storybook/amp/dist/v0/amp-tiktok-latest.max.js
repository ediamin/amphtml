(self.AMP=self.AMP||[]).push({n:"amp-tiktok",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){

(() => {
  // build/amp-tiktok-0.1.css.js
  var CSS2 = ".i-amphtml-tiktok-centered{height:100%;left:50%;width:325px;transform:translateX(-50%);position:absolute}.i-amphtml-tiktok-unresolved{position:fixed;opacity:0;pointer-events:none;width:325px;height:500px}\n/*# sourceURL=/extensions/amp-tiktok/0.1/amp-tiktok.css*/";
  ...
  function getServiceInternal(holder, id2) {
    devAssert(isServiceRegistered(holder, id2), "Expected service " + id2 + " to be registered");
    var services = getServices(holder);
    var s = services[id2];
    if (!s.obj) {
      devAssert(s.ctor, "Service " + id2 + " registered without ctor nor impl.");
      devAssert(s.context, "Service " + id2 + " registered without context.");
      s.obj = new s.ctor(s.context);
      devAssert(s.obj, "Service " + id2 + " constructed to null.");
      s.context = null;
      if (s.resolve) {
        s.resolve(s.obj);
      }
  ...
  function extensionScriptInNode(win, id2, version) {
    return extensionScriptsInNode(win.document.head).some(function(_ref) {
      var extensionId = _ref.extensionId, extensionVersion = _ref.extensionVersion;
      return id2 == extensionId && version == extensionVersion;
    });
  }

  // src/element-service.js
  function getElementServiceIfAvailable(win, id2, extension, version, opt_element) {
    var s = getServicePromiseOrNull(win, id2);
    if (s) {
      return s;
    }
    return getElementServicePromiseOrNull(win, id2, extension, version, opt_element);
  }
  ...
  function getElementServicePromiseOrNull(win, id2, extension, version, opt_element) {
  ...
  var AmpTiktok = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpTiktok2(element) {
      var _this;
      _classCallCheck3(this, AmpTiktok2);
      ...
      _this.resizeOuter_ = function(height) {
        ...
        _this.iframe_.setAttribute("aria-label", "Tiktok");
    ...
    _createClass2(AmpTiktok2, [{
      ...
      value: function layoutCallback() {
        ...
        return this.loadPromise(iframe).then(function() {
          ...
          _this2.resolveRecievedFirstMessage_ = resolve;
      ...
      key: "handleTiktokMessages_",
      value: function handleTiktokMessages_(event) {
      ...
      key: "getIframeNameString_",
      value: function getIframeNameString_() {
  ...
  AMP.extension("amp-tiktok", "0.1", function(AMP2) {
    AMP2.registerElement("amp-tiktok", AmpTiktok, CSS2);
  });
})();
