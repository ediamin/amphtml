(self.AMP=self.AMP||[]).push({n:"amp-truncate-text",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function forEachChild(node, cb) {
    var childNodes = node.localName == "slot" ? node.assignedNodes({
      flatten: true
    }) : node.childNodes;
  ...
  var AmpTruncateText = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpTruncateText2(element) {
      var _this;
      _classCallCheck3(this, AmpTruncateText2);
    ...
    _createClass2(AmpTruncateText2, [{
      key: "setupActions_",
      ...
      key: "getNodesForOverflow_",
      value: function getNodesForOverflow_() {
        if (this.useShadow_) {
      ...
      key: "maybeExpand_",
      value: function maybeExpand_(event) {
        this.maybeToggle_(event, true);
      }
    }, {
      key: "maybeCollapse_",
      value: function maybeCollapse_(event) {
        this.maybeToggle_(event, false);
      }
    }, {
      key: "maybeToggle_",
      value: function maybeToggle_(event, expand) {
  ...
  AMP.extension("amp-truncate-text", "0.1", function(AMP2) {
    AMP2.registerElement("amp-truncate-text", AmpTruncateText, CSS2);
  });
})();
