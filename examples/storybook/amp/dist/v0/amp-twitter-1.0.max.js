(self.AMP=self.AMP||[]).push({n:"amp-twitter",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function IframeEmbedWithRef(_ref, ref) {
    ...
    return createElement(ContainWrapper, _extends6({}, rest, {
      layout: true,
      size: true,
      paint: true
  ...
  function assertHttpsUrl(urlString, elementContext, sourceName) {
    ...
    userAssert2(isSecureUrlDeprecated(theUrlString) || /^(\/\/)/.test(theUrlString), '%s %s must start with "https://" or "//" or be relative and served from either https or from localhost. Invalid value: %s', elementContext, sourceName, theUrlString);
    return theUrlString;
  }
  ...
  function ProxyIframeEmbedWithRef(_ref, ref) {
    ...
    return createElement(IframeEmbed, _extends7({
      allow,
      contentRef,
      messageHandler,
      name,
  ...
  var _excluded5 = ["momentid", "options", "requestResize", "style", "title", "tweetid"];
  function _extends8() {
  ...
  function TwitterWithRef(_ref, ref) {
    var momentid = _ref.momentid, options = _ref.options, requestResize = _ref.requestResize, style = _ref.style, title = _ref.title, tweetid = _ref.tweetid, rest = _objectWithoutPropertiesLoose5(_ref, _excluded5);
    ...
    return createElement(ProxyIframeEmbed, _extends8({
  ...
  var AmpTwitter = /* @__PURE__ */ function(_BaseElement) {
    _inherits3(AmpTwitter2, _BaseElement);
    var _super = _createSuper3(AmpTwitter2);
    function AmpTwitter2(element) {
      _classCallCheck10(this, AmpTwitter2);
      return _super.call(this, element);
    }
    _createClass8(AmpTwitter2, [{
      key: "init",
      value: function init() {
        var _this = this;
        return dict({
      ...
      value: function isLayoutSupported(layout) {
        ...
        return _get2(_getPrototypeOf3(AmpTwitter2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }], [{
  ...
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpTwitter);
  });
})();
