(self.AMP=self.AMP||[]).push({n:"amp-user-notification",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var NotificationUiManager = /* @__PURE__ */ function() {
    function NotificationUiManager2() {
      _classCallCheck2(this, NotificationUiManager2);
      this.queueSize_ = 0;
    ...
    _createClass(NotificationUiManager2, [{
      key: "onQueueEmpty",
  ...
  var AmpUserNotification = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpUserNotification2(element) {
      var _this;
      _classCallCheck5(this, AmpUserNotification2);
    ...
    _createClass4(AmpUserNotification2, [{
      key: "isAlwaysFixed",
  ...
  var UserNotificationManager = /* @__PURE__ */ function() {
    function UserNotificationManager2(ampdoc) {
      _classCallCheck5(this, UserNotificationManager2);
      this.ampdoc = ampdoc;
    ...
    _createClass4(UserNotificationManager2, [{
      key: "get",
  ...
  AMP.extension(TAG, "0.1", function(AMP2) {
    AMP2.registerServiceForDoc(SERVICE_ID, UserNotificationManager);
    AMP2.registerServiceForDoc(NOTIFICATION_UI_MANAGER, NotificationUiManager);
    AMP2.registerElement(TAG, AmpUserNotification, CSS2);
  });
})();
