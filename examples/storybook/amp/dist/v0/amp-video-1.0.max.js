(self.AMP=self.AMP||[]).push({n:"amp-video",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){

(() => {
  // build/amp-video-1.0.css.js
  var CSS2 = "amp-video{display:block;overflow:hidden;position:relative}amp-video:not(.i-amphtml-built)>:not([placeholder]):not(.i-amphtml-svc){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-video/1.0/amp-video.css*/";
  ...
  VideoBaseElement["shadowCss"] = CSS3;
  ...
  var AmpVideo = /* @__PURE__ */ function(_VideoBaseElement) {
    _inherits3(AmpVideo2, _VideoBaseElement);
    var _super = _createSuper3(AmpVideo2);
    function AmpVideo2() {
      _classCallCheck10(this, AmpVideo2);
      return _super.apply(this, arguments);
    }
    _createClass9(AmpVideo2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        userAssert(isExperimentOn(this.win, "bento") || isExperimentOn(this.win, "bento-video"), 'expected global "bento" or specific "bento-video" experiment to be enabled');
        return _get2(_getPrototypeOf3(AmpVideo2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
    return AmpVideo2;
  }(VideoBaseElement);
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpVideo, CSS2);
  });
})();
