(self.AMP=self.AMP||[]).push({n:"amp-video-iframe",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpVideoIframe = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpVideoIframe2(element) {
      var _this;
      _classCallCheck8(this, AmpVideoIframe2);
    ...
    _createClass7(AmpVideoIframe2, [{
      ...
      value: function onMessage_(event) {
        ...
        var _devAssert = devAssert(this.readyDeferred_), reject = _devAssert.reject, resolve = _devAssert.resolve;
        if (isCanPlayEvent) {
          return resolve();
        }
        ...
        if (eventReceived == "analytics") {
          var spec = devAssert(data["analytics"]);
      ...
      value: function dispatchCustomAnalyticsEvent_(eventType, vars) {
        ...
        userAssert(getAnalyticsEventTypePrefixRegex().test(eventType), "Invalid analytics `eventType`. Value must start with `%s`.", ANALYTICS_EVENT_TYPE_PREFIX);
      ...
      value: function postIntersection_(messageId, intersection) {
      ...
      key: "postConsentData_",
      value: function postConsentData_(messageId) {
        var _this4 = this;
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpVideoIframe);
  });
})();
