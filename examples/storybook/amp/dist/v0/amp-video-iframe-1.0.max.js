(self.AMP=self.AMP||[]).push({n:"amp-video-iframe",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  function VideoIframeInternalWithRef(_ref, ref) {
    ...
    var postMethodMessage = useCallback(function(method) {
      ...
      var makeMethodMessage3 = makeMethodMessageRef.current;
      readyDeferred.promise.then(function() {
        var message = makeMethodMessage3(method);
  ...
  var CSS3 = "amp-video-iframe{display:block;overflow:hidden;position:relative}amp-video-iframe:not(.i-amphtml-built)>:not([placeholder]):not(.i-amphtml-svc){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-video-iframe/1.0/amp-video-iframe.css*/";
  ...
  function getInOb(win) {
    ...
    if (!observer) {
      observer = createViewportObserver(function(entries) {
        var seen = new Set();
        for (var i3 = entries.length - 1; i3 >= 0; i3--) {
          var target = entries[i3].target;
          if (seen.has(target)) {
            continue;
          }
          seen.add(target);
          observer.unobserve(target);
          intersectionDeferreds.get(target).resolve(entries[i3]);
  ...
  var AmpVideoIframe = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpVideoIframe2, _BaseElement);
    var _super = _createSuper4(AmpVideoIframe2);
    function AmpVideoIframe2() {
      _classCallCheck11(this, AmpVideoIframe2);
      return _super.apply(this, arguments);
    }
    _createClass9(AmpVideoIframe2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        ...
        return _get2(_getPrototypeOf4(AmpVideoIframe2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
  ...
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpVideoIframe, CSS3);
  });
})();
