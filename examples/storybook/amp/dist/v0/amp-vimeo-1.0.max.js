(self.AMP=self.AMP||[]).push({n:"amp-vimeo",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var _excluded5 = ["autoplay", "doNotTrack", "videoid"];
  function _extends8() {
  ...
  function VimeoWithRef(_ref, ref) {
    var _ref$autoplay = _ref.autoplay, autoplay = _ref$autoplay === void 0 ? false : _ref$autoplay, _ref$doNotTrack = _ref.doNotTrack, doNotTrack = _ref$doNotTrack === void 0 ? false : _ref$doNotTrack, videoid = _ref.videoid, rest = _objectWithoutPropertiesLoose5(_ref, _excluded5);
  ...
  var CSS3 = "amp-vimeo{display:block;overflow:hidden;position:relative}amp-vimeo:not(.i-amphtml-built)>:not([placeholder]):not(.i-amphtml-svc){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-vimeo/1.0/amp-vimeo.css*/";
  ...
  var AmpVimeo = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpVimeo2, _BaseElement);
    var _super = _createSuper4(AmpVimeo2);
    function AmpVimeo2() {
      _classCallCheck11(this, AmpVimeo2);
      return _super.apply(this, arguments);
    }
    _createClass9(AmpVimeo2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        ...
        return _get2(_getPrototypeOf4(AmpVimeo2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
    return AmpVimeo2;
  }(BaseElement);
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpVimeo, CSS3);
  });
})();
