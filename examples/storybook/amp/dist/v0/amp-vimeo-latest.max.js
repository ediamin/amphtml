(self.AMP=self.AMP||[]).push({n:"amp-vimeo",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpVimeo = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpVimeo2(element) {
      var _this;
      _classCallCheck8(this, AmpVimeo2);
    ...
    _createClass7(AmpVimeo2, [{
      ...
      value: function layoutCallback() {
        ...
        var videoid = userAssert(element.getAttribute("data-videoid"), "The data-videoid attribute is required for <amp-vimeo> %s", element);
      ...
      key: "buildIframe_",
      value: function buildIframe_(src) {
      ...
      key: "sendCommand_",
      value: function sendCommand_(method, params) {
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpVimeo);
  });
})();
