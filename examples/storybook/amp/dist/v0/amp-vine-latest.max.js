(self.AMP=self.AMP||[]).push({n:"amp-vine",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpVine = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    _createClass3(AmpVine2, [{
      ...
      value: function layoutCallback() {
        var vineid = userAssert(this.element.getAttribute("data-vineid"), "The data-vineid attribute is required for <amp-vine> %s", this.element);
  ...
  AMP.extension("amp-vine", "0.1", function(AMP2) {
    AMP2.registerElement("amp-vine", AmpVine);
  });
})();
