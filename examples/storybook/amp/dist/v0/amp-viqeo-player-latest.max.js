(self.AMP=self.AMP||[]).push({n:"amp-viqeo-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var DomFingerprint = /* @__PURE__ */ function() {
    function DomFingerprint2() {
      _classCallCheck5(this, DomFingerprint2);
    }
    _createClass4(DomFingerprint2, null, [{
      key: "generate",
  ...
  var AmpViqeoPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpViqeoPlayer2(element) {
      var _this;
      _classCallCheck9(this, AmpViqeoPlayer2);
    ...
    _createClass8(AmpViqeoPlayer2, [{
      ...
      value: function buildCallback() {
        this.videoId_ = userAssert(this.element.getAttribute("data-videoid"), "The data-videoid attribute is required for <amp-viqeo-player> %s", this.element);
        userAssert(this.element.getAttribute("data-profileid"), "The data-profileid attribute is required for <amp-viqeo-player> %s", this.element);
      ...
      value: function layoutCallback() {
        ...
        return this.mutateElement(function() {
          ...
          _this2.applyFillContent(iframe);
        }).then(function() {
          return _this2.playerReadyPromise_;
        });
      }
    }, {
      key: "handleViqeoMessages_",
      value: function handleViqeoMessages_(event) {
  ...
  AMP.extension(TAG4, "0.1", function(AMP2) {
    AMP2.registerElement(TAG4, AmpViqeoPlayer);
  });
