(self.AMP=self.AMP||[]).push({n:"amp-wistia-player",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpWistiaPlayer = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpWistiaPlayer2(element) {
      var _this;
      _classCallCheck7(this, AmpWistiaPlayer2);
    ...
    _createClass6(AmpWistiaPlayer2, [{
      ...
      value: function layoutCallback() {
        ...
        var mediaId = userAssert(element.getAttribute("data-media-hashed-id"), "The data-media-hashed-id attribute is required for <amp-wistia-player> %s", element);
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpWistiaPlayer);
  });
})();
