(self.AMP=self.AMP||[]).push({n:"amp-yotpo",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var DomFingerprint = /* @__PURE__ */ function() {
    function DomFingerprint2() {
      _classCallCheck4(this, DomFingerprint2);
    }
    _createClass3(DomFingerprint2, null, [{
      key: "generate",
  ...
  var AmpYotpo = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpYotpo2(element) {
      var _this;
      _classCallCheck5(this, AmpYotpo2);
      _this = _super.call(this, element);
      _this.iframe_ = null;
      _this.unlisteners_ = [];
      return _this;
    }
    _createClass4(AmpYotpo2, [{
      ...
      value: function buildCallback() {
        userAssert(this.element.getAttribute("data-app-key"), "The data-app-key attribute is required for <amp-yotpo> %s", this.element);
        userAssert(this.element.getAttribute("data-widget-type"), "The data-widget-type attribute is required for <amp-yotpo> %s", this.element);
      }
    }, {
  ...
  AMP.extension("amp-yotpo", "0.1", function(AMP2) {
    AMP2.registerElement("amp-yotpo", AmpYotpo);
  });
})();
