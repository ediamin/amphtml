(self.AMP=self.AMP||[]).push({n:"amp-youtube",ev:"1.0",l:false,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var VideoInterface = /* @__PURE__ */ function() {
    function VideoInterface2() {
      _classCallCheck8(this, VideoInterface2);
    }
    _createClass7(VideoInterface2, [{
      key: "signals",
  ...
  // extensions/amp-video/1.0/video-wrapper.css.js
  var fillStretch = {
    "position": "relative",
    "width": "100%",
    "height": "100%"
  };
  var fillContentOverlay = {
    "position": "absolute",
    "left": 0,
    "right": 0,
    "bottom": 0,
  ...
  var _excluded3 = ["autoplay", "className", "component", "controls", "loading", "loop", "mediasession", "noaudio", "onPlayingState", "onReadyState", "poster", "sources", "src", "style"];
  function _extends6() {
  ...
  function Autoplay(_ref2) {
    ...
    return createElement(Fragment, null, displayIcon && createElement("div", {
      className: obj_str_default((_objstr = {}, _objstr[$eq] = true, _objstr[$eqPlaying] = playing, _objstr))
  ...
  var VideoBaseElement = /* @__PURE__ */ function(_PreactBaseElement) {
    _inherits2(VideoBaseElement2, _PreactBaseElement);
    var _super = _createSuper2(VideoBaseElement2);
    function VideoBaseElement2() {
      _classCallCheck9(this, VideoBaseElement2);
      return _super.apply(this, arguments);
    }
    _createClass8(VideoBaseElement2, [{
      key: "init",
      value: function init() {
      ...
      key: "registerApiAction_",
      value: function registerApiAction_(alias, handler, minTrust) {
        if (minTrust === void 0) {
  ...
  VideoBaseElement["shadowCss"] = CSS2;
  VideoBaseElement["usesShadowDom"] = true;

  // extensions/amp-video/1.0/video-iframe.js
  var _excluded4 = ["loading", "unloadOnPause", "sandbox", "muted", "controls", "origin", "onCanPlay", "onMessage", "playerStateRef", "makeMethodMessage", "onIframeLoad"];
  function _extends7() {
  ...
  function VideoIframeInternalWithRef(_ref, ref) {
    ...
    var postMethodMessage = useCallback(function(method) {
      ...
      var makeMethodMessage2 = makeMethodMessageRef.current;
      readyDeferred.promise.then(function() {
        var message = makeMethodMessage2(method);
  ...
  var _excluded5 = ["autoplay", "loop", "videoid", "liveChannelid", "params", "credentials"];
  function _extends8() {
  ...
  function YoutubeWithRef(_ref, ref) {
    var autoplay = _ref.autoplay, loop = _ref.loop, videoid = _ref.videoid, liveChannelid = _ref.liveChannelid, _ref$params = _ref.params, params = _ref$params === void 0 ? {} : _ref$params, credentials = _ref.credentials, rest = _objectWithoutPropertiesLoose5(_ref, _excluded5);
  ...
  var BaseElement = /* @__PURE__ */ function(_VideoBaseElement) {
    _inherits3(BaseElement2, _VideoBaseElement);
  ...
  var CSS3 = "amp-youtube{display:block;overflow:hidden;position:relative}amp-youtube:not(.i-amphtml-built)>:not([placeholder]):not(.i-amphtml-svc){display:none;content-visibility:hidden}\n/*# sourceURL=/extensions/amp-youtube/1.0/amp-youtube.css*/";
  ...
  var AmpYoutube = /* @__PURE__ */ function(_BaseElement) {
    _inherits4(AmpYoutube2, _BaseElement);
    var _super = _createSuper4(AmpYoutube2);
    function AmpYoutube2() {
      _classCallCheck11(this, AmpYoutube2);
      return _super.apply(this, arguments);
    }
    _createClass9(AmpYoutube2, [{
      key: "isLayoutSupported",
      value: function isLayoutSupported(layout) {
        ...
        return _get2(_getPrototypeOf4(AmpYoutube2.prototype), "isLayoutSupported", this).call(this, layout);
      }
    }]);
    return AmpYoutube2;
  }(BaseElement);
  AMP.extension(TAG2, "1.0", function(AMP2) {
    AMP2.registerElement(TAG2, AmpYoutube, CSS3);
  });
})();
