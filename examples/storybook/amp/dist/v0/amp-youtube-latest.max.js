(self.AMP=self.AMP||[]).push({n:"amp-youtube",ev:"0.1",l:true,v:"2106040012000",m:0,f:(function(AMP,_){
...
(() => {
  ...
  var AmpYoutube = /* @__PURE__ */ function(_AMP$BaseElement) {
    ...
    function AmpYoutube2(element) {
      var _this;
      _classCallCheck8(this, AmpYoutube2);
    ...
    _createClass7(AmpYoutube2, [{
      ...
      value: function assertDatasourceExists_() {
        ...
        userAssert(datasourceExists, "Exactly one of data-videoid or data-live-channelid should be present for <amp-youtube> %s", this.element);
      }
    }, {
      key: "sendCommand_",
      ...
      value: function createPlaceholderCallback() {
        ...
        var el = this.element;
        var imgPlaceholder = htmlFor(el)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteralLoose3(["<img placeholder referrerpolicy=origin>"])));
  ...
  AMP.extension(TAG2, "0.1", function(AMP2) {
    AMP2.registerElement(TAG2, AmpYoutube);
  });
})();
